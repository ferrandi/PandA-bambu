...
BOOST_AUTO_TEST_CASE(range)
{
   Range* _r = nullptr;
   // Full range
   BOOST_REQUIRE_NO_THROW(_r = new Range(Regular, 8));
   Range r = *_r;
   ...
   // Regular pos-pos
   BOOST_REQUIRE_NO_THROW(_r = new Range(Regular, 8, 10, 113));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   BOOST_REQUIRE_NO_THROW(_r = new Range(Regular, 8, 129, 236));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   // Regular neg-pos
   BOOST_REQUIRE_NO_THROW(_r = new Range(Regular, 8, -5, 113));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   BOOST_REQUIRE_NO_THROW(_r = new Range(Regular, 8, -5, 132));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   ...
   BOOST_REQUIRE_NO_THROW(_r = new Range(Regular, 8, -3, 252));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(r.isFullSet());

   // Regular neg-neg
   BOOST_REQUIRE_NO_THROW(_r = new Range(Regular, 8, -111, -36));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   BOOST_REQUIRE_NO_THROW(_r = new Range(Regular, 8, -130, -36));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isAnti());
   ...
   BOOST_REQUIRE_NO_THROW(_r = new Range(Regular, 8, -292, -36));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   // Anti pos-pos
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, 10, 113));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isAnti());
   ...
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, 132, 213));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isAnti());
   ...
   // Anti neg-pos
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, -34, 97));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isAnti());
   ...
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, -34, 210));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, -34, 230));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isAnti());
   BOOST_REQUIRE(r.isFullSet());
   ...
   // Anti neg-neg
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, -104, -67));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isAnti());
   ...
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, -130, -67));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, -323, -67));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   // Anti min-neg
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, Range::Min, -57));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   // Anti min-pos
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, Range::Min, 13));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   // Anti pos-max
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, 32, Range::Max));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
   ...
   // Anti neg-max
   BOOST_REQUIRE_NO_THROW(_r = new Range(Anti, 8, -33, Range::Max));
   r = *_r;
   BOOST_REQUIRE_EQUAL(8, r.getBitWidth());
   BOOST_REQUIRE(!r.isFullSet());
   BOOST_REQUIRE(r.isRegular());
...
{
   Range a(Regular, 8, 5, 12);
   Range b(Regular, 8, -50, -20);
   Range c(Regular, 8, -23, 12);
   Range d(Anti, 8, -5, 7);
   Range e(Regular, 8);
   Range f(Unknown, 8);
   Range g(Anti, 8, -5, 6);
   Range h(Anti, 32, -55726, 0);
   Range i(Anti, 32, -55727, 0);
   Range j(Anti, 8, -1, -1);
   Range k(Anti, 8, Range::Min, -1);
...
{
   Range aPositive(Regular, 8, 5, 9);
   Range aNegative(Regular, 8, -9, -5);
   Range aMix(Regular, 8, -5, 9);
   Range bPositive(Regular, 8, 3, 6);
   Range bNegative(Regular, 8, -6, -3);
   Range bMix(Regular, 8, -3, 6);
   ...
   Range limitU63(Regular, 64, 0ULL, 9223372036854775807ULL);

   auto addLimitU64 = limitU63.add(Range(Regular, 64, 0, 1));
...
BOOST_AUTO_TEST_CASE(range_reminder)
{
   ...
   Range bNegative(Regular, 8, -6, -3);
   Range bMix(Regular, 8, -3, 6);
   Range cHigh(Regular, 8, 10, 15);
   Range cLow(Regular, 8, 2, 4);
   Range three(Regular, 8, 3, 3);
   Range mThree(Regular, 8, -3, -3);

   Range one(Regular, 8, 1, 1);
   Range invariant(Regular, 8, std::numeric_limits<char>::min(), std::numeric_limits<char>::min());
   ...
   Range all(Regular, 32, std::numeric_limits<int>::min(), std::numeric_limits<int>::max() - 1);
   Range min32(Regular, 32, std::numeric_limits<int>::min(), std::numeric_limits<int>::min());
...
{
   Range pos(Regular, 8, 12, 57);
   Range mix(Regular, 8, -27, 43);
   Range neg(Regular, 8, -105, -39);
   Range allOne(Regular, 8, -1, -1);
   Range antiPos(Anti, 8, 5, 38);
   Range antiNeg(Anti, 8, -47, -15);
   Range antiMix(Anti, 8, -17, 0);
   Range zero(Regular, 8, 0, 0);
   Range zeroOne(Regular, 8, 0, 1);
   Range zeroSeven(Regular, 8, 0, 7);
   Range eight(Regular, 8, 8, 8);
   Range two(Regular, 8, 2, 2);
...
{
   Range positive(Regular, 8, 5, 12);
   Range safeMix(Regular, 8, -12, 5);
   Range unsafeMix(Regular, 8, -128, 31);
   Range safeNeg(Regular, 8, -15, -3);
   Range unsafeNeg(Regular, 8, -128, -57);
   Range antiNeg(Anti, 8, -57, -35);
   Range antiSafe(Anti, 8, -128, 0);
...
{
   Range pos(Regular, 8, 5, 50);
   Range neg(Regular, 8, -50, -5);
   Range mix(Regular, 8, -50, 37);
   Range unsafe(Regular, 8, -128, 5);
   Range antiPos(Anti, 8, 6, 10);
   Range antiNeg(Anti, 8, -50, -26);
   Range antiMix(Anti, 8, -30, 57);
...
{
   Range aPositive(Regular, 8, 0b00001010, 0b00010100);
   Range aNegative(Regular, 8, 0b11000001, 0b11110000);
   Range aMix(Regular, 8, 0b10101000, 0b00001101);
   Range zero(Regular, 8, 0b00000000, 0b00000000);
   Range bPositive(Regular, 8, 0b00000111, 0b00011011);
   Range bNegative(Regular, 8, 0b10000000, 0b10000000);
   Range bMix(Regular, 8, 0b10000000, 0b00000000);
   Range one(Regular, 8, 0b00000001, 0b00000001);
   Range allOnes(Regular, 8, 0b11111111, 0b11111111);
   ...
   Range bOne(Regular, 1, 1, 1);
   Range bZero(Regular, 1, 0, 0);
   Range bOneZero(Regular, 1);
...
BOOST_AUTO_TEST_CASE(range_xor)
{
   ...
   Range aNegative(Regular, 8, 0b11000001, 0b11110000);
   Range aMix(Regular, 8, 0b10101000, 0b00001101);
   Range aConstant(Regular, 8, 0b00000000, 0b00000000);
   Range bPositive(Regular, 8, 0b00000111, 0b00011011);
   Range bNegative(Regular, 8, 0b10000000, 0b10000000);
   Range bMix(Regular, 8, 0b10000000, 0b00000000);
   Range bConstant(Regular, 8, 0b11111111, 0b11111111);
...
{
   Range pos(Regular, 8, 0b00001010, 0b00010100);
   Range neg(Regular, 8, 0b11000001, 0b11110000);
   Range mix(Regular, 8, 0b10101000, 0b00001101);
   Range anti(Anti, 8, static_cast<int8_t>(0b10101000), 0b00001101);
...
{
   Range one(Regular, 1, 1, 1);
   Range zero(Regular, 1, 0, 0);
   Range zeroOne(Regular, 1);
...
{
   Range contained(Regular, 8, 0b11111001, 0b00001010);
   Range lowwrap(Regular, 8, 0b11101101, 0b00001010);
   Range upwrap(Regular, 8, 0b11111111, 0b00011000);
   Range fullwrap(Regular, 8, 0b11100111, 0b11101111);
   Range fullwrap2(Regular, 16, -3786, -3703);
   Range multiwrap(Regular, 16, 1250, 2277);
   ...
   Range strangeTest1(Regular, 32, 122, 124);
...
{
   Range boolean(Regular, 1);
   Range signedR(Regular, 8, 0b11001100, 0b01110011);
   Range unsignedR(Regular, 8, 0b00011100, 0b01100101);
   Range empty(Empty, 2);
   Range unknown(Unknown, 2);
