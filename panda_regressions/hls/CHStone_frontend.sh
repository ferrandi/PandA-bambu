...
$(dirname $0)/../../etc/scripts/test_panda.py --tool=bambu \
             ...
             --args="--configuration-name=CLANG9-O3-wp-NN --simulate -O3 -fwhole-program --compiler=I386_CLANG9 --clock-period=15 -D'printf(fmt, ...)=' --channels-type=MEM_ACC_NN --experimental-setup=BAMBU"\
             --args="--configuration-name=CLANG10-O3-wp-NN --simulate -O3 -fwhole-program --compiler=I386_CLANG10 --clock-period=15 -D'printf(fmt, ...)=' --channels-type=MEM_ACC_NN --experimental-setup=BAMBU"\
             --args="--configuration-name=CLANG11-O3-wp-NN --simulate -O3 -fwhole-program --compiler=I386_CLANG11 --clock-period=15 -D'printf(fmt, ...)=' --channels-type=MEM_ACC_NN --experimental-setup=BAMBU"\
