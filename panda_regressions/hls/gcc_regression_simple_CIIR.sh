...
python $script_dir/../../etc/scripts/test_panda.py gcc_regression_simple --tool=bambu \
   ...
   -o output_CIIR -b$script_dir --table=output_CIIR.tex  --name="GccRegressionSimpleCIIR" "$@"
exit $?
