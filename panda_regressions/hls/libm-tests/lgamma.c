...
int main(void)
{
   ...
   check_d1(lgamma, -__builtin_inf(), __builtin_inf());
   //check_d1(lgamma, __builtin_inf(), NAN);
   check_d1(lgamma, 0.0, __builtin_inf()); /* pole */
   check_d1(lgamma, minus_zero, __builtin_inf()); /* pole */
   check_d1(lgamma, 1.0, 0.0);
   check_d1(lgamma, 2.0, 0.0);
   check_d1(lgamma, DBL_MAX/2, __builtin_inf()); /* overflow to inf */
   check_d1(lgamma, DBL_MAX, __builtin_inf()); /* overflow to inf */
   check_d1(lgamma, __builtin_inf(), __builtin_inf()); /* overflow to inf */
