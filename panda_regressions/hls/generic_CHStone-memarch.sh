...
python3 $script_dir/../../etc/scripts/test_panda.py --tool=bambu \
   ...
   --args="--configuration-name=${compiler}-O3-wp-11-D00-ALL --memory-allocation-policy=ALL_BRAM --channels-type=MEM_ACC_11 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-N1-D00-ALL --memory-allocation-policy=ALL_BRAM --channels-type=MEM_ACC_N1 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-NN-D00-ALL --memory-allocation-policy=ALL_BRAM --channels-type=MEM_ACC_NN ${BATCH_ARGS[*]}"\
