...
$dir_script/../../etc/scripts/test_panda.py --tool=bambu \
     ...
     -l$dir_script/CHStone_list -o output_hw_discrepancy --ulimit="-f 5000000 -v 5000000 -s 16384" -b$dir_script --table=table_hw_discrepancy.tex --name="hw_discrepancy" -t 120m $@
return_value=$?
