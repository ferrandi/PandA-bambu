...
const int out_length_get_sof = 17;
const int out_data_precision_get_sof = 8;
const int out_p_jinfo_image_height_get_sof = 59;
const int out_p_jinfo_image_width_get_sof = 90;
const int out_p_jinfo_num_components_get_sof = 3;
...
int i_get_sos = 0;
const int out_length_get_sos = 12;
const int out_num_comp_get_sos = 3;
