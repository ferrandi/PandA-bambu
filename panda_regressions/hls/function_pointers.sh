...
python $script_dir/../../etc/scripts/test_panda.py -l function_pointers_list_bsearch --tool=bambu \
...
python $script_dir/../../etc/scripts/test_panda.py -l function_pointers_list_qsort --tool=bambu \
