#!/bin/bash
$(dirname $0)/../../etc/scripts/test_panda.py -lgcc_regression_simple_verilator --tool=bambu \
   ...
   -o output_clang11_simple_verilator -b$(dirname $0) --table=output_clang11_simple_verilator.tex --name="Clang11RegressionSimple" $@
exit $?
