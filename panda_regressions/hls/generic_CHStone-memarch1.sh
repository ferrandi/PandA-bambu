...
python3 $script_dir/../../etc/scripts/mantis.py --tool=bambu \
   ...
   --args="--configuration-name=${compiler}-O3-wp-11-D00-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_11 --memory-ctrl-type=D00 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-N1-D00-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_N1 --memory-ctrl-type=D00 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-NN-D00-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_NN --memory-ctrl-type=D00 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-11-D10-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_11 --memory-ctrl-type=D10 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-N1-D10-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_N1 --memory-ctrl-type=D10 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-NN-D10-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_NN --memory-ctrl-type=D10 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-11-D11-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_11 --memory-ctrl-type=D11 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-N1-D11-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_N1 --memory-ctrl-type=D11 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-NN-D11-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_NN --memory-ctrl-type=D11 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-11-D21-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_11 --memory-ctrl-type=D21 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-N1-D21-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_N1 --memory-ctrl-type=D21 ${BATCH_ARGS[*]}"\
   --args="--configuration-name=${compiler}-O3-wp-NN-D21-NO-BRAM --memory-allocation-policy=NO_BRAM --channels-type=MEM_ACC_NN --memory-ctrl-type=D21 ${BATCH_ARGS[*]}"\
