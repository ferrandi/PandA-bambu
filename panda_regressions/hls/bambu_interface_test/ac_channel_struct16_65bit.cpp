...
// Struct with 16 elements of ac_int<65, false>
struct Data16_65bit {
...
extern "C" void __attribute__((noinline)) reduce16_65bit(ac_channel<Data16_65bit>& in,
                                                      ac_channel<Data16_65bit>& out) {
    Data16_65bit inData, outData;
