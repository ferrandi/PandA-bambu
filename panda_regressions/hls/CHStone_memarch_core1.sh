...
$(dirname $0)/../../etc/scripts/test_panda.py --tool=bambu \
             ...
             --args="--configuration-name=GCC49-O3-wp-VVD-NN-D00-INTERN-UNALIGNED --simulate -O3 -fwhole-program --compiler=I386_GCC49 --clock-period=15 -D'printf(fmt, ...)=' --channels-type=MEM_ACC_NN --memory-ctrl-type=D00 --experimental-setup=BAMBU --device-name=xc7z020,-1,clg484,VVD --do-not-expose-globals --memory-allocation-policy=INTERN_UNALIGNED"\
