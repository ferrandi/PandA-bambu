...
$(dirname $0)/../../etc/scripts/test_panda.py -ldiscrepancy_list --tool=bambu \
   ...
   -o gcc49_regression_simple_no_expose_globals_pretty_print -b$(dirname $0) --table=gcc49_regression_simple_no_expose_globals_pretty_print.tex --name="Gcc49RegressionSimpleDNEGPP" $@
exit $?
