...
def successful_environment() -> dict[str, str]:
    return {
        ...
        "PANDA_CI_EFFECTIVE_ASSERTIONS_ENABLED": "OFF",
        "PANDA_CI_EFFECTIVE_BUILD_TYPE": "Release",
        "PANDA_CI_EFFECTIVE_OPTIMIZED_FLAGS": "-Ofast -march=x86-64 -mtune=generic",
        "PANDA_CI_EFFECTIVE_WARNINGS_AS_ERRORS": "ON",
        "PANDA_CI_CPU_TARGET_PROFILE": "x86-64-portable",
