...
#define BAMBU_OPTIONS                                                                                                                                                                                                                                  \
   (chaining)(chaining_algorithm)(constraints_file)(controller_architecture)(datapath_architecture)(distram_threshold)(DSP_allocation_coefficient)(DSP_margin_combinational)(DSP_margin_pipelined)(estimate_logic_and_connections)(evaluation)(        \
       ...
       do_not_expose_globals)(connect_iob)(profiling_output)(disable_bounded_function)(discrepancy)(discrepancy_force)(discrepancy_hw)(discrepancy_no_load_pointers)(discrepancy_only)(discrepancy_permissive_ptrs)(dry_run_evaluation)(               \
...
#define SYNTHESIS_OPTIONS                                                                                                                                                                                                                        \
   (clock_period)(clock_name)(reset_name)(start_name)(done_name)(design_analysis_steps)(design_compiler_compile_log)(design_compiler_split_log)(design_parameters)(design_hierarchy)(device_string)(dump_genlib)(estimate_library)(export_ip_core)(import_ip_core)(input_liberty_library_file)( \
