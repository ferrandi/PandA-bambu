...
#define BAMBU_OPTIONS                                                                                                                                                                                                                                          \
   (chaining)(chaining_algorithm)(constraints_file)(controller_architecture)(context_switch)(datapath_architecture)(distram_threshold)(DSP_allocation_coefficient)(DSP_margin_combinational)(DSP_margin_pipelined)(estimate_logic_and_connections)(            \
       evaluation)(evaluation_mode)(evaluation_objectives)(experimental_setup)(export_core)(export_core_mode)(fsm_encoding)(fu_binding_algorithm)(generate_testbench)(generate_vcd)(hls_flow)(hls_div)(interface)(interface_type)(additional_top)(             \
       tag_bus_bitsize)(data_bus_bitsize)(addr_bus_bitsize)(libm_std_rounding)(liveness_algorithm)(scheduling_mux_margins)(scheduling_priority)(scheduling_algorithm)(simulate)(simulator)(simulation_output)(speculative)(storage_value_insertion_algorithm)( \
       stg)(stg_algorithm)(register_allocation_algorithm)(register_grouping)(registered_inputs)(resp_model)(datapath_interconnection_algorithm)(insert_memory_profile)(timing_simulation)(top_file)(assert_debug)(memory_allocation_algorithm)(                \
       ...
       softfloat_subnormal)(max_sim_cycles)(sparse_memory)(max_ulp)(skip_pipe_parameter)(gcc_serialize_memory_accesses)(unaligned_access)(aligned_access)(backend_script_extensions)(backend_sdc_extensions)(bitvalue_ipa)(use_asynchronous_memories)(         \
       do_not_chain_memories)(bram_high_latency)(cdfc_module_binding_algorithm)(function_allocation_algorithm)(testbench_input_string)(testbench_input_xml)(weighted_clique_register_algorithm)(disable_function_proxy)(memory_mapped_top)(                    \
       do_not_expose_globals)(connect_iob)(profiling_output)(disable_bounded_function)(discrepancy)(discrepancy_force)(discrepancy_no_load_pointers)(discrepancy_only)(discrepancy_permissive_ptrs)(dry_run_evaluation)(find_max_cfg_transformations)(         \
       generate_taste_architecture)(initial_internal_address)(mem_delay_read)(mem_delay_write)(memory_banks_number)(mixed_design)(no_parse_c_python)(num_threads)(post_rescheduling)(technology_file)(testbench_extra_gcc_flags)(timing_violation_abort)(      \
       top_design_name)(visualizer)
