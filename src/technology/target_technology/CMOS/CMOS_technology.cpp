...
void CMOS_technology::initialize()
{
   ...
   if (Param->isOption("grid-size")) set_parameter("manufacturing_grid_size", Param->getOption<double>("grid-size"));
   ///it represents the number of blocks for the cell height
   if (Param->isOption("height-blocks")) set_parameter("grid_cell_height", Param->getOption<double>("height-blocks"));
   ///it represents the size of the pitch grid on x axis
   if (Param->isOption("grid-x")) set_parameter("pitch_grid_x", Param->getOption<double>("grid-x"));
   ///it represents the size of the pitch grid on y axis
   if (Param->isOption("grid-y")) set_parameter("pitch_grid_y", Param->getOption<double>("grid-y"));
#endif
