...
class technology_manager
{
   ...
   public:
       ...
       */
      const std::vector<std::string>& get_library_list() const { return libraries; }
       ...
       */
      static
         void gload(const std::string& file_name, const fileIO_istreamRef file, const technology_managerRef TM, const ParameterConstRef Param);
#endif
