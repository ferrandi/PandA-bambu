 ...
 *     keywords = {Liveness Analysis; SSA form; Compilers},
 *     language = {English},
 *     affiliation = {COMPSYS - INRIA Grenoble Rh{\^o}ne-Alpes / LIP Laboratoire de l'Informatique du Parall{\'e}lisme , Kalray},
 *     pages = {25},
 *     type = {Research Report},
 *     institution = {INRIA},
 *     number = {RR-7503},
 *     collaboration = {Kalray },
 *     year = {2011},
 *     month = Apr,
 *     pdf = {http://hal.inria.fr/inria-00558509/PDF/RR-7503.pdf},
 *   }
 *
 *
