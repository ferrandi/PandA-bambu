         ...
         if(GET_NODE(stmt)->get_kind() == gimple_assign_K)
         {
            ...
            if(ssa)
            {
               ...
               else if(GET_NODE(ga->op1)->get_kind() == lut_expr_K)
               {
                  ...
                  {
                     if(GET_CONST_NODE(le->op1)->get_kind() == integer_cst_K
                        || (le->op2 && GET_CONST_NODE(le->op2)->get_kind() == integer_cst_K)
                        || (le->op3 && GET_CONST_NODE(le->op3)->get_kind() == integer_cst_K)
                        || (le->op4 && GET_CONST_NODE(le->op4)->get_kind() == integer_cst_K)
                        || (le->op5 && GET_CONST_NODE(le->op5)->get_kind() == integer_cst_K)
                        || (le->op6 && GET_CONST_NODE(le->op6)->get_kind() == integer_cst_K)
                        || (le->op7 && GET_CONST_NODE(le->op7)->get_kind() == integer_cst_K)
                        || (le->op8 && GET_CONST_NODE(le->op8)->get_kind() == integer_cst_K)
                        )
