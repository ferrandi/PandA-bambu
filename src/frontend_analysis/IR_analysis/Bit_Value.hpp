...
class Bit_Value : public FunctionFrontendFlowStep, public BitLatticeManipulator
{
   private:
       ...
       */
      std::deque<bit_lattice> backward_transfer(
       ...
       */
      bool manage_forward_binary_operands(
       ...
       */
      std::deque<bit_lattice> backward_compute_result_from_uses(
