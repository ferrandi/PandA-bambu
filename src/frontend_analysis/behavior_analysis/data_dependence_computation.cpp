                                                                     ...
                                                                     const int adg_selector, const int fb_adg_selector)
{
   ...
   for(boost::tie(vi, vi_end) = boost::vertices(*cfg); vi != vi_end; vi++)
   {
      ...
      {
         INDENT_DBG_MEX(DEBUG_LEVEL_VERY_PEDANTIC, debug_level, "---" + TM->CGetTreeNode(local_def)->ToString());
   ...
   for(boost::tie(vi, vi_end) = boost::vertices(*cfg); vi != vi_end; vi++)
   {
      ...
      {
         INDENT_DBG_MEX(DEBUG_LEVEL_VERY_PEDANTIC, debug_level, "---" + TM->CGetTreeNode(local_over)->ToString());
   ...
   for(boost::tie(vi, vi_end) = boost::vertices(*cfg); vi != vi_end; vi++)
   {
      ...
      {
         INDENT_DBG_MEX(DEBUG_LEVEL_VERY_PEDANTIC, debug_level,
                        "-->Considering use of " + TM->CGetTreeNode(local_use)->ToString());
