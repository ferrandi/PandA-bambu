...
#define TASK_FINISHED "task_finished"
...
struct structural_type_descriptor
{
      ...
      enum s_type
      {
         OTHER = 0, BOOL, INT, UINT, REAL, USER, VECTOR_BOOL, VECTOR_INT, VECTOR_UINT, VECTOR_REAL, VECTOR_USER, UNKNOWN
      };
...
*/
enum so_kind {component_o_K,
              channel_o_K, bus_connection_o_K,
              constant_o_K,
              signal_o_K, signal_vector_o_K,
              port_o_K, port_vector_o_K,
...
class structural_object
{
   ...
   public:
      ...
      /**
          ...
          */
      std::string get_equation(const structural_objectRef out_obj, const technology_managerConstRef TM, std::set<structural_objectRef>& analyzed,
...
class action_o : public structural_object
{
   public:
      ...
      enum process_type
      {
         THREAD = 0, CTHREAD, METHOD, SERVICE, UNKNOWN
      };
