...
#endif
   if(((Param->isOption(OPT_discrepancy) and Param->getOption<bool>(OPT_discrepancy)) || (Param->isOption(OPT_discrepancy_hw) and Param->getOption<bool>(OPT_discrepancy_hw))) and (cm == GccWrapper_CompilerMode::CM_STD || cm == GccWrapper_CompilerMode::CM_EMPTY))
   {
