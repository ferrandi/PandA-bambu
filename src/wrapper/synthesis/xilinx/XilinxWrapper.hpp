...
class XilinxWrapper : public SynthesisTool
{
 public:
    ...
    */
   XilinxWrapper(const ParameterConstRef& Param, const std::string& tool_exec, const target_deviceRef& device, const std::string& _output_dir, const std::string& _default_output_dir);
