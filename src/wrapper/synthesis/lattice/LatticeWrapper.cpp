...
LatticeWrapper::LatticeWrapper(const ParameterConstRef& _Param, const std::string& _tool_exec, const target_deviceRef& _device, const std::string& _output_dir, const std::string& _default_output_dir)
    : SynthesisTool(_Param, _tool_exec, _device, _output_dir, _default_output_dir)
{
}

LatticeWrapper::~LatticeWrapper() = default;
...
std::string LatticeWrapper::get_command_line(const DesignParametersRef& dp) const
{
   std::ostringstream s;
...
std::string LatticeWrapper::getStringValue(const xml_script_node_tRef node, const DesignParametersRef& dp) const
{
...
std::string LatticeWrapper::toString(const xml_script_node_tRef node, const DesignParametersRef dp) const
{
   switch(node->nodeType)
   {
      case NODE_ENTRY:
