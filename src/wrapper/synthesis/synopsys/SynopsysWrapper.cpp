...
std::string SynopsysWrapper::get_command_line(const DesignParametersRef& dp) const
{
   std::ostringstream s;
...
std::string SynopsysWrapper::getStringValue(const xml_script_node_tRef node, const DesignParametersRef& dp) const
{
...
std::string SynopsysWrapper::toString(const xml_script_node_tRef node, const DesignParametersRef dp) const
{
   switch(node->nodeType)
   {
      case NODE_ENTRY:
