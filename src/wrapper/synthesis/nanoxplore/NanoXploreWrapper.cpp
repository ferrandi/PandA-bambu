 ...
 */
/**
 * @file NanoXploreWrapper.cpp
 * @brief Implementation of the wrapper to NanoXplore tools
 *
...
NanoXploreWrapper::~NanoXploreWrapper() = default;
...
void NanoXploreWrapper::generate_synthesis_script(const DesignParametersRef& dp, const std::string& file_name)
{
   ...
   script << "##########################################################\n"
             ...
             "##########################################################\n\n"
          << generate_bare_script(xml_script_nodes, dp);
...
std::string NanoXploreWrapper::getStringValue(const xml_script_node_tRef node, const DesignParametersRef& dp) const
{
...
std::string NanoXploreWrapper::toString(const xml_script_node_tRef node, const DesignParametersRef dp) const
{
   switch(node->nodeType)
   {
      case NODE_ENTRY:
