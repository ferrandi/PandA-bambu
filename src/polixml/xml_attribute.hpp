...
class xml_attribute : public xml_node
{
   ...
   public:
       ...
       */
      std::string get_value() const {return at_value;}
      /** 
       * Set the value of this attribute.
       * @param The attribute's value.
       */
      void set_value(const std::string& value) {at_value=value;}
...
struct attribute_sequence
{
       ...
       */
      attribute_list get_attributes() {return a_list;}

      /** Obtain the list of attributes for this element. Constant version.
       * @returns The list of attributes.
       */
      const attribute_list& get_attributes() const {return a_list;}

      /**
       * @returns Whether this node has attributes, or is empty.
       */
      bool has_attributes() const {return !a_list.empty();}
