...
class TernaryOpNode : public OpNode
{
 ...
 public:
   TernaryOpNode(VarNode* sink, VarNode* source1, VarNode* source2, VarNode* source3, const ir_nodeConstRef& inst,
                 kind_R opcode);
   ...
   static std::function<OpNode*(NodeContainer*)> opCtorGenerator(const ir_nodeConstRef&, const application_managerRef&);
};
