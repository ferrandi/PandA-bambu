...
*/
/**
 * @file test_dsatur2_coloring.hpp
 * @brief Test unit of the Boost-based implementation of the sequential coloring algorithm based on the work of Daniel Brelaz (Version 2).
 *
...
main(int argc, char *argv[])
{
   ...
   */
      ...
      switch (in_line[0])
      {
         ...
         case 'p':                  /* problem description      */
         {
            ...
            if (
               ...
               sscanf ( in_line.c_str(), "%*c %4s %ld %ld", pr_type, &VERTICES, &number_of_edges )
               != P_FIELDS
            )
         ...
         case 'e':                    /* edge description */
         {
            ...
            --head;
            if ( tail < 0  ||  tail > VERTICES  ||
                  head < 0  ||  head > VERTICES
               )
...

   {
      ...
      color(&color_vec.front(), get(vertex_index, g1));
