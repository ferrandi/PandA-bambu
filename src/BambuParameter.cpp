...
void BambuParameter::PrintHelp(std::ostream& os) const
{
   ...
   os << "  RTL synthesis:\n\n"
      ...
      << "        <func_name>*<sign_bit>*<min_exp>*<max_exp>*<frac_bits> (use comma separated list for multiple definitions)\n"
      << "           func_name - Set arbitrary floating-point format for a specific function\n"
      << "                       To modify all single or double-precision formats use @32 and @64\n"
...
void BambuParameter::add_experimental_setup_gcc_options(bool kill_printf)
{
   ...
   if(!isOption(OPT_gcc_m32_mx32))
   {
    ...
    (HAVE_I386_GCC6_COMPILER && HAVE_I386_GCC6_M32) || (HAVE_I386_GCC7_COMPILER && HAVE_I386_GCC7_M32) || (HAVE_I386_GCC8_COMPILER && HAVE_I386_GCC8_M32)
      if(false
