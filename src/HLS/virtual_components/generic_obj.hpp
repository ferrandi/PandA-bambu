...
class generic_obj
{
   ...
   public:
       ...
       */
      const std::string get_string() const {return name;}
       ...
       */
      void set_structural_obj(const structural_objectRef& SM_) { SM = SM_; }
       ...
       */
      void set_out_sign(const structural_objectRef& out_sign_) { out_sign = out_sign_; }
