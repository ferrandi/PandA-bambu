...
std::ostream& operator<<(std::ostream& os, const OmpFunctions* omp_functions)
{
   ...
   os << std::string(indentation + 2, ' ')
      << HLSMgr->CGetFunctionBehavior(omp_functions->locks_allocation)->CGetBehavioralHelper()->get_function_name()
      << std::endl;
   ...
   {
      os << std::string(indentation + 2, ' ')
         << HLSMgr->CGetFunctionBehavior(kernel_functions)->CGetBehavioralHelper()->get_function_name() << std::endl;
   }
   ...
   {
      os << std::string(indentation + 2, ' ')
         << HLSMgr->CGetFunctionBehavior(atomic_functions)->CGetBehavioralHelper()->get_function_name() << std::endl;
   }
   ...
   {
      os << std::string(indentation + 2, ' ')
         << HLSMgr->CGetFunctionBehavior(parallelized_functions)->CGetBehavioralHelper()->get_function_name()
         << std::endl;
   }
   ...
   {
      os << std::string(indentation + 2, ' ')
         << HLSMgr->CGetFunctionBehavior(hierarchical_functions)->CGetBehavioralHelper()->get_function_name()
         << std::endl;
   }
   ...
   {
      os << std::string(indentation + 2, ' ')
         << HLSMgr->CGetFunctionBehavior(locks_merge_communication)->CGetBehavioralHelper()->get_function_name()
         << std::endl;
   }
