 ...
 */
/**
 * @file WriteNoneDSModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "WriteNoneDSModuleGenerator.hpp"

#include "language_writer.hpp"

WriteNoneDSModuleGenerator::WriteNoneDSModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void WriteNoneDSModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */,
