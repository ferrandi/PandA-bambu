 ...
 */
/**
 * @file TestbenchAXIMModuleGenerator.hpp
 * @brief
 *
 ...
 *
 */
#ifndef _TESTBENCH_AXIM_MODULE_GENERATOR_HPP_
#define _TESTBENCH_AXIM_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class TestbenchAXIMModuleGenerator : public ModuleGenerator::Registrar<TestbenchAXIMModuleGenerator>
{
 public:
