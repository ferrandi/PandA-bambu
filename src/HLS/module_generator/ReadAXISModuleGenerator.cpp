 ...
 */
/**
 * @file ReadAXISModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "ReadAXISModuleGenerator.hpp"

#include "language_writer.hpp"

ReadAXISModuleGenerator::ReadAXISModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void ReadAXISModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */, unsigned int /* function_id */,
