 ...
 */
/**
 * @file OpenCSModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _OPEN_CS_MODULE_GENERATOR_HPP_
#define _OPEN_CS_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class OpenCSModuleGenerator : public ModuleGenerator::Registrar<OpenCSModuleGenerator>
{
 public:
