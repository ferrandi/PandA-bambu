 ...
 */
/**
 * @file ReadValidModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "ReadValidModuleGenerator.hpp"

#include "language_writer.hpp"

ReadValidModuleGenerator::ReadValidModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void ReadValidModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */, unsigned int /* function_id */,
