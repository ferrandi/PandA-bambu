 ...
 */
/**
 * @file Write_axisModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _WRITE_AXIS_MODULE_GENERATOR_HPP_
#define _WRITE_AXIS_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class Write_axisModuleGenerator : public ModuleGenerator::Registrar<Write_axisModuleGenerator>
{
 public:
   Write_axisModuleGenerator(const HLS_managerRef& HLSMgr);
