 ...
 *
 */
#ifndef _ASM_MODULE_GENERATOR_HPP_
#define _ASM_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class ASMModuleGenerator : public ModuleGenerator::Registrar<ASMModuleGenerator>
{
 public:
