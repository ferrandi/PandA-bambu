 ...
 */
/**
 * @file ReadNoneModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _READ_NONE_MODULE_GENERATOR_HPP_
#define _READ_NONE_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class ReadNoneModuleGenerator : public ModuleGenerator::Registrar<ReadNoneModuleGenerator>
{
 public:
   ReadNoneModuleGenerator(const HLS_managerRef& HLSMgr);
