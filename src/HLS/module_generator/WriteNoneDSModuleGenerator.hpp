 ...
 */
/**
 * @file WriteNoneDSModuleGenerator.hpp
 * @brief
 *
 *
 *
...
class WriteNoneDSModuleGenerator : public ModuleGenerator::Registrar<WriteNoneDSModuleGenerator>
{
 public:
   WriteNoneDSModuleGenerator(const HLS_managerRef& HLSMgr);
