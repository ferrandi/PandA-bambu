 ...
 */
/**
 * @file ReadAcknowledgeModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "ReadAcknowledgeModuleGenerator.hpp"

#include "language_writer.hpp"

ReadAcknowledgeModuleGenerator::ReadAcknowledgeModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void ReadAcknowledgeModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */,
