 ...
 *
 */
#ifndef _OPEN_N_MODULE_GENERATOR_HPP_
#define _OPEN_N_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class OpenNModuleGenerator : public ModuleGenerator::Registrar<OpenNModuleGenerator>
{
 public:
