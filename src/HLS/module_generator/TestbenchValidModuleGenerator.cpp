 ...
 */
/**
 * @file TestbenchValidModuleGenerator.cpp
 * @brief
 *
...
TestbenchValidModuleGenerator::TestbenchValidModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void TestbenchValidModuleGenerator::InternalExec(std::ostream& out, structural_objectRef mod_cir,
