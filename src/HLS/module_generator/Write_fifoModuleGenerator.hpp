 ...
 */
/**
 * @file Write_fifoModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _WRITE_FIFO_MODULE_GENERATOR_HPP_
#define _WRITE_FIFO_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class Write_fifoModuleGenerator : public ModuleGenerator::Registrar<Write_fifoModuleGenerator>
{
 public:
   Write_fifoModuleGenerator(const HLS_managerRef& HLSMgr);
