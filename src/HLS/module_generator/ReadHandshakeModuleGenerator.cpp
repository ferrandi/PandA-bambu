 ...
 */
/**
 * @file ReadHandshakeModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "ReadHandshakeModuleGenerator.hpp"

#include "language_writer.hpp"

ReadHandshakeModuleGenerator::ReadHandshakeModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void ReadHandshakeModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */,
