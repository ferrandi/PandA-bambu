 ...
 */
/**
 * @file WriteFIFOModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "WriteFIFOModuleGenerator.hpp"

#include "language_writer.hpp"

WriteFIFOModuleGenerator::WriteFIFOModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void WriteFIFOModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */, unsigned int /* function_id */,
                                            ...
                                            const std::vector<ModuleGenerator::parameter>& /* _ports_inout */)
{
   ...
   out << "  for(ii=0; ii<PORTSIZE_" << _ports_in[3].name << "; ii=ii+1)\n";
   out << "  begin\n";
   out << "    " << _ports_out[1].name << "_0 = " << _ports_in[4].name << "[(BITSIZE_" << _ports_in[4].name
       << ")*ii+:BITSIZE_" << _ports_in[4].name << "];\n";
   out << "  end\n";
   out << "end\n";
