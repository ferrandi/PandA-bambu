 ...
 */
/**
 * @file Read_fifoModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _READ_FIFO_MODULE_GENERATOR_HPP_
#define _READ_FIFO_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class Read_fifoModuleGenerator : public ModuleGenerator::Registrar<Read_fifoModuleGenerator>
{
 public:
   Read_fifoModuleGenerator(const HLS_managerRef& HLSMgr);
