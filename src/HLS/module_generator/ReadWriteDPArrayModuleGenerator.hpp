 ...
 */
/**
 * @file ReadWriteDPArrayModuleGenerator.hpp
 * @brief
 *
 *
 *
...
class ReadWriteDPArrayModuleGenerator : public ModuleGenerator::Registrar<ReadWriteDPArrayModuleGenerator>
{
 public:
   ReadWriteDPArrayModuleGenerator(const HLS_managerRef& HLSMgr);
