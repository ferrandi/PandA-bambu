 ...
 */
/**
 * @file ReadValidModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _READ_VALID_MODULE_GENERATOR_HPP_
#define _READ_VALID_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class ReadValidModuleGenerator : public ModuleGenerator::Registrar<ReadValidModuleGenerator>
{
 public:
   ReadValidModuleGenerator(const HLS_managerRef& HLSMgr);
