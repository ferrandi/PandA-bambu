 ...
 */
/**
 * @file WriteNoneModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _WRITE_NONE_MODULE_GENERATOR_HPP_
#define _WRITE_NONE_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class WriteNoneModuleGenerator : public ModuleGenerator::Registrar<WriteNoneModuleGenerator>
{
 public:
   WriteNoneModuleGenerator(const HLS_managerRef& HLSMgr);
