 ...
 */
/**
 * @file WriteFIFOModuleGenerator.hpp
 * @brief
 *
 *
 *
...
class WriteFIFOModuleGenerator : public ModuleGenerator::Registrar<WriteFIFOModuleGenerator>
{
 public:
   WriteFIFOModuleGenerator(const HLS_managerRef& HLSMgr);
