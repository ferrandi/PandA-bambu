 ...
 */
/**
 * @file ReadAXISModuleGenerator.hpp
 * @brief
 *
 *
 *
...
class ReadAXISModuleGenerator : public ModuleGenerator::Registrar<ReadAXISModuleGenerator>
{
 public:
   ReadAXISModuleGenerator(const HLS_managerRef& HLSMgr);
