 ...
 */
/**
 * @file TestbenchHandshakeModuleGenerator.hpp
 * @brief
 *
 ...
 *
 */
#ifndef _TESTBENCH_HANDSHAKE_MODULE_GENERATOR_HPP_
#define _TESTBENCH_HANDSHAKE_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class TestbenchHandshakeModuleGenerator : public ModuleGenerator::Registrar<TestbenchHandshakeModuleGenerator>
{
 public:
