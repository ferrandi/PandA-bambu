 ...
 */
/**
 * @file TestbenchArrayModuleGenerator.hpp
 * @brief
 *
 ...
 *
 */
#ifndef _TESTBENCH_ARRAY_MODULE_GENERATOR_HPP_
#define _TESTBENCH_ARRAY_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class TestbenchArrayModuleGenerator : public ModuleGenerator::Registrar<TestbenchArrayModuleGenerator>
{
 public:
