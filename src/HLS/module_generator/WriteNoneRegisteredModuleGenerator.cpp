 ...
 */
/**
 * @file WriteNoneRegisteredModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "WriteNoneRegisteredModuleGenerator.hpp"

#include "language_writer.hpp"

WriteNoneRegisteredModuleGenerator::WriteNoneRegisteredModuleGenerator(const HLS_managerRef& _HLSMgr)
    : Registrar(_HLSMgr)
{
}

void WriteNoneRegisteredModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */,
