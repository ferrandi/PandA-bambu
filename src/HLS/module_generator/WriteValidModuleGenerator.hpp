 ...
 */
/**
 * @file WriteValidModuleGenerator.hpp
 * @brief
 *
 *
 *
...
class WriteValidModuleGenerator : public ModuleGenerator::Registrar<WriteValidModuleGenerator>
{
 public:
   WriteValidModuleGenerator(const HLS_managerRef& HLSMgr);
