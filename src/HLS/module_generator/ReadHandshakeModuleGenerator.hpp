 ...
 */
/**
 * @file ReadHandshakeModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _READ_HANDSHAKE_MODULE_GENERATOR_HPP_
#define _READ_HANDSHAKE_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class ReadHandshakeModuleGenerator : public ModuleGenerator::Registrar<ReadHandshakeModuleGenerator>
{
 public:
   ReadHandshakeModuleGenerator(const HLS_managerRef& HLSMgr);
