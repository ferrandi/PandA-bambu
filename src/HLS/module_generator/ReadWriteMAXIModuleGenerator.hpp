 ...
 */
/**
 * @file ReadWriteMAXIModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _READ_WRITE_MAXI_MODULE_GENERATOR_HPP_
#define _READ_WRITE_MAXI_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class ReadWriteMAXIModuleGenerator : public ModuleGenerator::Registrar<ReadWriteMAXIModuleGenerator>
{
 public:
   ReadWriteMAXIModuleGenerator(const HLS_managerRef& HLSMgr);
