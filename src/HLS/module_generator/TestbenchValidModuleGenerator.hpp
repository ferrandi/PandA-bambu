 ...
 */
/**
 * @file TestbenchValidModuleGenerator.hpp
 * @brief
 *
 ...
 *
 */
#ifndef _TESTBENCH_VALID_MODULE_GENERATOR_HPP_
#define _TESTBENCH_VALID_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class TestbenchValidModuleGenerator : public ModuleGenerator::Registrar<TestbenchValidModuleGenerator>
{
 public:
