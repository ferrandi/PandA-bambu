 ...
 */
/**
 * @file TestbenchDUTModuleGenerator.hpp
 * @brief
 *
 ...
 *
 */
#ifndef _TESTBENCH_DUT_MODULE_GENERATOR_HPP_
#define _TESTBENCH_DUT_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class TestbenchDUTModuleGenerator : public ModuleGenerator::Registrar<TestbenchDUTModuleGenerator>
{
 public:
