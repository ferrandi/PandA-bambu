 ...
 */
/**
 * @file WriteHandshakeModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "WriteHandshakeModuleGenerator.hpp"

#include "language_writer.hpp"

WriteHandshakeModuleGenerator::WriteHandshakeModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void WriteHandshakeModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */,
