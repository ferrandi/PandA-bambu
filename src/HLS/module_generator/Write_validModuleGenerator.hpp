 ...
 */
/**
 * @file Write_validModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _WRITE_VALID_MODULE_GENERATOR_HPP_
#define _WRITE_VALID_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class Write_validModuleGenerator : public ModuleGenerator::Registrar<Write_validModuleGenerator>
{
 public:
   Write_validModuleGenerator(const HLS_managerRef& HLSMgr);
