 ...
 */
/**
 * @file PrintfCSModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _PRINTF_CS_MODULE_GENERATOR_HPP_
#define _PRINTF_CS_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class PrintfCSModuleGenerator : public ModuleGenerator::Registrar<PrintfCSModuleGenerator>
{
 public:
