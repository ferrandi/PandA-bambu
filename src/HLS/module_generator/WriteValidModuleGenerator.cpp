 ...
 */
/**
 * @file WriteValidModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "WriteValidModuleGenerator.hpp"

#include "language_writer.hpp"

WriteValidModuleGenerator::WriteValidModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void WriteValidModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */, unsigned int /* function_id */,
