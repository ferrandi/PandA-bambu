 ...
 */
/**
 * @file ReadWriteArrayModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "ReadWriteArrayModuleGenerator.hpp"
...
ReadWriteArrayModuleGenerator::ReadWriteArrayModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void ReadWriteArrayModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */, unsigned int function_id,
