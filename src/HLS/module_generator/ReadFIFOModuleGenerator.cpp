 ...
 */
/**
 * @file ReadFIFOModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "ReadFIFOModuleGenerator.hpp"

#include "language_writer.hpp"

ReadFIFOModuleGenerator::ReadFIFOModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void ReadFIFOModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */, unsigned int /* function_id */,
