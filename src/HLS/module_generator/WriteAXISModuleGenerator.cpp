 ...
 */
/**
 * @file WriteAXISModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "WriteAXISModuleGenerator.hpp"

#include "language_writer.hpp"

WriteAXISModuleGenerator::WriteAXISModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void WriteAXISModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */, unsigned int /* function_id */,
