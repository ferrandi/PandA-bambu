 ...
 */
/**
 * @file TestbenchHandshakeModuleGenerator.cpp
 * @brief
 *
...
#include "TestbenchHandshakeModuleGenerator.hpp"
...
void TestbenchHandshakeModuleGenerator::InternalExec(std::ostream& out, structural_objectRef mod_cir,
