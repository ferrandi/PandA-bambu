 ...
 */
/**
 * @file WriteAcknowledgeModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _WRITE_ACKNOWLEDGE_MODULE_GENERATOR_HPP_
#define _WRITE_ACKNOWLEDGE_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class WriteAcknowledgeModuleGenerator : public ModuleGenerator::Registrar<WriteAcknowledgeModuleGenerator>
{
 public:
   WriteAcknowledgeModuleGenerator(const HLS_managerRef& HLSMgr);
