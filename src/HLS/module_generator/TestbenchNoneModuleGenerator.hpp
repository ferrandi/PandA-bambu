 ...
 */
/**
 * @file TestbenchNoneModuleGenerator.hpp
 * @brief
 *
 ...
 *
 */
#ifndef _TESTBENCH_NONE_MODULE_GENERATOR_HPP_
#define _TESTBENCH_NONE_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class TestbenchNoneModuleGenerator : public ModuleGenerator::Registrar<TestbenchNoneModuleGenerator>
{
 public:
