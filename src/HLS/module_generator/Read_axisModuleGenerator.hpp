 ...
 */
/**
 * @file Read_axisModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _READ_AXIS_MODULE_GENERATOR_HPP_
#define _READ_AXIS_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class Read_axisModuleGenerator : public ModuleGenerator::Registrar<Read_axisModuleGenerator>
{
 public:
   Read_axisModuleGenerator(const HLS_managerRef& HLSMgr);
