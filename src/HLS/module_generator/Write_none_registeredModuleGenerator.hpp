 ...
 */
/**
 * @file Write_none_registeredModuleGenerator.hpp
 * @brief
 *
 *
 *
...
class Write_none_registeredModuleGenerator : public ModuleGenerator::Registrar<Write_none_registeredModuleGenerator>
{
 public:
