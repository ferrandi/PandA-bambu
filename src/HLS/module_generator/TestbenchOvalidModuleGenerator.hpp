 ...
 */
/**
 * @file TestbenchOvalidModuleGenerator.hpp
 * @brief
 *
 ...
 *
 */
#ifndef _TESTBENCH_OVALID_MODULE_GENERATOR_HPP_
#define _TESTBENCH_OVALID_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class TestbenchOvalidModuleGenerator : public ModuleGenerator::Registrar<TestbenchOvalidModuleGenerator>
{
 public:
