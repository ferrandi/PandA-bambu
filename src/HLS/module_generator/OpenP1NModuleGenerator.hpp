 ...
 */
/**
 * @file OpenP1NModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _OPEN_P1_N_MODULE_GENERATOR_HPP_
#define _OPEN_P1_N_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class OpenP1NModuleGenerator : public ModuleGenerator::Registrar<OpenP1NModuleGenerator>
{
 public:
