 ...
 */
/**
 * @file TestbenchFifoModuleGenerator.hpp
 * @brief
 *
 ...
 *
 */
#ifndef _TESTBENCH_FIFO_MODULE_GENERATOR_HPP_
#define _TESTBENCH_FIFO_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class TestbenchFifoModuleGenerator : public ModuleGenerator::Registrar<TestbenchFifoModuleGenerator>
{
 public:
