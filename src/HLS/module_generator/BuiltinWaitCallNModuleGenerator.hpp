 ...
 */
/**
 * @file BuiltinWaitCallNModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _BUILTIN_WAIT_CALL_N_MODULE_GENERATOR_HPP_
#define _BUILTIN_WAIT_CALL_N_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class BuiltinWaitCallNModuleGenerator : public ModuleGenerator::Registrar<BuiltinWaitCallNModuleGenerator>
{
 public:
