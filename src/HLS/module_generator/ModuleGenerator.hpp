 ...
 *
 */
#ifndef _MODULE_GENERATOR_FACTORY_HPP_
...
class ModuleGenerator : public Factory<ModuleGenerator, const HLS_managerRef&>
{
 public:
   struct parameter
   {
 ...
 protected:
   ...
   ModuleGenerator(Key, const HLS_managerRef& _HLSMgr) : HLSMgr(_HLSMgr)
   {
   }
