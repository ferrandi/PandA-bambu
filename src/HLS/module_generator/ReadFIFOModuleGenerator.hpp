 ...
 */
/**
 * @file ReadFIFOModuleGenerator.hpp
 * @brief
 *
 *
 *
...
class ReadFIFOModuleGenerator : public ModuleGenerator::Registrar<ReadFIFOModuleGenerator>
{
 public:
   ReadFIFOModuleGenerator(const HLS_managerRef& HLSMgr);
