 ...
 */
/**
 * @file WriteAXISModuleGenerator.hpp
 * @brief
 *
 *
 *
...
class WriteAXISModuleGenerator : public ModuleGenerator::Registrar<WriteAXISModuleGenerator>
{
 public:
   WriteAXISModuleGenerator(const HLS_managerRef& HLSMgr);
