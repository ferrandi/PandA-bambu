 ...
 */
/**
 * @file ReadWriteArrayModuleGenerator.hpp
 * @brief
 *
 *
 *
 ...
 *
 */
#ifndef _READ_WRITE_ARRAY_MODULE_GENERATOR_HPP_
#define _READ_WRITE_ARRAY_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class ReadWriteArrayModuleGenerator : public ModuleGenerator::Registrar<ReadWriteArrayModuleGenerator>
{
 public:
   ReadWriteArrayModuleGenerator(const HLS_managerRef& HLSMgr);
