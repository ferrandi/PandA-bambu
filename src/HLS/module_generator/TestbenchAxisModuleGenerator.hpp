 ...
 */
/**
 * @file TestbenchAxisModuleGenerator.hpp
 * @brief
 *
 ...
 *
 */
#ifndef _TESTBENCH_AXIS_MODULE_GENERATOR_HPP_
#define _TESTBENCH_AXIS_MODULE_GENERATOR_HPP_

#include "ModuleGenerator.hpp"

class TestbenchAxisModuleGenerator : public ModuleGenerator::Registrar<TestbenchAxisModuleGenerator>
{
 public:
