 ...
 */
/**
 * @file WriteAcknowledgeModuleGenerator.cpp
 * @brief
 *
 *
 *
...
#include "WriteAcknowledgeModuleGenerator.hpp"

#include "language_writer.hpp"

WriteAcknowledgeModuleGenerator::WriteAcknowledgeModuleGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void WriteAcknowledgeModuleGenerator::InternalExec(std::ostream& out, const module* /* mod */,
                                                   ...
                                                   const std::vector<ModuleGenerator::parameter>& /* _ports_inout */)
{
   ...
   out << "begin\n";
   out << "  for(ii=0; ii<PORTSIZE_" << _ports_in[3].name << "; ii=ii+1)\n";
   out << "    " << _ports_out[0].name << "[ii] = (" << _ports_in[2].name << "[ii] & " << _ports_in[6].name
