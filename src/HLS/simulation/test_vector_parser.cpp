...
void TestVectorParser::ParseXMLFile(
      std::vector<std::map<std::string, std::string> > & test_vectors) const
{
...
size_t TestVectorParser::ParseTestVectors
(std::vector<std::map<std::string, std::string> > & test_vectors)
const
{
...
void TestVectorParser::Initialize()
{
   ...
   {
      input_xml_filename =
         parameters->getOption<std::string>(OPT_testbench_input_xml);
...
<
   ...
   >
>
TestVectorParser::ComputeHLSRelationships
