   ...
   for(const auto& function_parameter : function_parameters)
   {
      if(function_parameter.first != HLS->functionId)
      {
         data_bus_bitsize = std::max(
             data_bus_bitsize, ir_helper::SizeAlloc(HLSMgr->get_ir_manager()->GetIRNode(function_parameter.first)));
      }
   }
...
void WB4_interface::build_WB4_bus_interface(structural_managerRef SM)
{
   ...
   // Parameters
   const auto functionName = ir_helper::GetFunctionName(HLSMgr->get_ir_manager()->GetIRNode(HLS->functionId));
                                             ...
                                             structural_objectRef interfaceObj)
{
   ...
   if(is_master)
   {
      ...
      if(is_slave) // add the control logic for the multiplexers
      {
         ...
         auto constBaseAddress =
             SM->add_constant("const_base_address", interfaceObj, addr_type,
                              baseAddressParameter + " + " + STR(HLSMgr->Rmem->get_first_address(HLS->functionId)));
         SM->add_connection(arcBase, constBaseAddress);

         auto constMaxAddress = SM->add_constant("const_max_address", interfaceObj, addr_type,
                                                 baseAddressParameter + " + " +
                                                     STR(HLSMgr->Rmem->get_last_address(HLS->functionId, HLSMgr)));
         SM->add_connection(arcMaxAddress, constBaseAddress);
         ...
         if(!only_mm_parameters_allocated)
         {
            ...
            const auto is_openmp = parameters->isOption(OPT_openmp) && parameters->getOption<bool>(OPT_openmp);
      ...
      if(is_master)
      {
         ...
         else
         {
            ...
            structural_objectRef weMux = SM->add_module_from_technology_library(
                "weMux", MUX2_GATE_STD, HLS->HLS_D->get_technology_manager()->get_library(MUX2_GATE_STD), interfaceObj,
            ...
            structural_objectRef oeMux = SM->add_module_from_technology_library(
                "oeMux", MUX2_GATE_STD, HLS->HLS_D->get_technology_manager()->get_library(MUX2_GATE_STD), interfaceObj,
                HLS->HLS_D->get_technology_manager());
      ...
      if(is_master)
      {
         ...
         else
         {
            ...
            structural_objectRef wDataMux = SM->add_module_from_technology_library(
                "wDataMux", MUX2_GATE_STD, HLS->HLS_D->get_technology_manager()->get_library(MUX2_GATE_STD),
                interfaceObj, HLS->HLS_D->get_technology_manager());
      ...
      if(is_slave)
      {
         ...
         else
         {
            ...
            structural_objectRef rDataMux = SM->add_module_from_technology_library(
                "rDataMux", MUX2_GATE_STD, HLS->HLS_D->get_technology_manager()->get_library(MUX2_GATE_STD),
                interfaceObj, HLS->HLS_D->get_technology_manager());
      ...
      if(is_master)
      {
         ...
         else
         {
            ...
            structural_objectRef dRSMux = SM->add_module_from_technology_library(
                "dRSMux", MUX2_GATE_STD, HLS->HLS_D->get_technology_manager()->get_library(MUX2_GATE_STD), interfaceObj,
                HLS->HLS_D->get_technology_manager());
   ...
   if(is_slave)
   {
      ...
      GetPointer<module_o>(addressFilterAddrIS)
      ...
      if(is_master)
      {
         ...
         else
         {
            ...
            structural_objectRef addrMux = SM->add_module_from_technology_library(
                "addrMux", MUX2_GATE_STD, HLS->HLS_D->get_technology_manager()->get_library(MUX2_GATE_STD),
                interfaceObj, HLS->HLS_D->get_technology_manager());
      ...
      if(is_master)
      {
         ...
         else
         {
            ...
            structural_objectRef soutDRMux = SM->add_module_from_technology_library(
                "soutDRMux", MUX2_GATE_STD, HLS->HLS_D->get_technology_manager()->get_library(MUX2_GATE_STD),
                interfaceObj, HLS->HLS_D->get_technology_manager());
