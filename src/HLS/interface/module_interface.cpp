...
void module_interface::add_sign_vector(const structural_managerRef SM, const structural_objectRef sig1,
                                       const structural_objectRef sig2, const std::string& sig_name)
{
...
void module_interface::AddSignal(const structural_managerRef SM, const structural_objectRef component1,
                                 const std::string& port1_name, const structural_objectRef component2,
                                 const std::string& port2_name, const std::string& signal_name)
{
   ...
   INDENT_DBG_MEX(DEBUG_LEVEL_VERY_PEDANTIC, debug_level,
                  "---Connecting " + component1->get_id() + "::" + port1_name + " (Size " + STR(size1) + ") to " +
                      component2->get_id() + "::" + port2_name + " (Size " + STR(size2) + ")");
   if(size1 > size2)
   {
...
void module_interface::AddConnection(const structural_managerRef SM, const structural_objectRef component1,
                                     const std::string& port1_name, const structural_objectRef component2,
                                   ...
                                   const unsigned long long constant_size)
{
   ...
   INDENT_DBG_MEX(DEBUG_LEVEL_VERY_PEDANTIC, debug_level,
                  "---Binding " + constant_value + " to " + component->get_id() + "::" + port_name);
   structural_objectRef constant(
       new constant_o(parameters->getOption<int>(OPT_debug_level), SM->get_circ(), constant_value));
