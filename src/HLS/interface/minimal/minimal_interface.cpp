...
DesignFlowStep_Status minimal_interface::InternalExec()
{
   ...
   build_wrapper(wrappedObj, interfaceObj, SM_minimal_interface, BH);
                                      ...
                                      structural_managerRef SM_minimal_interface, const BehavioralHelperConstRef BH)
{
   ...
   bool Has_intern_shared_data =
       ...
       (top_function_ids.find(funId) != top_function_ids.end() and
   ...
   if(!DesignInterface.empty())
   {
      ...
      std::string fname = BH->get_mangled_function_name();
      ...
      auto manage_feedback1 = [&](const std::string& portS, const std::string& portM) {
         ...
         if(port1->get_kind() == port_vector_o_K)
         {
            sign = SM_minimal_interface->add_sign_vector(port2->get_id() + "_INT",
                                                         GetPointer<port_o>(port2)->get_ports_size(), interfaceObj,
                                                         port2->get_typeRef());
         }
         else
         {
      ...
      auto manage_feedback2 = [&](const std::string& portSin, const std::string& portSout, const std::string& portM) {
         ...
         if(port1Out->get_kind() == port_vector_o_K)
         {
            sign = SM_minimal_interface->add_sign_vector(port1Out->get_id() + "_INT",
                                                         GetPointer<port_o>(port1Out)->get_ports_size(), interfaceObj,
   ...
   for(unsigned int i = 0; i < GetPointer<module>(wrappedObj)->get_out_port_size(); ++i)
   {
      ...
      if(GetPointer<port_o>(port_out)->get_port_interface() != port_o::port_interface::PI_DEFAULT)
      {
         ...
         if(check_interfaces({port_o::port_interface::PI_WNONE,        port_o::port_interface::PI_WVALID,
                              ...
                              port_o::port_interface::M_AXI_WLAST,     port_o::port_interface::M_AXI_WID,
                              port_o::port_interface::M_AXI_WUSER,     port_o::port_interface::M_AXI_ARVALID,
                              port_o::port_interface::M_AXI_ARADDR,    port_o::port_interface::M_AXI_ARID,
                              port_o::port_interface::M_AXI_ARLEN,     port_o::port_interface::M_AXI_ARSIZE,
                              port_o::port_interface::M_AXI_ARBURST,   port_o::port_interface::M_AXI_ARLOCK,
                              port_o::port_interface::M_AXI_ARCACHE,   port_o::port_interface::M_AXI_ARPROT,
                              port_o::port_interface::M_AXI_ARQOS,     port_o::port_interface::M_AXI_ARREGION,
                              port_o::port_interface::M_AXI_ARUSER,    port_o::port_interface::M_AXI_RREADY,
                              port_o::port_interface::M_AXI_BREADY,    port_o::port_interface::M_AXI_BUSER,
                              port_o::port_interface::S_AXIL_AWVALID,  port_o::port_interface::S_AXIL_AWREADY,
                              port_o::port_interface::S_AXIL_AWADDR,   port_o::port_interface::S_AXIL_WVALID,
                              port_o::port_interface::S_AXIL_WREADY,   port_o::port_interface::S_AXIL_WDATA,
                              port_o::port_interface::S_AXIL_WSTRB,    port_o::port_interface::S_AXIL_ARVALID,
                              port_o::port_interface::S_AXIL_ARREADY,  port_o::port_interface::S_AXIL_ARADDR,
                              port_o::port_interface::S_AXIL_RVALID,   port_o::port_interface::S_AXIL_RREADY,
