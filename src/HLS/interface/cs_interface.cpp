...
void cs_interface::instantiate_component_parallel(structural_objectRef clock_port, structural_objectRef reset_port)
{
   ...
   resize_ctrl_parallel_ports(mem_ctrl_mod);
}
...
void cs_interface::manage_memory_ports_parallel_chained_parallel(const structural_managerRef SM, const structural_objectRef memory_module, const structural_objectRef circuit)
{
