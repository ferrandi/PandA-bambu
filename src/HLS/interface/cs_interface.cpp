...
DesignFlowStep_Status minimal_interface::InternalExec()
{
   ...
   add_parameter_port(interfaceObj,wrappedObj);   //connect port

   instantiate_component_parallel();   //instantiate memory_ctrl_top

   manage_memory_ports_parallel_chained_top(SM,wrappedObj,interfaceObj);  //connect memory port for memory_ctrl_top
...
void cs_interface::add_parameter_port(structural_objectRef circuit, structural_objectRef top_module)
{
