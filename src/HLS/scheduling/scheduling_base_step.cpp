...
schedulingBaseStep::~schedulingBaseStep() = default;

void schedulingBaseStep::Initialize()
{
...
schedulingBaseStep::ComputeHLSRelationships(const DesignFlowStep::RelationshipType relationship_type) const
{
