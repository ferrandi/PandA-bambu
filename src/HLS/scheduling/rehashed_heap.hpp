...
struct rehashed_heap : public std::priority_queue<vertex, 
                                             std::vector<vertex>, 
                                             priority_compare_functor<_Type> >
{
   /**
    * Constructor
...
struct tree_rehashed_heap : public std::unordered_map<vertex, std::vector< rehashed_heap<_Type> > >
{
   ...
   */
   typename std::vector< rehashed_heap<_Type> >::iterator top(const std::unordered_map<vertex, std::set<unsigned int> > & curren_black_list,
