...
class parametric_list_based : public Scheduling
{
   private:
      ...
      */
      void compute_starting_ending_time_asap(const vertex v, const unsigned int fu_type, const ControlStep cs, double & current_starting_time, double & current_ending_time, double &stage_period, bool &cannot_be_chained, fu_bindingRef res_binding, const ScheduleConstRef schedule, double &phi_extra_time, double setup_hold_time, CustomMap<std::pair<unsigned int, unsigned int>, double> &local_fo_correction_map);
      void compute_starting_ending_time_alap(const vertex v, const unsigned int fu_type, const ControlStep cs, double & starting_time, double & ending_time, double &op_execution_time, double &stage_period, unsigned int &n_cycles, bool &has_a_store_unbounded_as_in, fu_bindingRef res_binding, const ScheduleConstRef schedule, double &phi_extra_time, double setup_hold_time, CustomMap<std::pair<unsigned int, unsigned int>, double> & local_connection_map);
