...
class ASLAP
{
   private:
       ...
       */
      ControlStep get_min_csteps()const { return min_tot_csteps; }
       ...
       */
      ControlStep get_max_csteps() const {return max_tot_csteps;}
   ...
   public:
      ...
      enum ALAP_method
      {
         ALAP_fast, ALAP_worst_case, ALAP_with_upper, ALAP_with_upper_minus_one, ALAP_with_partial_scheduling
      };
       ...
       */
      const ScheduleConstRef CGetASAP() const { return ASAP;}

      ScheduleRef GetASAP() { return ASAP;}
       ...
       */
      const ScheduleConstRef CGetALAP() const { return ALAP;}

      /**
       * Return the ALAP (modifiable)
       */
      const ScheduleRef GetALAP() {return ALAP;}
