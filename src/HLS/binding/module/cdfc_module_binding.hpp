...
public:
    ...
    selector(_selector), weight(_weight) {}
...
class cdfc_module_binding : public fu_binding_creator
{
    protected:
      ...
      void update_slack_starting_time(const OpGraphConstRef sdg, OpVertexSet &sorted_vertices, std::unordered_map<vertex,double> &slack_time, std::unordered_map<vertex,double> &starting_time, bool update_starting_time, bool only_backward, bool only_forward);
