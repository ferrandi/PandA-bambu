                                                ...
                                                const unsigned int base_index) const
{
   ...
   const uint64_t memory_area_bitsize =
       std::max(8ull, tree_helper::Size(tree_helper::CGetType(TM->GetTreeNode(base_index))));
...
#if HAVE_ASSERTS
         const uint64_t memory_area_bitsize =
             std::max(8ull, tree_helper::Size(tree_helper::CGetType(TM->GetTreeNode(l.base_index))));
