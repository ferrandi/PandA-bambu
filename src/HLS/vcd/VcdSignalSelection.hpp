...
class VcdSignalSelection : public HLS_step
{
   protected :
       ...
       */
      void SingleStepPropagateParamToSsa
      (const TreeNodeMap<size_t> & used_ssa, const TreeNodeSet & address_parameters);
