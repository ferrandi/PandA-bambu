...
class liveness
{
   ...
   public:
      ...
      void set_live_in(const vertex & v,
            const std::set<unsigned int>::const_iterator first,
            const std::set<unsigned int>::const_iterator last);
       ...
       */
      const std::list<vertex> & get_support() const { return support_set;}
       ...
       */
      void add_op_definition(unsigned int var, vertex v) { var_op_definition[var]=v;}
       ...
       */
      void add_state_for_ending_op(vertex op, vertex v) { ending_operations[op].insert(v);}
       ...
       */
      void add_state_for_running_op(vertex op, vertex v) { running_operations[op].insert(v);}
       ...
       */
      void add_support_state(vertex v) {support_set.push_front(v);}
       ...
       */
      void add_dummy_state(vertex state) {dummy_states.insert(state);}
       ...
       */
      bool is_a_dummy_state(vertex state) {return dummy_states.find(state) != dummy_states.end();}
