...
DesignFlowStep_Status datapath_parallel_cs::InternalExec()
{
   ...
   const structural_type_descriptorRef module_type(new structural_type_descriptor("datapath_" + FB->CGetBehavioralHelper()->get_function_name()));
   THROW_ASSERT(HLS, "");
   ...
   GetPointerS<module>(datapath_cir)->set_description("Datapath RTL descrition for " + FB->CGetBehavioralHelper()->get_function_name());
