 ...
 */
/**
 * @file ReadWriteDPArrayHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the dual-port read/write array interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _READ_WRITE_DP_ARRAY_HDL_GENERATOR_HPP_
#define _READ_WRITE_DP_ARRAY_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class ReadWriteDPArrayHDLGenerator : public HDLGenerator::Registrar<ReadWriteDPArrayHDLGenerator>
{
 public:
   ReadWriteDPArrayHDLGenerator(const HLS_managerRef& HLSMgr);
