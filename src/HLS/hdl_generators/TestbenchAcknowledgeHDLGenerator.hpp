 ...
 */
/**
 * @file TestbenchAcknowledgeHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the testbench model of an acknowledge-based interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _TESTBENCH_ACKNOWLEDGE_HDL_GENERATOR_HPP_
#define _TESTBENCH_ACKNOWLEDGE_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class TestbenchAcknowledgeHDLGenerator : public HDLGenerator::Registrar<TestbenchAcknowledgeHDLGenerator>
{
 public:
   TestbenchAcknowledgeHDLGenerator(const HLS_managerRef& HLSMgr);
