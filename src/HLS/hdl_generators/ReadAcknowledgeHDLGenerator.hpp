 ...
 */
/**
 * @file ReadAcknowledgeHDLGenerator.hpp
 * @brief Declaration of the HDL generator for an acknowledge-based read interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _READ_ACKNOWLEDGE_HDL_GENERATOR_HPP_
#define _READ_ACKNOWLEDGE_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class ReadAcknowledgeHDLGenerator : public HDLGenerator::Registrar<ReadAcknowledgeHDLGenerator>
{
 public:
   ReadAcknowledgeHDLGenerator(const HLS_managerRef& HLSMgr);
