 ...
 */
/**
 * @file WriteAcknowledgeHDLGenerator.hpp
 * @brief Declaration of the HDL generator for an acknowledge-based write interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _WRITE_ACKNOWLEDGE_HDL_GENERATOR_HPP_
#define _WRITE_ACKNOWLEDGE_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class WriteAcknowledgeHDLGenerator : public HDLGenerator::Registrar<WriteAcknowledgeHDLGenerator>
{
 public:
   WriteAcknowledgeHDLGenerator(const HLS_managerRef& HLSMgr);
