 ...
 */
/**
 * @file ReadWriteMAXIHDLGenerator.cpp
 * @brief Implementation of the HDL generator for the AXI master read/write interface.
 *
 * Cache size is equal to line_size * FE_DATA_W = line_size * BITSIZE_wdata
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 * @author Giovanni Gozzi <giovanni.gozzi@polimi.it>
 *
 */
#include "ReadWriteMAXIHDLGenerator.hpp"
...
ReadWriteMAXIHDLGenerator::ReadWriteMAXIHDLGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}
                                             ...
                                             const std::vector<HDLGenerator::parameter>& /* _ports_inout */)
{
   ...
   const auto has_device_burst_type =
       HLSMgr->TryGetParameterFromParameterOrDevice<unsigned int>("axi_burst_type", hls_d, device_burst_type);
