 ...
 */
/**
 * @file ReadAcknowledgeHDLGenerator.cpp
 * @brief Implementation of the HDL generator for an acknowledge-based read interface.
 *
...
#include "ReadAcknowledgeHDLGenerator.hpp"
...
ReadAcknowledgeHDLGenerator::ReadAcknowledgeHDLGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void ReadAcknowledgeHDLGenerator::InternalExec(std::ostream& out, structural_objectRef mod, unsigned int function_id,
                                               ...
                                               const std::vector<HDLGenerator::parameter>& /* _ports_inout */)
{
   ...
   {
      THROW_ERROR("Registered acknowledge interface not yet implemented.");
   }
