 ...
 */
/**
 * @file TestbenchAXIMHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the testbench model of an AXI master interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _TESTBENCH_AXIM_HDL_GENERATOR_HPP_
#define _TESTBENCH_AXIM_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class TestbenchAXIMHDLGenerator : public HDLGenerator::Registrar<TestbenchAXIMHDLGenerator>
{
 public:
   TestbenchAXIMHDLGenerator(const HLS_managerRef& HLSMgr);
