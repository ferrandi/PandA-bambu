 ...
 */
/**
 * @file WriteFifoHDLGenerator.hpp
 * @brief Declaration of the HDL generator for a FIFO-based write interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _WRITE_FIFO_HDL_GENERATOR_HPP_
#define _WRITE_FIFO_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class WriteFifoHDLGenerator : public HDLGenerator::Registrar<WriteFifoHDLGenerator>
{
 public:
   WriteFifoHDLGenerator(const HLS_managerRef& HLSMgr);
