 ...
 */
/**
 * @file TestbenchArrayHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the testbench model of an array-based interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _TESTBENCH_ARRAY_HDL_GENERATOR_HPP_
#define _TESTBENCH_ARRAY_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class TestbenchArrayHDLGenerator : public HDLGenerator::Registrar<TestbenchArrayHDLGenerator>
{
 public:
   TestbenchArrayHDLGenerator(const HLS_managerRef& HLSMgr);
