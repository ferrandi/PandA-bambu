 ...
 */
/**
 * @file TestbenchValidHDLGenerator.cpp
 * @brief Implementation of the HDL generator for the testbench model of a valid-based interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */

#include "TestbenchValidHDLGenerator.hpp"
...
TestbenchValidHDLGenerator::TestbenchValidHDLGenerator(const HLS_managerRef& _HLSMgr) : Registrar(_HLSMgr)
{
}

void TestbenchValidHDLGenerator::InternalExec(std::ostream& out, structural_objectRef mod_cir, unsigned int function_id,
