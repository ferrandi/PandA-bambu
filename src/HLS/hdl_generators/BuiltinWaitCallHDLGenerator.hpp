 ...
 */
/**
 * @file BuiltinWaitCallHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the built-in wait call module.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _BUILTIN_WAIT_CALL_HDL_GENERATOR_HPP_
#define _BUILTIN_WAIT_CALL_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class BuiltinWaitCallHDLGenerator : public HDLGenerator::Registrar<BuiltinWaitCallHDLGenerator>
{
 public:
   BuiltinWaitCallHDLGenerator(const HLS_managerRef& HLSMgr);
