 ...
 */
/**
 * @file WriteAxisHDLGenerator.hpp
 * @brief Declaration of the HDL generator for an AXI-Stream write interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _WRITE_AXIS_HDL_GENERATOR_HPP_
#define _WRITE_AXIS_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class WriteAxisHDLGenerator : public HDLGenerator::Registrar<WriteAxisHDLGenerator>
{
 public:
   WriteAxisHDLGenerator(const HLS_managerRef& HLSMgr);
