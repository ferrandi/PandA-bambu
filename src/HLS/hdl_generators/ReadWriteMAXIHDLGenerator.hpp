 ...
 */
/**
 * @file ReadWriteMAXIHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the AXI master read/write interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _READ_WRITE_MAXI_HDL_GENERATOR_HPP_
#define _READ_WRITE_MAXI_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class ReadWriteMAXIHDLGenerator : public HDLGenerator::Registrar<ReadWriteMAXIHDLGenerator>
{
 public:
   ReadWriteMAXIHDLGenerator(const HLS_managerRef& HLSMgr);
