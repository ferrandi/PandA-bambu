 ...
 */
/**
 * @file TestbenchDUTHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the DUT wrapper used in generated testbenches.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _TESTBENCH_DUT_HDL_GENERATOR_HPP_
#define _TESTBENCH_DUT_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class TestbenchDUTHDLGenerator : public HDLGenerator::Registrar<TestbenchDUTHDLGenerator>
{
 public:
   TestbenchDUTHDLGenerator(const HLS_managerRef& HLSMgr);
