 ...
 */
/**
 * @file TestbenchHandshakeHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the testbench model of a handshake-based interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _TESTBENCH_HANDSHAKE_HDL_GENERATOR_HPP_
#define _TESTBENCH_HANDSHAKE_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class TestbenchHandshakeHDLGenerator : public HDLGenerator::Registrar<TestbenchHandshakeHDLGenerator>
{
 public:
   TestbenchHandshakeHDLGenerator(const HLS_managerRef& HLSMgr);
