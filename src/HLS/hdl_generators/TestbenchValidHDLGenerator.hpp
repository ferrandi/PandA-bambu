 ...
 */
/**
 * @file TestbenchValidHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the testbench model of a valid-based interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _TESTBENCH_VALID_HDL_GENERATOR_HPP_
#define _TESTBENCH_VALID_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class TestbenchValidHDLGenerator : public HDLGenerator::Registrar<TestbenchValidHDLGenerator>
{
 public:
   TestbenchValidHDLGenerator(const HLS_managerRef& HLSMgr);
