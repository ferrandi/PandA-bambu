 ...
 */
/**
 * @file PrintfNHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the variadic printf helper module.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _PRINTF_N_HDL_GENERATOR_HPP_
#define _PRINTF_N_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class PrintfNHDLGenerator : public HDLGenerator::Registrar<PrintfNHDLGenerator>
{
 public:
   PrintfNHDLGenerator(const HLS_managerRef& HLSMgr);
