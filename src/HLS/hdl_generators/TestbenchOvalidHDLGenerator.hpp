 ...
 */
/**
 * @file TestbenchOvalidHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the testbench model of an output-valid interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _TESTBENCH_OVALID_HDL_GENERATOR_HPP_
#define _TESTBENCH_OVALID_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class TestbenchOvalidHDLGenerator : public HDLGenerator::Registrar<TestbenchOvalidHDLGenerator>
{
 public:
   TestbenchOvalidHDLGenerator(const HLS_managerRef& HLSMgr);
