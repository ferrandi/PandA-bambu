 ...
 */
/**
 * @file WriteValidHDLGenerator.hpp
 * @brief Declaration of the HDL generator for a valid-based write interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _WRITE_VALID_HDL_GENERATOR_HPP_
#define _WRITE_VALID_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class WriteValidHDLGenerator : public HDLGenerator::Registrar<WriteValidHDLGenerator>
{
 public:
   WriteValidHDLGenerator(const HLS_managerRef& HLSMgr);
