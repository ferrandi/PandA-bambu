 ...
 */
/**
 * @file ReadHandshakeHDLGenerator.hpp
 * @brief Declaration of the HDL generator for a handshake-based read interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _READ_HANDSHAKE_HDL_GENERATOR_HPP_
#define _READ_HANDSHAKE_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class ReadHandshakeHDLGenerator : public HDLGenerator::Registrar<ReadHandshakeHDLGenerator>
{
 public:
   ReadHandshakeHDLGenerator(const HLS_managerRef& HLSMgr);
