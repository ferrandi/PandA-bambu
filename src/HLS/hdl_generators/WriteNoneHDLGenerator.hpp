 ...
 */
/**
 * @file WriteNoneHDLGenerator.hpp
 * @brief Declaration of the HDL generator for a write interface without handshake signals.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _WRITE_NONE_HDL_GENERATOR_HPP_
#define _WRITE_NONE_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class WriteNoneHDLGenerator : public HDLGenerator::Registrar<WriteNoneHDLGenerator>
{
 public:
   WriteNoneHDLGenerator(const HLS_managerRef& HLSMgr);
