 ...
 */
/**
 * @file ReadNoneHDLGenerator.hpp
 * @brief Declaration of the HDL generator for a read interface without handshake signals.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _READ_NONE_HDL_GENERATOR_HPP_
#define _READ_NONE_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class ReadNoneHDLGenerator : public HDLGenerator::Registrar<ReadNoneHDLGenerator>
{
 public:
   ReadNoneHDLGenerator(const HLS_managerRef& HLSMgr);
