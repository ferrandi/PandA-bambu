 ...
 */
/**
 * @file TestbenchFifoHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the testbench model of a FIFO-based interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _TESTBENCH_FIFO_HDL_GENERATOR_HPP_
#define _TESTBENCH_FIFO_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class TestbenchFifoHDLGenerator : public HDLGenerator::Registrar<TestbenchFifoHDLGenerator>
{
 public:
   TestbenchFifoHDLGenerator(const HLS_managerRef& HLSMgr);
