 ...
 */
/**
 * @file ReadWriteArrayHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the read/write array interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _READ_WRITE_ARRAY_HDL_GENERATOR_HPP_
#define _READ_WRITE_ARRAY_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class ReadWriteArrayHDLGenerator : public HDLGenerator::Registrar<ReadWriteArrayHDLGenerator>
{
 public:
