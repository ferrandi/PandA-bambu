 ...
 */
/**
 * @file ReadFifoHDLGenerator.hpp
 * @brief Declaration of the HDL generator for a FIFO-based read interface.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _READ_FIFO_HDL_GENERATOR_HPP_
#define _READ_FIFO_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class ReadFifoHDLGenerator : public HDLGenerator::Registrar<ReadFifoHDLGenerator>
{
 public:
   ReadFifoHDLGenerator(const HLS_managerRef& HLSMgr);
