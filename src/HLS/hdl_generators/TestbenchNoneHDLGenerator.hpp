 ...
 */
/**
 * @file TestbenchNoneHDLGenerator.hpp
 * @brief Declaration of the HDL generator for the testbench model of an interface without handshake signals.
 *
 * @author Michele Fiorito <michele.fiorito@polimi.it>
 *
 */
#ifndef _TESTBENCH_NONE_HDL_GENERATOR_HPP_
#define _TESTBENCH_NONE_HDL_GENERATOR_HPP_

#include "HDLGenerator.hpp"

class TestbenchNoneHDLGenerator : public HDLGenerator::Registrar<TestbenchNoneHDLGenerator>
{
 public:
   TestbenchNoneHDLGenerator(const HLS_managerRef& HLSMgr);
