...
class tree_manager
{
   private:
      ...
      */
       ...
       */
      void erase_usage_info(tree_nodeRef tn, tree_nodeRef stmt);
       ...
       */
      void insert_usage_info(tree_nodeRef tn, tree_nodeRef stmt);
...
// ************************+ handlers for tree_nodes structure **************************
      ...
      */
       ...
       */
      unsigned int function_index(std::string function_name) const;
      ...
      */
       ...
       */
      void ReplaceTreeNode(const tree_nodeRef tn, const tree_nodeRef old_node, tree_nodeRef new_node);
