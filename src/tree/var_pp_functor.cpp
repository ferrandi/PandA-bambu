...
pointer_var_pp_functor::pointer_var_pp_functor(const BehavioralHelperConstRef _BH, const CustomSet<unsigned int> vars, bool _add_restrict):
        pointer_based_variables(vars),
        BH(_BH),
        std_functor(std_var_pp_functor(_BH)),
        add_restrict(_add_restrict)
{
}
...
address_var_pp_functor::address_var_pp_functor(const BehavioralHelperConstRef _BH, const CustomSet<unsigned int> vars, const CustomSet<unsigned int> pointer_vars) :
        addr_based_variables(vars),
        pointer_based_variables(pointer_vars),
        BH(_BH)
{
