...
#define UNARY_EXPRESSION_TREE_NODES                                                                                   \
   (abs_expr)(addr_expr)(alignof_expr)(arrow_expr)(bit_not_expr)(buffer_ref)(card_expr)(cleanup_point_expr)(conj_expr)(             \
...
#define BINARY_EXPRESSION_TREE_NODES                                                                                   \
   (assert_expr)(bit_and_expr)(bit_ior_expr)(bit_xor_expr)(catch_expr)(ceil_div_expr)(ceil_mod_expr)(complex_expr)(    \
       ...
       sat_minus_expr)(extractvalue_expr)
...
#define TERNARY_EXPRESSION_TREE_NODES                                                                              \
   (bit_field_ref)(bit_ior_concat_expr)(component_ref)(cond_expr)(vec_cond_expr)(vec_perm_expr)(dot_prod_expr)(    \
       ...
       with_cleanup_expr)(fshl_expr)(fshr_expr)(insertvalue_expr)
...
#define GIMPLE_NODES                                                                                          \
   (gimple_asm)(gimple_assign)(gimple_bind)(gimple_call)(gimple_cond)(gimple_goto)(gimple_label)(gimple_nop)( \
       gimple_phi)(gimple_predict)(gimple_resx)(gimple_return)(gimple_switch)

#define MISCELLANEOUS_OBJ_TREE_NODES                                                                               \
   (baselink)(binfo)(block)(constructor)(ctor_initializer)(error_mark)(expr_stmt)(handler)(identifier_node)(none)( \
       null_node)(overload)(return_stmt)(ssa_name)(statement_list)(template_parm_index)(tree_list)(tree_reindex)(  \
       tree_vec)(try_block)
...
#define DECL_NODE_TREE_NODES                                                                                   \
   (const_decl)(field_decl)(function_decl)(namespace_decl)(parm_decl)(result_decl)(template_decl)(label_decl)( \
...
#define CPP_NODES                                                                                                      \
   (aggr_init_expr)(ctor_initializer)(expr_stmt)(if_stmt)(for_stmt)(handler)(modop_expr)(new_expr)(nullptr_type)(      \
       overload)(return_stmt)(scope_ref)(template_decl)(template_id_expr)(template_parm_index)(trait_expr)(try_block)( \
...
#define PANDA_PRAGMA_TREE_NODES                                                                             \
   (blackbox_pragma)(call_hw_pragma)(call_point_hw_pragma)(issue_pragma)(map_pragma)(omp_atomic_pragma)(    \
       omp_critical_pragma)(omp_declare_simd_pragma)(omp_for_pragma)(omp_parallel_pragma)(                  \
       omp_parallel_sections_pragma)(omp_pragma)(omp_section_pragma)(omp_sections_pragma)(omp_simd_pragma)( \
       omp_target_pragma)(omp_task_pragma)(profiling_pragma)(statistical_profiling)
...
enum kind : int
{
   BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY, BINARY_EXPRESSION_TREE_NODES)
       BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY,
                             CONST_OBJ_TREE_NODES) BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY, CPP_STMT_NODES)
           BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY, DECL_NODE_TREE_NODES)
               BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY, GIMPLE_NODES)
                   BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY, MISCELLANEOUS_EXPR_TREE_NODES)
                       BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY, MISCELLANEOUS_OBJ_TREE_NODES)
                           BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY, PANDA_EXTENSION_TREE_NODES)
                               BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY, QUATERNARY_EXPRESSION_TREE_NODES)
                                   BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY, TERNARY_EXPRESSION_TREE_NODES)
                                       BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY, TYPE_NODE_TREE_NODES)
                                           BOOST_PP_SEQ_FOR_EACH(TREE_NODE_KIND, BOOST_PP_EMPTY,
