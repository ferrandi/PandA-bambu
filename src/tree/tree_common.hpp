...
#define BINARY_EXPRESSION_TREE_NODES                                                                                                                                                                                                                           \
   (assert_expr)(bit_and_expr)(bit_ior_expr)(bit_xor_expr)(catch_expr)(ceil_div_expr)(ceil_mod_expr)(complex_expr)(compound_expr)(eh_filter_expr)(eq_expr)(exact_div_expr)(fdesc_expr)(floor_div_expr)(floor_mod_expr)(ge_expr)(lut_expr)(gt_expr)(            \
...
#define MISCELLANEOUS_EXPR_TREE_NODES \
   (call_expr)(aggr_init_expr)(case_label_expr)(modop_expr)(new_expr)(placeholder_expr)(scope_ref)(target_expr)(target_mem_ref)(target_mem_ref461)(template_id_expr)(trait_expr)(vec_new_expr)(nontype_argument_pack)(expr_pack_expansion)(cast_expr)
