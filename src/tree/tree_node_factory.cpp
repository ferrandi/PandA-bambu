...
void tree_node_factory::operator()(const attr* obj, unsigned int & mask)
{
   ...
   #define ATTR_SEQ (TOK_NEW) (TOK_DELETE) (TOK_ASSIGN) (TOK_MEMBER) (TOK_PUBLIC) (TOK_PROTECTED) (TOK_PRIVATE) (TOK_NORETURN)\
      ...
      (TOK_VISIBILITY) (TOK_TLS_MODEL) (TOK_NONNULL) (TOK_NOTHROW) (TOK_MAY_ALIAS) (TOK_WARN_UNUSED_RESULT) (TOK_FORMAT)\
      (TOK_FORMAT_ARG) (TOK_NULL) (TOK_GLOBAL_INIT) (TOK_GLOBAL_FINI) (TOK_CONVERSION) (TOK_VIRTUAL) (TOK_LSHIFT) (TOK_MUTABLE)\
      (TOK_PSEUDO_TMPL) (TOK_VECNEW) (TOK_VECDELETE) (TOK_POS) (TOK_NEG) (TOK_ADDR) (TOK_DEREF) (TOK_LNOT) (TOK_NOT)\
      (TOK_PREINC) (TOK_PREDEC) (TOK_PLUSASSIGN) (TOK_PLUS) (TOK_MINUSASSIGN) (TOK_MINUS) (TOK_MULTASSIGN) (TOK_MULT)\
      (TOK_DIVASSIGN) (TOK_DIV) (TOK_MODASSIGN) (TOK_MOD) (TOK_ANDASSIGN) (TOK_AND) (TOK_ORASSIGN) (TOK_OR) (TOK_XORASSIGN)\
      (TOK_XOR) (TOK_LSHIFTASSIGN) (TOK_RSHIFTASSIGN) (TOK_RSHIFT) (TOK_EQ) (TOK_NE) (TOK_LT) (TOK_GT) (TOK_LE) (TOK_GE)\
      (TOK_LAND) (TOK_LOR) (TOK_COMPOUND) (TOK_MEMREF) (TOK_REF) (TOK_SUBS) (TOK_POSTINC) (TOK_POSTDEC) (TOK_CALL) (TOK_THUNK)\
