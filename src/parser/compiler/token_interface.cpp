...
const int treeVocabularyTokenTypes::bisontokens[] = {
    TOK_BISON_COMPILER_VERSION, TOK_BISON_PLUGIN_VERSION, TOK_BISON_IDENTIFIER_NODE, TOK_BISON_TREE_LIST,
    TOK_BISON_TREE_VEC, TOK_BISON_BLOCK, TOK_BISON_VOID_TYPE, TOK_BISON_INTEGER_TYPE, TOK_BISON_REAL_TYPE,
    TOK_BISON_COMPLEX_TYPE, TOK_BISON_TYPE_ARGUMENT_PACK, TOK_BISON_NONTYPE_ARGUMENT_PACK,
