...
const int treeVocabularyTokenTypes::bisontokens[] = {
    ...
    TOK_BISON_TEMPLATE_ID_EXPR, TOK_BISON_THROW_EXPR, TOK_BISON_TRY_BLOCK, TOK_BISON_ALIGNOF_EXPR, TOK_BISON_ARROW_EXPR, TOK_BISON_HANDLER,
    TOK_BISON_BASELINK,
    ...
    TOK_BISON_USE_VARS, TOK_BISON_PREDICATE, TOK_BISON_SLOT, TOK_BISON_SAT_PLUS_EXPR, TOK_BISON_SAT_MINUS_EXPR, TOK_BISON_EXTRACTVALUE_EXPR, TOK_BISON_INSERTVALUE_EXPR,
