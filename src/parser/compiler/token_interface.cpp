...
const int treeVocabularyTokenTypes::bisontokens[] = {
    TOK_BISON_GCC_VERSION, TOK_BISON_PLUGIN_VERSION, TOK_BISON_IDENTIFIER_NODE, TOK_BISON_TREE_LIST, TOK_BISON_TREE_VEC,
    TOK_BISON_BLOCK, TOK_BISON_VOID_TYPE, TOK_BISON_INTEGER_TYPE, TOK_BISON_REAL_TYPE, TOK_BISON_COMPLEX_TYPE,
    TOK_BISON_TYPE_ARGUMENT_PACK, TOK_BISON_NONTYPE_ARGUMENT_PACK, TOK_BISON_EXPR_PACK_EXPANSION, TOK_BISON_VECTOR_TYPE,
    TOK_BISON_ENUMERAL_TYPE, TOK_BISON_BOOLEAN_TYPE, TOK_BISON_CHAR_TYPE, TOK_BISON_NULLPTR_TYPE, TOK_BISON_ERROR_MARK,
    TOK_BISON_TYPE_PACK_EXPANSION, TOK_BISON_POINTER_TYPE, TOK_BISON_OFFSET_TYPE, TOK_BISON_REFERENCE_TYPE,
    TOK_BISON_METHOD_TYPE, TOK_BISON_ARRAY_TYPE, TOK_BISON_SET_TYPE, TOK_BISON_RECORD_TYPE, TOK_BISON_UNION_TYPE,
    TOK_BISON_QUAL_UNION_TYPE, TOK_BISON_FUNCTION_TYPE, TOK_BISON_LANG_TYPE, TOK_BISON_INTEGER_CST, TOK_BISON_REAL_CST,
    TOK_BISON_COMPLEX_CST, TOK_BISON_VECTOR_CST, TOK_BISON_VOID_CST, TOK_BISON_STRING_CST, TOK_BISON_FUNCTION_DECL,
    TOK_BISON_LABEL_DECL, TOK_BISON_CONST_DECL, TOK_BISON_TYPE_DECL, TOK_BISON_USING_DECL, TOK_BISON_VAR_DECL,
    TOK_BISON_PARM_DECL, TOK_BISON_PARAM_PACKS, TOK_BISON_RESULT_DECL, TOK_BISON_FIELD_DECL, TOK_BISON_NAMESPACE_DECL,
    ...
    TOK_BISON_WRITING_MEMORY, TOK_BISON_READING_MEMORY, TOK_BISON_PIPELINE_ENABLED, TOK_BISON_INITIATION_TIME,
    TOK_BISON_OMP_ATOMIC, TOK_BISON_OMP_BODY_LOOP, TOK_BISON_OMP_CRITICAL_SESSION, TOK_BISON_OMP_FOR_WRAPPER,
    TOK_BISON_DEFAULT, TOK_BISON_VOLATILE, TOK_BISON_VARARGS, TOK_BISON_INF, TOK_BISON_NAN, TOK_BISON_ENTRY,
    TOK_BISON_EXIT, TOK_BISON_NEW, TOK_BISON_DELETE, TOK_BISON_ASSIGN, TOK_BISON_MEMBER, TOK_BISON_PUBLIC,
    TOK_BISON_PRIVATE, TOK_BISON_PROTECTED, TOK_BISON_NORETURN, TOK_BISON_NOINLINE, TOK_BISON_ALWAYS_INLINE,
    TOK_BISON_UNUSED, TOK_BISON_CONST, TOK_BISON_TRANSPARENT_UNION, TOK_BISON_MODE, TOK_BISON_SECTION,
    TOK_BISON_ALIGNED, TOK_BISON_PACKED, TOK_BISON_WEAK, TOK_BISON_ALIAS, TOK_BISON_NO_INSTRUMENT_FUNCTION,
    TOK_BISON_MALLOC, TOK_BISON_NO_STACK_LIMIT, TOK_BISON_NO_STACK, TOK_BISON_PURE, TOK_BISON_DEPRECATED,
    TOK_BISON_VECTOR_SIZE, TOK_BISON_VISIBILITY, TOK_BISON_TLS_MODEL, TOK_BISON_NONNULL, TOK_BISON_NOTHROW,
    TOK_BISON_MAY_ALIAS, TOK_BISON_WARN_UNUSED_RESULT, TOK_BISON_FORMAT, TOK_BISON_FORMAT_ARG, TOK_BISON_NULL,
    TOK_BISON_CONVERSION, TOK_BISON_VIRTUAL, TOK_BISON_MUTABLE, TOK_BISON_PSEUDO_TMPL, TOK_BISON_SPEC, TOK_BISON_LINE,
    TOK_BISON_FIXD,
