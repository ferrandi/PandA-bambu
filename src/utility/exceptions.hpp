...
#define PRINT_STACK                                                                                                 \
   ...
   {                                                                                                                \
      ...
      print_stack_stack_strings =                                                                                   \
          backtrace_symbols(print_stack_stack_addrs, static_cast<int>(print_stack_stack_depth));                    \
                                                                                                                    \
      printf("Call stack\n");                                                                                       \
                                                                                                                    \
      ...
      {                                                                                                             \
         ...
         for(char* print_stack_j = print_stack_stack_strings[print_stack_i]; *print_stack_j;                        \
             ++print_stack_j, print_stack_counter++)                                                                \
         {                                                                                                          \
            if(*print_stack_j == '(')                                                                               \
            {                                                                                                       \
         ...
         {                                                                                                          \
            ...
            *print_stack_end = 0;                                                                                   \
            ...
            char* print_stack_ret =                                                                                 \
                abi::__cxa_demangle(print_stack_begin, print_stack_function, &print_stack_sz, &print_stack_status); \
            if(print_stack_ret)                                                                                     \
            {                                                                                                       \
            ...
            {                                                                                                       \
               ...
               strncpy(print_stack_address, &((print_stack_stack_strings[print_stack_i])[print_stack_first + 1]),   \
                       print_stack_last - print_stack_first - 1);                                                   \
...
/// helper function used to check an assert and if needed to throw an error in a standard way
#if HAVE_ASSERTS
#define THROW_WARNING_ASSERT(cond, str_expr) \
   ((cond) ? (void)0 : (THROW_WARNING(std::string(str_expr) + " (" + #cond + ")")))
#else
