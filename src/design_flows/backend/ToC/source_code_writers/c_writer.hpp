...
class CWriter
{
   protected:
       ...
       */
      void writeRoutineInstructions_rec
      (
       ...
       */
      virtual void writePreInstructionInfo
       ...
       * can specify its own additional information to print
       */
      virtual void writePostInstructionInfo
      (const FunctionBehaviorConstRef, const vertex);
   ...
   public:
       ...
       */
      static
      CWriterRef CreateCWriter(
            const CBackend::Type type,
       ...
       * @param varFunc is the printer functor
       */
      virtual void DeclareLocalVariables
      (
