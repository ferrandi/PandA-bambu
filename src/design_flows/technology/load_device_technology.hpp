...
*/
/**
 * @file load_device_technology.hpp
 ...
 *
*/
#ifndef LOAD_DEVICE_TECHNOLOGY_HPP
#define LOAD_DEVICE_TECHNOLOGY_HPP
 ...
 */
class LoadDeviceTechnology : public TechnologyFlowStep
{
   protected:
      /**
   ...
   public:
       ...
       */
      LoadDeviceTechnology(const technology_managerRef TM, const target_deviceRef target, const DesignFlowManagerConstRef design_flow_manager, const ParameterConstRef parameters);

      /**
       * Destructor
       */
      ~LoadDeviceTechnology();
