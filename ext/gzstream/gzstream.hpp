...
// ============================================================================
//
// PandA/Bambu modifications:
// Copyright (C) 2004-2026 Politecnico di Milano
//
// This local version is a header-only refactoring of the original gzstream
// implementation, with minor C++ interface updates. It remains licensed under
// LGPL-2.1-or-later as a derivative of the original gzstream code.
//
// The maintained PandA/Bambu variant lives in ext/gzstream/ alongside the
// upstream import so local changes and provenance stay co-located.
// ============================================================================
#ifndef GZSTREAM_HPP
#define GZSTREAM_HPP
