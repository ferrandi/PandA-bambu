...
size_t linear_search(Seq const &I, typename Seq::value_type const &v, const F &less) {
...
template<typename Seq, typename F>
size_t binary_search(Seq const &I, typename Seq::value_type const &v, const F &less) {
  size_t start = 0;
  size_t end = I.size();
