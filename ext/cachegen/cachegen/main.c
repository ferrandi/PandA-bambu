...
#define COMPARATOR_TOPFILE "design/_comparator.vlg"
#define BRAM_TOPFILE "design/STD_SP_BRAM.vlg"
...
char cmdoptions[NUMOPTIONS][2] = {"h", "e", "i", "w"};
...
void directcachegen(int w, int d, int data, int intercept, int cachehit, int twocycle, char* dir)
{
   ...
   copyFileInto(f, COMPARATOR_TOPFILE);
   copyFileInto(f, BRAM_TOPFILE);
