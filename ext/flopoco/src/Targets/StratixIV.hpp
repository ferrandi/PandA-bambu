...
namespace flopoco{
	...
	public:
		...
		double DSPAdderDelay() override{ return DSPAdderDelay_;} //TODO
		double DSPCascadingWireDelay() override{ return DSPCascadingWireDelay_;}//TODO
