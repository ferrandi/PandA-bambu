/*
  ...
  Authors: Florent de Dinechin, Sebastian Banescu, Matei Istoan
...
namespace flopoco{
	...
	double StratixIV::adder3Delay(int size) 
	{
		int subAdd = 0;
	...
	bool StratixIV::suggestSubadd3Size(int &x, int wIn)
	{
	...
	bool  StratixIV::suggestSlackSubadd3Size(int &x, int wIn, double slack)
	{
	...
	void StratixIV::delayForDSP(MultiplierBlock* multBlock, double currentCp, int& cycleDelay, double& cpDelay)
	{
