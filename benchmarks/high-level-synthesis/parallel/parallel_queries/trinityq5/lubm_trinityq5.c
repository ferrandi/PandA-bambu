...
void kernel(size_t i_var_3, Graph * graph, NodeId var_2, PropertyId p_var_3, PropertyId p_var_4, PropertyId p_var_5, size_t in_degree_var_2, Edge * var_2_1_inEdges)
{
...
__attribute__((noinline))
void parallel(Graph * graph, NodeId var_2, PropertyId p_var_3, PropertyId p_var_4, PropertyId p_var_5, size_t in_degree_var_2, Edge * var_2_1_inEdges)
{
   size_t i_var_3;
