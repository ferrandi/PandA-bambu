...
void kernel(size_t i_var_3, Graph * graph, NodeId var_2, PropertyId p_var_3, PropertyId p_var_5, Edge * var_2_1_inEdges)
{
...
__attribute__((noinline))
void parallel(Graph * graph, NodeId var_2, PropertyId p_var_3, PropertyId p_var_5, Edge * var_2_1_inEdges, size_t in_degree_var_2)
{
  size_t i_var_3;
...
__attribute__((noinline))
void search(Graph * graph, NodeId var_2, PropertyId p_var_3, PropertyId p_var_5)
{
#ifndef DEBUG
...
// p_var_3 = "a" 14
// p_var_5 = "ub:name" 17
  search(&TheGraph, var_2, p_var_3, p_var_5);
  printf("%d\n", numAnswers);
  return numAnswers;
}
