...
void kernel(size_t i_var_3, Graph * graph, NodeId var_2, PropertyId p_var_3, PropertyId p_var_4, PropertyId p_var_5, PropertyId p_var_7, PropertyId p_var_8, PropertyId p_var_9, size_t in_degree_var_2, Edge * var_2_1_inEdges)
{
...
__attribute__((noinline))
void parallel(Graph * graph, NodeId var_2, PropertyId p_var_3, PropertyId p_var_4, PropertyId p_var_5, PropertyId p_var_7, PropertyId p_var_8, PropertyId p_var_9, size_t in_degree_var_2, Edge * var_2_1_inEdges)
{
   size_t i_var_3;
   #pragma omp parallel for
   for(i_var_3=0; i_var_3 < in_degree_var_2; i_var_3++)
   {
     kernel(i_var_3, graph, var_2, p_var_3, p_var_4, p_var_5, p_var_7, p_var_8, p_var_9, in_degree_var_2, var_2_1_inEdges);
   }
}

__attribute__((noinline))
void search(Graph * graph, NodeId var_2, PropertyId p_var_3, PropertyId p_var_4, PropertyId p_var_5, PropertyId p_var_7, PropertyId p_var_8, PropertyId p_var_9)
{
#ifndef DEBUG
...
// p_var_9 = "a" 14
  search(&TheGraph, var_2, p_var_3, p_var_4, p_var_5, p_var_7, p_var_8, p_var_9);
