...
BATCH_ARGS=("--hls-div" "--experimental-setup=BAMBU-PERFORMANCE-MP" "--top-fname=run_benchmark" ""-mx32" "-fno-tree-vectorize" "--simulate" "--simulator=VERILATOR" "-s" "-DBAMBU_PROFILING")
