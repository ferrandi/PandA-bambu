...
timeout 2h bambu $root_dir/main_test.c $root_dir/top.c $root_dir/module_lib.xml --top-fname=main \
   $root_dir/constraints_STD.xml --experimental-setup=BAMBU --memory-allocation-policy=ALL_BRAM -O3 \
