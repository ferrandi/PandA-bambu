...
set_property PACKAGE_PIN K5 [get_ports done_port]					
set_property IOSTANDARD LVCMOS33 [get_ports done_port]
...
##here used as accelerator reset
set_property PACKAGE_PIN C12 [get_ports reset]				
set_property IOSTANDARD LVCMOS33 [get_ports reset]

##Bank = 15, Pin name = IO_L11N_T1_SRCC_15,					Sch name = BTNC
##here used as start port
set_property PACKAGE_PIN E16 [get_ports start_port]						
set_property IOSTANDARD LVCMOS33 [get_ports start_port]

##Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
##here used to terminate the execution
