...
ARGS="--simulator=MODELSIM --compiler=I386_GCC49 --evaluation --no-iob --device-name=5SGXEA7N2F45C1 --print-dot --aligned-access --clock-period=2.5 --speculative-sdc-scheduling -fno-delete-null-pointer-checks  --panda-parameter=simple-benchmark-name=1"
NAME=$(basename $0 .sh)
DIRNAME=${root_dir##*/}
