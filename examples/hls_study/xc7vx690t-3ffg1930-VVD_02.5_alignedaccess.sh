...
ARGS="--simulator=MODELSIM --compiler=I386_GCC49 --evaluation --no-iob --device=xc7vx690t,-3,ffg1930,VVD --print-dot --aligned-access --clock-period=2.5  --speculative-sdc-scheduling -fno-delete-null-pointer-checks  --panda-parameter=simple-benchmark-name=1"
NAME=$(basename $0 .sh)
DIRNAME=${root_dir##*/}
