...
BATCH_ARGS=("-lm" "-fno-delete-null-pointer-checks" "-fopenmp" "--mem-delay-read=20" "--mem-delay-write=20" "--tb-queue-size=20" "--channels-type=MEM_ACC_NN" "--generate-interface=INFER" "--memory-allocation-policy=NO_BRAM" "--bus-pipelined" "-DMAX_VERTEX_NUMBER=1309073" "-DMAX_EDGE_NUMBER=5309056" "--max-sim-cycles=2000000000")
