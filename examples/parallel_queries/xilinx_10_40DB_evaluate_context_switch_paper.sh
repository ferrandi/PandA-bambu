...
`dirname $0`/../../../../etc/scripts/test_panda.py --spider-style="../lib/latex_format_bambu_results_xilinx.xml" --tool=bambu -l`dirname $0`/list_40DB -ooutput_$NAME --commonargs="$COMMONARGS"  --ulimit="-f 4097152 -v 8388608 -s 16384"\
      ...
      --args="--configuration-name=16W-04CH-2C-02CS -DN_THREADS=8  --num-threads=8  --memory-banks-number=4  --channels-number=2 --context_switch=2"\
      --args="--configuration-name=16W-04CH-2C-04CS -DN_THREADS=8  --num-threads=8  --memory-banks-number=4  --channels-number=2 --context_switch=4"\
      --args="--configuration-name=16W-04CH-2C-08CS -DN_THREADS=8  --num-threads=8  --memory-banks-number=4  --channels-number=2 --context_switch=8"\
      --args="--configuration-name=16W-04CH-2C-16CS -DN_THREADS=8  --num-threads=8  --memory-banks-number=4  --channels-number=2 --context_switch=16"\
