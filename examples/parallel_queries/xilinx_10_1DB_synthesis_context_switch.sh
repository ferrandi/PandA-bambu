...
`dirname $0`/../../../../etc/scripts/test_panda.py --spider-style="../lib/latex_format_bambu_results_xilinx.xml" --tool=bambu -l`dirname $0`/list_1DB -ooutput_$NAME --commonargs="$COMMONARGS" \
      ...
      --args="--configuration-name=4W-16CH-2C-16CS -DN_THREADS=4 --num-threads=4 --memory-banks-number=16 --channels-number=2 --context_switch=16"\
      --args="--configuration-name=4W-32CH-2C-2CS -DN_THREADS=4 --num-threads=4 --memory-banks-number=32 --channels-number=2 --context_switch=2"\
      --args="--configuration-name=4W-32CH-2C-4CS -DN_THREADS=4 --num-threads=4 --memory-banks-number=32 --channels-number=2 --context_switch=4"\
      --args="--configuration-name=4W-32CH-2C-8CS -DN_THREADS=4 --num-threads=4 --memory-banks-number=32 --channels-number=2 --context_switch=8"\
      --args="--configuration-name=4W-32CH-2C-16CS -DN_THREADS=4 --num-threads=4 --memory-banks-number=32 --channels-number=2 --context_switch=16"\
