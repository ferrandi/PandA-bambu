...
W_info = helper.make_tensor_value_info('W', TensorProto.FLOAT, [1,8])
W = np.ones((1,8)).astype(np.float32)
W = numpy_helper.from_array(W, 'W')

B_info = helper.make_tensor_value_info('B', TensorProto.FLOAT, [8])
...
onnx.save_model(model_def, '04_dense_a.onnx')
