...
#if USE_CACHE == 1
#pragma HLS bus bank_number = 4 chunk_size = 64
#elif USE_AXI == 1
#pragma HLS bus bank_number = 4 chunk_size = 64 mode = m_axi
#elif BANK_NUMBER == 2
#pragma HLS bus bank_number = 2 chunk_size = 64 mode = m_axi
#elif BANK_NUMBER == 4
#pragma HLS bus bank_number = 4 chunk_size = 64
#elif BANK_NUMBER == 8
#pragma HLS bus bank_number = 8 chunk_size = 64
#endif
#if CACHE_64b_16d == 1
...
#endif
void __attribute__((noinline)) vector_op(float* const a, float* const b, float* const c, int n)
{
   unsigned i, j;
