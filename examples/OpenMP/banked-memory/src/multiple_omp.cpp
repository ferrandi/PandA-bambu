...
#if USE_CACHE == 1
#pragma HLS bus bank_number = 4 chunk_size = 16
#elif USE_AXI == 1
#pragma HLS bus bank_number = 4 chunk_size = 16 mode = m_axi
#elif BANK_NUMBER == 2
#pragma HLS bus bank_number = 2 chunk_size = 16 mode = m_axi
#elif BANK_NUMBER == 4
#pragma HLS bus bank_number = 4 chunk_size = 16
#elif BANK_NUMBER == 8
#pragma HLS bus bank_number = 8 chunk_size = 16
#endif
#if CACHE_64b_16d == 1
...
#endif
void __attribute__((noinline)) vector_add(float* const a, float* const b, float* const c, char n)
{
   unsigned i;
