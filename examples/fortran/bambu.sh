...
cd fortran_hls1
echo "#synthesis"
bambu -v2 --print-dot $root_dir/euclid.copy.f -fno-underscoring --top-fname=ngcd --generate-tb=$root_dir/test.copy.xml --print-dot --evaluation --speculative-sdc-scheduling --no-iob --pretty-print=a.c
return_value=$?
