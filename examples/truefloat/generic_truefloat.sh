...
BATCH_ARGS=("--registered-inputs=top" "--bambu-parameter=profile-top=1" "--simulate" "--fp-format-propagate" "-DBAMBU_SKIP_VERIFICATION")
BATCH_ARGS+=("--tb-extra-cc-options=-D_FILE_OFFSET_BITS=64" "--generate-tb=${script_dir}/common/harness.c" "--generate-tb=${script_dir}/common/support.c" "--generate-tb=$(readlink -e ${script_dir}/../../etc/libbambu/softfloat/softfloat.c)")
