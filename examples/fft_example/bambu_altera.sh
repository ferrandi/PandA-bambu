...
timeout 2h bambu_OPTION="-v4 -lm -fsingle-precision-constant --evaluation -Os --device-name=EP2C70F896C6-R -ffast-math --libm-std-rounding --experimental-setup=BAMBU"
