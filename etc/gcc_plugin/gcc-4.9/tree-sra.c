...
static bool
needs_to_live_in_memory_local (const_tree t)
{
...
maybe_add_sra_candidate (tree var)
{
  ...
  if (needs_to_live_in_memory_local (var))
    {
...
const pass_data pass_data_sra_earlyAggressive =
{
  GIMPLE_PASS, /* type */
  "esraAggressive", /* name */
...
class pass_sra_earlyAggressive : public gimple_opt_pass
{
public:
  pass_sra_earlyAggressive (gcc::context *ctxt)
    : gimple_opt_pass (pass_data_sra_earlyAggressive, ctxt)
  {}
...
}; // class pass_sra_earlyAggressive

} // anon namespace

gimple_opt_pass *
make_pass_sra_earlyAggressive (gcc::context *ctxt)
{
  return new pass_sra_earlyAggressive (ctxt);
}

namespace {

const pass_data pass_data_sraAggressive =
{
  GIMPLE_PASS, /* type */
  "sraAggressive", /* name */
  OPTGROUP_NONE, /* optinfo_flags */
...
class pass_sraAggressive : public gimple_opt_pass
{
public:
  pass_sraAggressive (gcc::context *ctxt)
    : gimple_opt_pass (pass_data_sraAggressive, ctxt)
  {}
...
}; // class pass_sraAggressive

} // anon namespace

gimple_opt_pass *
make_pass_sraAggressive (gcc::context *ctxt)
{
  return new pass_sraAggressive (ctxt);
}
...
const pass_data pass_data_early_ipa_sraAggressive =
{
  GIMPLE_PASS, /* type */
  "eipa_sraAggressive", /* name */
  OPTGROUP_NONE, /* optinfo_flags */
  true, /* has_gate */
  true, /* has_execute */
  TV_IPA_SRA, /* tv_id */
...
class pass_early_ipa_sraAggressive : public gimple_opt_pass
{
public:
  pass_early_ipa_sraAggressive (gcc::context *ctxt)
    : gimple_opt_pass (pass_data_early_ipa_sraAggressive, ctxt)
  {}
...
}; // class pass_early_ipa_sraAggressive

} // anon namespace

gimple_opt_pass *
make_pass_early_ipa_sraAggressive (gcc::context *ctxt)
{
  return new pass_early_ipa_sraAggressive (ctxt);
}
