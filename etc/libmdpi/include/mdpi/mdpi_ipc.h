...
#ifndef __M_IPC_FILENAME_ENV
#define __M_IPC_FILENAME_ENV "BAMBU_IPC_FILENAME"
#endif

#define __M_IPC_FILENAME "panda_ipc_mmap"

#ifndef __M_IPC_SIM_CMD_ENV
#define __M_IPC_SIM_CMD_ENV "BAMBU_IPC_SIM_CMD"
#endif
...
#define MDPI_IF_IDX_OUT_OF_BOUNDS (UINT16_MAX)
#define MDPI_IF_IDX_EMPTY (UINT16_MAX - 1)
...
static inline const char* __ipc_filename()
{
   char* path = getenv(__M_IPC_FILENAME_ENV);
   if(path)
   {
      return path;
   }
   return __M_IPC_FILENAME;
}
