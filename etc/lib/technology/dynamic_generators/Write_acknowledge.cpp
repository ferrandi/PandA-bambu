...
std::cout << "      started[ii] <= (started[ii] | " << _ports_in[2].name << "[ii]) & !(validated[ii] | " << _ports_in[6].name << ");\n";
std::cout << "always @(posedge clock 1RESET_EDGE)\n";
std::cout << "  if (1RESET_VALUE)\n";
std::cout << "    validated <= 0;\n";
std::cout << "  else\n";
std::cout << "    for(ii=0; ii<PORTSIZE_"<< _ports_in[3].name << "; ii=ii+1)\n";
std::cout << "      validated[ii] <= (validated[ii] | " << _ports_in[6].name << ") & !(started[ii] | " << _ports_in[2].name << "[ii]);\n";
std::cout << "always @(posedge clock 1RESET_EDGE)\n";
std::cout << "  if (1RESET_VALUE)\n";
