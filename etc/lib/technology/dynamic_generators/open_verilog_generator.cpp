...
std::string fsm = "\
  ...
  \n\
  always @(_present_state or _present_pointer or _present_index or start_port or M_DataRdy or Min_we_ram or Min_oe_ram or Min_Wdata_ram or Min_addr_ram or Min_data_ram_size" +
                  sensitivity + " or M_Rdata_ram)\n\
      begin\n\
