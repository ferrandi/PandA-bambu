...
std::cout << "reg [PORTSIZE_" << _ports_in[3].name << "-1:0] validated 1INIT_ZERO_VALUE;\n";
std::cout << "reg [PORTSIZE_" << _ports_in[3].name << "-1:0] validated0 1INIT_ZERO_VALUE;\n";
...
std::cout << "reg [" << _ports_out[1].type_size << "-1:0] reg_" << _ports_out[1].name << " 1INIT_ZERO_VALUE;\n";
...
std::cout << "always @(*)\n";
std::cout << "  for(ii=0; ii<PORTSIZE_"<< _ports_in[3].name << "; ii=ii+1)\n";
std::cout << "    validated0[ii] <= (validated[ii] | " << _ports_in[6].name << ") & !(started[ii] | " << _ports_in[2].name << "[ii]);\n";
...
std::cout << "  else\n";
std::cout << "    for(ii=0; ii<PORTSIZE_"<< _ports_in[3].name << "; ii=ii+1)\n";
std::cout << "      validated[ii] <= validated0[ii];\n";

std::cout << "always @(posedge clock 1RESET_EDGE)\n";
std::cout << "  if (1RESET_VALUE)\n";
std::cout << "    reg_" << _ports_out[1].name << " <= 0;\n";
std::cout << "  else if(|" << _ports_in[2].name << ")\n";
std::cout << "    reg_" << _ports_out[1].name << " <= "<< _ports_out[1].name <<"_0;\n";

std::cout << "assign " << _ports_out[1].name << " = (|" << _ports_in[2].name << ") ? " << _ports_out[1].name << "_0 : reg_" << _ports_out[1].name << ";\n";
std::cout << "always @(*)\n";
std::cout << "begin\n";
