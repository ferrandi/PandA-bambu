...
\n\
  ...
  always @(_present_state or _present_pointer or _present_index or start_port or mem_done_port or Min_we_ram or Min_oe_ram or Min_Wdata_ram or Min_addr_ram or Min_data_ram_size" + sensitivity + " or mem_out1)\n\
      begin\n\
        done_port = 1'b0;\n\
