...
std::cout << "  variable \\" << _ports_out[1].name << "_0\\ : std_logic_vector(" << _ports_out[1].type_size
          << "-1  downto 0);\n";
std::cout << "begin\n";
...
std::cout << "          if(unsigned(" << _ports_in[3].name << "(BITSIZE_" << _ports_in[3].name
          << "*(ii0+1)-1 downto BITSIZE_" << _ports_in[3].name << "*ii0)) >=" << _ports_out[1].type_size << ") then\n";
std::cout << "            \\" << _ports_out[1].name << "_0\\ := std_logic_vector(unsigned(resize(unsigned("
          << _ports_in[4].name << "(BITSIZE_" << _ports_in[4].name << "*(ii0+1)-1 downto BITSIZE_" << _ports_in[4].name
          << "*ii0)), " << _ports_out[1].type_size << ")));\n";
std::cout << "          elsif ((unsigned(" << _ports_in[3].name << "(BITSIZE_" << _ports_in[3].name
...
std::cout << "            \\" << _ports_out[1].name << "_0\\ := \\" << _ports_out[1].name
...
std::cout << "      else\n";
std::cout << "        \\" << _ports_out[1].name << "\\ <= std_logic_vector(resize(unsigned(" << _ports_in[4].name
          << "), " << _ports_out[1].type_size << "));" << std::endl;
std::cout << "      end if;\n";
std::cout << "    end if;\n";
std::cout << "  end if;\n";
