...
/**
 * @file Write_fifo.cpp
 * @brief Snippet for the Write_fifo dynamic generator.
 *
...
std::cout << "reg [PORTSIZE_" << _ports_in[3].name << "-1:0] " << _ports_out[0].name << "0 1INIT_ZERO_VALUE;\n";
...
std::cout << "begin\n";
std::cout << "  for(ii=0; ii<PORTSIZE_"<< _ports_in[3].name << "; ii=ii+1)\n";
std::cout << "    " << _ports_out[0].name << "0[ii] = ("<< _ports_in[2].name <<"[ii] & " << _ports_in[6].name << ") | (started[ii] & " << _ports_in[6].name << ") ;" <<std::endl;
 std::cout << "end\n";
