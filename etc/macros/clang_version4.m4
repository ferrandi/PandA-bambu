...
PLUGIN_TEST
      for plugin_compiler in $I386_CLANGPP4_EXE; do
         ...
         echo "compiling plugin $plugin_compiler -I$TOPSRCDIR/etc/clang_plugin/ $I386_LLVM4_CXXFLAGS -c plugin_test.cpp -o plugin_test.o"
         $plugin_compiler -I$TOPSRCDIR/etc/clang_plugin/ $I386_LLVM4_CXXFLAGS -c plugin_test.cpp -o plugin_test.o 2> /dev/null
