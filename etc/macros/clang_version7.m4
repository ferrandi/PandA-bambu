...
PLUGIN_TEST
      for plugin_compiler in $I386_CLANGPP7_EXE; do
         ...
         echo "compiling plugin $plugin_compiler -I$TOPSRCDIR/etc/clang_plugin/ $I386_LLVM7_CXXFLAGS -c plugin_test.cpp -o plugin_test.o"
         case $host_os in
           mingw*) 
             I386_CLANG7_PLUGIN_COMPILER=$plugin_compiler
             ;;
           *)
             $plugin_compiler -I$TOPSRCDIR/etc/clang_plugin/ $I386_LLVM7_CXXFLAGS -c plugin_test.cpp -o plugin_test.o 2> /dev/null
