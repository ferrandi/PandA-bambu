...
*----------------------------------------------------------------------------*/
static __float32 __int32_to_float32( __int32 );SF_ADAPTER3_unary(__int32_to_float32,32,32);
static inline __float32 __int8_to_float32( __int8 a) {return __int32_to_float32(a);}SF_ADAPTER3_unary(__int8_to_float32,8,32);
static inline __float32 __int16_to_float32( __int16 a) {return __int32_to_float32(a);}SF_ADAPTER3_unary(__int16_to_float32,16,32);
static __float32 __uint32_to_float32( __uint32 );SF_UADAPTER3_unary(__uint32_to_float32,32,32);
static inline __float32 __uint8_to_float32( __uint8 a) {return __uint32_to_float32(a);}SF_UADAPTER3_unary(__uint8_to_float32,8,32);
static inline __float32 __uint16_to_float32( __uint16 a) {return __uint32_to_float32(a);}SF_UADAPTER3_unary(__uint16_to_float32,16,32);
static __float64 __int32_to_float64( __int32 );SF_ADAPTER3_unary(__int32_to_float64,32,64);
static __float64 __uint32_to_float64( __uint32 );SF_UADAPTER3_unary(__uint32_to_float64,32,64);
#ifdef FLOATX80
...
*----------------------------------------------------------------------------*/
static __int32 __float32_to_int32( __float32 );SF_ADAPTER2_unary(__float32_to_int32,32,32);
static __int32 __float32_to_int32_round_to_zero( __float32 );SF_ADAPTER2_unary(__float32_to_int32_round_to_zero,32,32);
static __uint32 __float32_to_uint32_round_to_zero( __float32 a); SF_UADAPTER2_unary(__float32_to_uint32_round_to_zero,32,32);
static __int64 __float32_to_int64( __float32 );SF_ADAPTER2_unary(__float32_to_int64,32,64);
static __int64 __float32_to_int64_round_to_zero( __float32 );SF_ADAPTER2_unary(__float32_to_int64_round_to_zero,32,64);
static __uint64 __float32_to_uint64_round_to_zero( __float32 ); SF_UADAPTER2_unary(__float32_to_uint64_round_to_zero,32,64);
static __float64 __float32_to_float64( __float32 );SF_ADAPTER4_unary(__float32_to_float64,32,64);
#ifdef FLOATX80
static __floatx80 __float32_to_floatx80( __float32 );SF_ADAPTER4_unary(__float32_to_floatx80,32,x80);
#endif
#ifdef FLOAT128
static __float128 __float32_to_float128( __float32 );SF_ADAPTER4_unary(__float32_to_float128,32,128);
#endif
...
static inline __flag __float32_ge( __float32 a, __float32 b) {return __float32_le(b,a);}SF_ADAPTER2(__float32_ge,32);
static inline __flag __float32_gt( __float32 a, __float32 b) {return __float32_lt(b,a);}SF_ADAPTER2(__float32_gt,32);
...
*----------------------------------------------------------------------------*/
static __int32 __float64_to_int32( __float64 );SF_ADAPTER2_unary(__float64_to_int32,64,32);
static __int32 __float64_to_int32_round_to_zero( __float64 );SF_ADAPTER2_unary(__float64_to_int32_round_to_zero,64,32);
static __uint32 __float64_to_uint32_round_to_zero( __float64 a); SF_UADAPTER2_unary(__float64_to_uint32_round_to_zero,64,32);
static __int64 __float64_to_int64( __float64 );SF_ADAPTER2_unary(__float64_to_int64,64,64);
static __int64 __float64_to_int64_round_to_zero( __float64 );SF_ADAPTER2_unary(__float64_to_int64_round_to_zero,64,64);
static __uint64 __float64_to_uint64_round_to_zero( __float64 a); SF_UADAPTER2_unary(__float64_to_uint64_round_to_zero,64,64);
static __float32 __float64_to_float32( __float64 );SF_ADAPTER4_unary(__float64_to_float32,64,32);
#ifdef FLOATX80
static __floatx80 __float64_to_floatx80( __float64 );SF_ADAPTER4_unary(__float64_to_floatx80,64,x80);
#endif
#ifdef FLOAT128
static __float128 __float64_to_float128( __float64 );SF_ADAPTER4_unary(__float64_to_float128,64,128);
#endif
...
static inline __flag __float64_ge( __float64 a, __float64 b) {return __float64_le(b,a);}SF_ADAPTER2(__float64_ge,64);
static inline __flag __float64_gt( __float64 a, __float64 b) {return __float64_lt(b,a);}SF_ADAPTER2(__float64_gt,64);
...
static __floatx80 floatx80_add( __floatx80, __floatx80 );SF_ADAPTER1(floatx80_add,x80);
static __floatx80 __floatx80_sub( __floatx80, __floatx80 );SF_ADAPTER1(__floatx80_sub,x80);
...
static inline __flag __floatx80_ge( __floatx80 a, __floatx80 b) {return __floatx80_le(b,a);}SF_ADAPTER2(__floatx80_ge,x80);
static inline __flag __floatx80_gt( __floatx80 a, __floatx80 b) {return __floatx80_lt(b,a);}SF_ADAPTER2(__floatx80_gt,x80);
...
static __float128 __float128_add( __float128, __float128 );SF_ADAPTER1(__float128_add,128);
static __float128 __float128_sub( __float128, __float128 );SF_ADAPTER1(__float128_sub,128);
...
static inline __flag __float128_ge( __float128 a, __float128 b) {return __float128_le(b,a);}SF_ADAPTER2(__float128_ge,128);
static inline __flag __float128_gt( __float128 a, __float128 b) {return __float128_lt(b,a);}SF_ADAPTER2(__float128_gt,128);
