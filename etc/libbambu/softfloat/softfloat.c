...
#ifndef NO_PARAMETRIC
    if ( roundBits ) __float_exception_flags |= float_flag_inexact;
#endif
    return z;
...
static __int64 __roundAndPackInt64( __flag zSign, __bits64 absZ0, __bits64 absZ1 )
{
 ...
 overflow:
        __float_raise( float_flag_invalid );
        return
              zSign ? (__sbits64) LIT64( 0x8000000000000000 )
            : LIT64( 0x7FFFFFFFFFFFFFFF );
    }
#ifndef NO_PARAMETRIC
    if ( absZ1 ) __float_exception_flags |= float_flag_inexact;
#endif
    return z;
...
static void
 __normalizeFloat32Subnormal( __bits32 aSig, __int16 *zExpPtr, __bits32 *zSigPtr )
{
    __int8 shiftCount;
...
static __float32 __roundAndPackFloat32( __flag zSign, __int16 zExp, __bits32 zSig )
{
    ...
    if ( 0xFD <= (__bits16) zExp ) {
        if (    ( 0xFD < zExp )
             || (    ( zExp == 0xFD )
                  && ( (__sbits32) ( zSig + roundIncrement ) < 0 ) )
           ) {
...
#else
            isTiny =
                   ( __float_detect_tininess == float_tininess_before_rounding )
                || ( zExp < -1 )
                || ( zSig + roundIncrement < 0x80000000 );
            __shift32RightJamming( zSig, - zExp, &zSig );
            zExp = 0;
            roundBits = zSig & 0x7F;
            if ( isTiny && roundBits ) __float_raise( float_flag_underflow );
#endif
        }
    }
#ifndef NO_PARAMETRIC
...
static __float32
 __normalizeRoundAndPackFloat32( __flag zSign, __int16 zExp, __bits32 zSig )
{
    __int8 shiftCount;
...
static void
 __normalizeFloat64Subnormal( __bits64 aSig, __int16 *zExpPtr, __bits64 *zSigPtr )
{
    __int8 shiftCount;
...
static __float64 __roundAndPackFloat64( __flag zSign, __int16 zExp, __bits64 zSig )
{
    ...
    if ( 0x7FD <= (__bits16) zExp ) {
        if (    ( 0x7FD < zExp )
             || (    ( zExp == 0x7FD )
                  && ( (__sbits64) ( zSig + roundIncrement ) < 0 ) )
           ) {
            __float_raise( float_flag_overflow | float_flag_inexact );
...
static __float64
 __normalizeRoundAndPackFloat64( __flag zSign, __int16 zExp, __bits64 zSig )
{
    __int8 shiftCount;
...
static void
 __normalizeFloatx80Subnormal( __bits64 aSig, __int32 *zExpPtr, __bits64 *zSigPtr )
{
    __int8 shiftCount;
...
static __floatx80
 __roundAndPackFloatx80(
     __int8 roundingPrecision, __flag zSign, __int32 zExp, __bits64 zSig0, __bits64 zSig1
 )
{
    __int8 roundingMode;
 ...
 overflow:
        ...
        if ( zExp <= 0 ) {
            ...
            zExp = 0;
            if ( isTiny && zSig1 ) __float_raise( float_flag_underflow );
            if ( zSig1 ) __float_exception_flags |= float_flag_inexact;
            if ( roundNearestEven ) {
                increment = ( (__sbits64) zSig1 < 0 );
            }
            else {
            ...
            if ( increment ) {
                ++zSig0;
                zSig0 &=
                    ~ ( ( (__bits64) ( zSig1<<1 ) == 0 ) & roundNearestEven );
                if ( (__sbits64) zSig0 < 0 ) zExp = 1;
            }
            return __packFloatx80( zSign, zExp, zSig0 );
        }
...
static __floatx80
 __normalizeRoundAndPackFloatx80(
     __int8 roundingPrecision, __flag zSign, __int32 zExp, __bits64 zSig0, __bits64 zSig1
 )
{
    __int8 shiftCount;
    ...
    zExp -= shiftCount;
    return
        __roundAndPackFloatx80( roundingPrecision, zSign, zExp, zSig0, zSig1 );
...
static /*INLINE*/ __float128
 __packFloat128( __flag zSign, __int32 zExp, __bits64 zSig0, __bits64 zSig1 )
{
    __float128 z;
...
static __float128
 __roundAndPackFloat128(
     __flag zSign, __int32 zExp, __bits64 zSig0, __bits64 zSig1, __bits64 zSig2 )
{
    __int8 roundingMode;
    __flag roundNearestEven, increment, isTiny;
    ...
    if ( 0x7FFD <= (__bits32) zExp ) {
        ...
        if ( zExp < 0 ) {
            ...
            __shift128ExtraRightJamming(
                zSig0, zSig1, zSig2, - zExp, &zSig0, &zSig1, &zSig2 );
            zExp = 0;
            if ( isTiny && zSig2 ) __float_raise( float_flag_underflow );
            if ( roundNearestEven ) {
                increment = ( (__sbits64) zSig2 < 0 );
            }
            else {
    ...
    if ( zSig2 ) __float_exception_flags |= float_flag_inexact;
    if ( increment ) {
...
static __float128
 __normalizeRoundAndPackFloat128(
     __flag zSign, __int32 zExp, __bits64 zSig0, __bits64 zSig1 )
{
    __int8 shiftCount;
    __bits64 zSig2;
...
static __float32 __int32_to_float32( __int32 a )
{
    ...
    if ( a == 0 ) return 0;
    if ( a == (__sbits32) 0x80000000 ) return __packFloat32( 1, 0x9E, 0 );
    zSign = ( a < 0 );
...
static __floatx80 __int32_to_floatx80( __int32 a )
{
    ...
    if ( a == 0 ) return __packFloatx80( 0, 0, 0 );
    zSign = ( a < 0 );
    absA = zSign ? - a : a;
...
static __float128 __int32_to_float128( __int32 a )
{
    ...
    if ( a == 0 ) return __packFloat128( 0, 0, 0, 0 );
    zSign = ( a < 0 );
    absA = zSign ? - a : a;
...
static __int32 __float32_to_int32( __float32 a )
{
    ...
    aSig64 = aSig;
    aSig64 <<= 32;
    if ( 0 < shiftCount ) __shift64RightJamming( aSig64, shiftCount, &aSig64 );
...
#ifndef NO_PARAMETRIC
        if ( aExp | aSig ) __float_exception_flags |= float_flag_inexact;
#endif
        return 0;
    }
...
static __float64 __float32_to_float64( __float32 a )
{
    ...
    aSign = __extractFloat32Sign( a );
    if ( aExp == 0xFF ) {
        if ( aSig ) return __commonNaNToFloat64( __float32ToCommonNaN( a ) );
...
#else
        if ( aSig == 0 ) return __packFloat64( aSign, 0, 0 );
...
static __floatx80 __float32_to_floatx80( __float32 a )
{
    ...
    aSign = __extractFloat32Sign( a );
    if ( aExp == 0xFF ) {
        if ( aSig ) return __commonNaNToFloatx80( __float32ToCommonNaN( a ) );
...
#else
        if ( aSig == 0 ) return __packFloatx80( aSign, 0, 0 );
        __normalizeFloat32Subnormal( aSig, &aExp, &aSig );
#endif
    }
    aSig |= 0x00800000;
...
static __float128 __float32_to_float128( __float32 a )
{
    ...
    aSign = __extractFloat32Sign( a );
    if ( aExp == 0xFF ) {
        if ( aSig ) return __commonNaNToFloat128( __float32ToCommonNaN( a ) );
...
#else
        if ( aSig == 0 ) return __packFloat128( aSign, 0, 0, 0 );
        __normalizeFloat32Subnormal( aSig, &aExp, &aSig );
#endif
        --aExp;
    }
...
static __float32 __float32_round_to_int( __float32 a )
{
    ...
    z &= ~ roundBitsMask;
#ifndef NO_PARAMETRIC
    if ( z != a ) __float_exception_flags |= float_flag_inexact;
#endif
    return z;
...
static __float32 __addFloat32Sigs( __float32 a, __float32 b, __flag zSign )
{
    ...
    if ( 0 < expDiff ) {
        if ( aExp == 0xFF ) {
            if ( aSig ) return __propagateFloat32NaN( a, b );
            return a;
        }
        if ( bExp == 0 ) {
            --expDiff;
        ...
        if ( bExp == 0xFF ) {
            if ( bSig ) return __propagateFloat32NaN( a, b );
        ...
        if ( aExp == 0xFF ) {
            if ( aSig | bSig ) return __propagateFloat32NaN( a, b );
            return a;
        }
        if ( aExp == 0 ) return __packFloat32( zSign, 0, ( aSig + bSig )>>6 );
...
static __float32 __float32_mul( __float32 a, __float32 b )
{
    ...
    if ( aExp == 0 ) {
        ...
        return __packFloat32( zSign, 0, 0 );
#else
        if ( aSig == 0 ) return __packFloat32( zSign, 0, 0 );
        __normalizeFloat32Subnormal( aSig, &aExp, &aSig );
#endif
    }
    if ( bExp == 0 )
    {
        ...
        return __packFloat32( zSign, 0, 0 );
#else
        if ( bSig == 0 ) return __packFloat32( zSign, 0, 0 );
...
static __float32 __float32_sqrt( __float32 a )
{
    ...
    aSign = __extractFloat32Sign( a );
    if ( aExp == 0xFF ) {
        if ( aSig ) return __propagateFloat32NaN( a, 0 );
        if ( ! aSign ) return a;
        __float_raise( float_flag_invalid );
        return __float32_default_nan;
    }
...
static __flag __float32_eq( __float32 a, __float32 b )
{
    ...
    if (    ( ( __extractFloat32Exp( a ) == 0xFF ) && __extractFloat32Frac( a ) )
         || ( ( __extractFloat32Exp( b ) == 0xFF ) && __extractFloat32Frac( b ) )
       ) {
...
static __flag __float32_le( __float32 a, __float32 b )
{
    ...
    aSign = __extractFloat32Sign( a );
    bSign = __extractFloat32Sign( b );
    if ( aSign != bSign ) return aSign || ( (__bits32) ( ( a | b )<<1 ) == 0 );
...
static __int32 __float64_to_int32( __float64 a )
{
    ...
    if ( 0 < shiftCount ) __shift64RightJamming( aSig, shiftCount, &aSig );
...
static __float32 __float64_to_float32( __float64 a )
{
    ...
    aSign = __extractFloat64Sign( a );
    if ( aExp == 0x7FF ) {
        if ( aSig ) return __commonNaNToFloat32( __float64ToCommonNaN( a ) );
...
static __floatx80 __float64_to_floatx80( __float64 a )
{
    ...
    aSign = __extractFloat64Sign( a );
    if ( aExp == 0x7FF ) {
        if ( aSig ) return __commonNaNToFloatx80( __float64ToCommonNaN( a ) );
        return __packFloatx80( aSign, 0x7FFF, LIT64( 0x8000000000000000 ) );
    }
    if ( aExp == 0 ) {
        if ( aSig == 0 ) return __packFloatx80( aSign, 0, 0 );
...
static __float128 __float64_to_float128( __float64 a )
{
    ...
    aSign = __extractFloat64Sign( a );
    if ( aExp == 0x7FF ) {
        if ( aSig ) return __commonNaNToFloat128( __float64ToCommonNaN( a ) );
        return __packFloat128( aSign, 0x7FFF, 0, 0 );
    }
    if ( aExp == 0 ) {
        if ( aSig == 0 ) return __packFloat128( aSign, 0, 0, 0 );
...
static __float64 __addFloat64Sigs( __float64 a, __float64 b, __flag zSign )
{
    ...
    if ( 0 < expDiff ) {
        if ( aExp == 0x7FF ) {
            if ( aSig ) return __propagateFloat64NaN( a, b );
            return a;
        }
        if ( bExp == 0 ) {
            --expDiff;
        ...
        if ( bExp == 0x7FF ) {
            if ( bSig ) return __propagateFloat64NaN( a, b );
        ...
        if ( aExp == 0x7FF ) {
            if ( aSig | bSig ) return __propagateFloat64NaN( a, b );
            return a;
        }
        if ( aExp == 0 ) return __packFloat64( zSign, 0, ( aSig + bSig )>>9 );
...
static __float64 __float64_mul( __float64 a, __float64 b )
{
...
#else
        if ( aSig == 0 ) return __packFloat64( zSign, 0, 0 );
        __normalizeFloat64Subnormal( aSig, &aExp, &aSig );
#endif
    }
    if ( bExp == 0 ) 
    {
        ...
        return __packFloat64 (zSign, 0, 0);
#else
        if ( bSig == 0 ) return __packFloat64( zSign, 0, 0 );
...
static __float64 __float64_div( __float64 a, __float64 b )
{
    __flag aSign, bSign, zSign;
    __int16 aExp, bExp, zExp;
    __bits64 aSig, bSig, zSig;
...
static __float64 __float64_sqrt( __float64 a )
{
    ...
    aSign = __extractFloat64Sign( a );
    if ( aExp == 0x7FF ) {
        if ( aSig ) return __propagateFloat64NaN( a, a );
        if ( ! aSign ) return a;
        __float_raise( float_flag_invalid );
        return __float64_default_nan;
    }
...
static __flag __float64_eq( __float64 a, __float64 b )
{
    ...
    if (    ( ( __extractFloat64Exp( a ) == 0x7FF ) && __extractFloat64Frac( a ) )
         || ( ( __extractFloat64Exp( b ) == 0x7FF ) && __extractFloat64Frac( b ) )
       ) {
...
static __flag __float64_le( __float64 a, __float64 b )
{
    ...
    aSign = __extractFloat64Sign( a );
    bSign = __extractFloat64Sign( b );
    if ( aSign != bSign ) return aSign || ( (__bits64) ( ( a | b )<<1 ) == 0 );
    return ( a == b ) || ( aSign ^ ( a < b ) );
...
static __int32 __floatx80_to_int32( __floatx80 a )
{
    ...
    if ( ( aExp == 0x7FFF ) && (__bits64) ( aSig<<1 ) ) aSign = 0;
...
static __floatx80 __floatx80_round_to_int( __floatx80 a )
{
    ...
    if ( aExp < 0x3FFF ) {
        if (    ( aExp == 0 )
             && ( (__bits64) ( __extractFloatx80Frac( a )<<1 ) == 0 ) ) {
            return a;
        }
        __float_exception_flags |= float_flag_inexact;
        aSign = __extractFloatx80Sign( a );
        switch ( __float_rounding_mode ) {
         case float_round_nearest_even:
            if ( ( aExp == 0x3FFE ) && (__bits64) ( __extractFloatx80Frac( a )<<1 )
                ...
                return
                    __packFloatx80( aSign, 0x3FFF, LIT64( 0x8000000000000000 ) );
            }
            break;
         case float_round_down:
            return
                  aSign ?
                      __packFloatx80( 1, 0x3FFF, LIT64( 0x8000000000000000 ) )
                : __packFloatx80( 0, 0, 0 );
         case float_round_up:
            return
                  aSign ? __packFloatx80( 1, 0, 0 )
                : __packFloatx80( 0, 0x3FFF, LIT64( 0x8000000000000000 ) );
        }
        return __packFloatx80( aSign, 0, 0 );
    }
    lastBitMask = 1;
    ...
    if ( z.low != a.low ) __float_exception_flags |= float_flag_inexact;
    return z;
...
static __floatx80 __addFloatx80Sigs( __floatx80 a, __floatx80 b, __flag zSign )
{
    ...
    if ( 0 < expDiff ) {
        if ( aExp == 0x7FFF ) {
            if ( (__bits64) ( aSig<<1 ) ) return __propagateFloatx80NaN( a, b );
            return a;
        }
        if ( bExp == 0 ) --expDiff;
        ...
        if ( bExp == 0x7FFF ) {
            if ( (__bits64) ( bSig<<1 ) ) return __propagateFloatx80NaN( a, b );
            return __packFloatx80( zSign, 0x7FFF, LIT64( 0x8000000000000000 ) );
        }
        if ( aExp == 0 ) ++expDiff;
    ...
    zSig0 = aSig + bSig;
    if ( (__sbits64) zSig0 < 0 ) goto roundAndPack;
 shiftRight1:
 ...
 roundAndPack:
    return
        __roundAndPackFloatx80(
            __floatx80_rounding_precision, zSign, zExp, zSig0, zSig1 );
...
static __floatx80 __floatx80_mul( __floatx80 a, __floatx80 b )
{
 ...
 invalid:
    ...
    if ( aExp == 0 ) {
        if ( aSig == 0 ) return __packFloatx80( zSign, 0, 0 );
        __normalizeFloatx80Subnormal( aSig, &aExp, &aSig );
    }
    if ( bExp == 0 ) {
        if ( bSig == 0 ) return __packFloatx80( zSign, 0, 0 );
...
static __floatx80 __floatx80_rem( __floatx80 a, __floatx80 b )
{
 ...
 invalid:
    ...
    if ( aExp == 0 ) {
        if ( (__bits64) ( aSig0<<1 ) == 0 ) return a;
    ...
    if (    __lt128( alternateASig0, alternateASig1, aSig0, aSig1 )
         || (    __eq128( alternateASig0, alternateASig1, aSig0, aSig1 )
              && ( q & 1 ) )
       ) {
...
static __floatx80 __floatx80_sqrt( __floatx80 a )
{
    ...
    aSign = __extractFloatx80Sign( a );
    if ( aExp == 0x7FFF ) {
        if ( (__bits64) ( aSig0<<1 ) ) return __propagateFloatx80NaN( a, a );
        if ( ! aSign ) return a;
        goto invalid;
    }
    if ( aSign ) {
 ...
 invalid:
    ...
    if ( aExp == 0 ) {
        if ( aSig0 == 0 ) return __packFloatx80( 0, 0, 0 );
        __normalizeFloatx80Subnormal( aSig0, &aExp, &aSig0 );
    }
    ...
    return
        __roundAndPackFloatx80(
            __floatx80_rounding_precision, 0, zExp, zSig0, zSig1 );
...
static __flag __floatx80_eq( __floatx80 a, __floatx80 b )
{
    ...
    if (    (    ( __extractFloatx80Exp( a ) == 0x7FFF )
              && (__bits64) ( __extractFloatx80Frac( a )<<1 ) )
         || (    ( __extractFloatx80Exp( b ) == 0x7FFF )
              && (__bits64) ( __extractFloatx80Frac( b )<<1 ) )
       ) {
        if (    __floatx80_is_signaling_nan( a )
             || __floatx80_is_signaling_nan( b ) ) {
            __float_raise( float_flag_invalid );
        }
        return 0;
    }
...
static __flag __floatx80_le( __floatx80 a, __floatx80 b )
{
    ...
    if ( aSign != bSign ) {
        return
               aSign
            || (    ( ( (__bits16) ( ( a.high | b.high )<<1 ) ) | a.low | b.low )
                 == 0 );
    }
    return
          aSign ? __le128( b.high, b.low, a.high, a.low )
        : __le128( a.high, a.low, b.high, b.low );
...
static __flag __floatx80_lt( __floatx80 a, __floatx80 b )
{
    ...
    return
          aSign ? __lt128( b.high, b.low, a.high, a.low )
        : __lt128( a.high, a.low, b.high, b.low );
...
static __int32 __float128_to_int32( __float128 a )
{
    ...
    if ( 0 < shiftCount ) __shift64RightJamming( aSig0, shiftCount, &aSig0 );
...
static __int32 __float128_to_int32_round_to_zero( __float128 a )
{
    ...
    if ( 0x401E < aExp ) {
        ...
        if ( aExp || aSig0 ) __float_exception_flags |= float_flag_inexact;
        return 0;
    }
    ...
    if ( 0 < shiftCount ) {
        if ( 0x403E <= aExp ) {
            ...
            if (    ( a.high == LIT64( 0xC03E000000000000 ) )
                ...
                if ( aSig1 ) __float_exception_flags |= float_flag_inexact;
            }
            else {
                __float_raise( float_flag_invalid );
        ...
        z = aSig0>>( - shiftCount );
        if (    aSig1
             || ( shiftCount && (__bits64) ( aSig0<<( shiftCount & 63 ) ) ) ) {
            __float_exception_flags |= float_flag_inexact;
        }
    }
    if ( aSign ) z = - z;
...
static __floatx80 __float128_to_floatx80( __float128 a )
{
    ...
    if ( aExp == 0 ) {
        if ( ( aSig0 | aSig1 ) == 0 ) return __packFloatx80( aSign, 0, 0 );
...
static __float128 __float128_round_to_int( __float128 a )
{
    ...
    if ( 0x402F <= aExp ) {
        if ( 0x406F <= aExp ) {
            if (    ( aExp == 0x7FFF )
                 && ( __extractFloat128Frac0( a ) | __extractFloat128Frac1( a ) )
               ) {
        ...
        if ( roundingMode == float_round_nearest_even ) {
            if ( lastBitMask ) {
                ...
                if ( (__sbits64) z.low < 0 ) {
                    ++z.high;
                    if ( (__bits64) ( z.low<<1 ) == 0 ) z.high &= ~1;
                }
            }
        }
        else if ( roundingMode != float_round_to_zero ) {
            if (   __extractFloat128Sign( z )
        ...
        if ( aExp < 0x3FFF ) {
            if ( ( ( (__bits64) ( a.high<<1 ) ) | a.low ) == 0 ) return a;
            __float_exception_flags |= float_flag_inexact;
            aSign = __extractFloat128Sign( a );
            switch ( __float_rounding_mode ) {
             case float_round_nearest_even:
                if (    ( aExp == 0x3FFE )
                     && (   __extractFloat128Frac0( a )
                          | __extractFloat128Frac1( a ) )
                   ) {
             ...
             case float_round_down:
                return
                      aSign ? __packFloat128( 1, 0x3FFF, 0, 0 )
                    : __packFloat128( 0, 0, 0, 0 );
             case float_round_up:
                return
                      aSign ? __packFloat128( 1, 0, 0, 0 )
                    : __packFloat128( 0, 0x3FFF, 0, 0 );
            }
            return __packFloat128( aSign, 0, 0, 0 );
        }
        lastBitMask = 1;
...
static __float128 __addFloat128Sigs( __float128 a, __float128 b, __flag zSign )
{
    ...
    if ( 0 < expDiff ) {
        if ( aExp == 0x7FFF ) {
            if ( aSig0 | aSig1 ) return __propagateFloat128NaN( a, b );
            return a;
        }
        if ( bExp == 0 ) {
            --expDiff;
        ...
        if ( bExp == 0x7FFF ) {
            if ( bSig0 | bSig1 ) return __propagateFloat128NaN( a, b );
            return __packFloat128( zSign, 0x7FFF, 0, 0 );
        }
        if ( aExp == 0 ) {
            ++expDiff;
        ...
        if ( aExp == 0 ) return __packFloat128( zSign, 0, zSig0, zSig1 );
        zSig2 = 0;
...
static __float128 __float128_mul( __float128 a, __float128 b )
{
 ...
 invalid:
    ...
    if ( aExp == 0 ) {
        if ( ( aSig0 | aSig1 ) == 0 ) return __packFloat128( zSign, 0, 0, 0 );
        __normalizeFloat128Subnormal( aSig0, aSig1, &aExp, &aSig0, &aSig1 );
    }
    if ( bExp == 0 ) {
        if ( ( bSig0 | bSig1 ) == 0 ) return __packFloat128( zSign, 0, 0, 0 );
...
static __float128 __float128_rem( __float128 a, __float128 b )
{
 ...
 invalid:
    ...
    if ( q ) __sub128( aSig0, aSig1, bSig0, bSig1, &aSig0, &aSig1 );
    expDiff -= 64;
    while ( 0 < expDiff ) {
    ...
    if ( zSign ) __sub128( 0, 0, aSig0, aSig1, &aSig0, &aSig1 );
    return
        __normalizeRoundAndPackFloat128( aSign ^ zSign, bExp - 4, aSig0, aSig1 );
...
static __float128 __float128_sqrt( __float128 a )
{
    ...
    aSign = __extractFloat128Sign( a );
    if ( aExp == 0x7FFF ) {
        if ( aSig0 | aSig1 ) return __propagateFloat128NaN( a, a );
        if ( ! aSign ) return a;
        goto invalid;
    }
    if ( aSign ) {
 ...
 invalid:
    ...
    if ( aExp == 0 ) {
        if ( ( aSig0 | aSig1 ) == 0 ) return __packFloat128( 0, 0, 0, 0 );
        __normalizeFloat128Subnormal( aSig0, aSig1, &aExp, &aSig0, &aSig1 );
    }
...
static __flag __float128_eq( __float128 a, __float128 b )
{
    ...
    if (    (    ( __extractFloat128Exp( a ) == 0x7FFF )
              && ( __extractFloat128Frac0( a ) | __extractFloat128Frac1( a ) ) )
         || (    ( __extractFloat128Exp( b ) == 0x7FFF )
              && ( __extractFloat128Frac0( b ) | __extractFloat128Frac1( b ) ) )
       ) {
        if (    __float128_is_signaling_nan( a )
             || __float128_is_signaling_nan( b ) ) {
            __float_raise( float_flag_invalid );
        }
        return 0;
    }
...
static __flag __float128_le( __float128 a, __float128 b )
{
    ...
    if ( aSign != bSign ) {
        return
               aSign
            || (    ( ( (__bits64) ( ( a.high | b.high )<<1 ) ) | a.low | b.low )
                 == 0 );
    }
    return
          aSign ? __le128( b.high, b.low, a.high, a.low )
