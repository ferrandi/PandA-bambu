...
static __FORCE_INLINE __int64_t __udivmoddi4(__uint64_t x, __uint64_t y, __int64_t* res)
{
...
__int64_t __moddi36432(__int64_t u, __int32_t v)
{
   ...
   if(v < 0)
      _v = -_v;
   __udivmoddi4(u, _v, (__uint64_t*)&w);
   if(c)
      w = -w;
   return w;
}
