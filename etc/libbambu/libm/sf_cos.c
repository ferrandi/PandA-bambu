...
static inline 
float __hide_local_cosf(float x)
{
	float y[2],z=0.0;
	int n,ix;
	GET_FLOAT_WORD(ix,x);
    ...
    /* argument reduction needed */
	    ...
	    switch(n&3) {
		case 0: return  __hide_kernel_cosf(y[0],y[1]);
		case 1: return -__hide_kernel_sinf(y[0],y[1],1);
		case 2: return -__hide_kernel_cosf(y[0],y[1]);
		default:
