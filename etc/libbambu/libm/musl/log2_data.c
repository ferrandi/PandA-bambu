...
#define __log2_data_invln2hi 0x1.7154765200000p+0
#define __log2_data_invln2lo 0x1.705fc2eefa200p-33
#define __log2_data_poly1(i) __log2_data_poly1_##i
// relative error: 0x1.2fad8188p-63
// in -0x1.5b51p-5 0x1.6ab2p-5
#define __log2_data_poly1_0 -0x1.71547652b82fep-1
#define __log2_data_poly1_1 0x1.ec709dc3a03f7p-2
#define __log2_data_poly1_2 -0x1.71547652b7c3fp-2
#define __log2_data_poly1_3 0x1.2776c50f05be4p-2
#define __log2_data_poly1_4 -0x1.ec709dd768fe5p-3
#define __log2_data_poly1_5 0x1.a61761ec4e736p-3
#define __log2_data_poly1_6 -0x1.7153fbc64a79bp-3
#define __log2_data_poly1_7 0x1.484d154f01b4ap-3
#define __log2_data_poly1_8 -0x1.289e4a72c383cp-3
#define __log2_data_poly1_9 0x1.0b32f285aee66p-3

#define __log2_data_poly(i) __log2_data_poly_##i
// relative error: 0x1.a72c2bf8p-58
// abs error: 0x1.67a552c8p-66
// in -0x1.f45p-8 0x1.f45p-8
#define __log2_data_poly_0 -0x1.71547652b8339p-1
#define __log2_data_poly_1 0x1.ec709dc3a04bep-2
#define __log2_data_poly_2 -0x1.7154764702ffbp-2
#define __log2_data_poly_3 0x1.2776c50034c48p-2
#define __log2_data_poly_4 -0x1.ec7b328ea92bcp-3
#define __log2_data_poly_5 0x1.a6225e117f92ep-3
...
static const struct {
		double invc, logc;
	} __log2_data_tab[1 << LOG2_TABLE_BITS] = {
...
static const struct {
		double chi, clo;
	} __log2_data_tab2[1 << LOG2_TABLE_BITS] = {
