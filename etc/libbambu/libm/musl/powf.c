...
#define T __powf_log2_data_tab
#define A(i) __powf_log2_data_poly(i)
...
#if TOINT_INTRINSICS
#define C(i) __exp2f_data_poly_scaled(i)
	/* N*x = k + r with r in [-1/2, 1/2] */
	kd = roundtoint(xd); /* k */
	ki = converttoint(xd);
#else
#define C(i) __exp2f_data_poly(i)
#define SHIFT __exp2f_data_shift_scaled
