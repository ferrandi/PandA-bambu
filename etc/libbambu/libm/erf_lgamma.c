...
static const float two23 = 8.3886080000e+06f, /* 0x4b000000 */
...
static float __hide_sin_pif(float x)
{
   ...
   if(ix < 0x3e800000)
      return __hide_kernel_sinf(pi * x, zero, 0);
   ...
   {
      case 0:
         y = __hide_kernel_sinf(pi * y, zero, 0);
         break;
      case 1:
      case 2:
         y = __hide_kernel_cosf(pi * ((float)0.5 - y), zero);
         break;
      case 3:
      case 4:
         y = __hide_kernel_sinf(pi * (one - y), zero, 0);
         break;
      case 5:
      case 6:
         y = -__hide_kernel_cosf(pi * (y - (float)1.5), zero);
         break;
      default:
         y = __hide_kernel_sinf(pi * (y - (float)2.0), zero, 0);
         break;
   }
   return -y;
}
