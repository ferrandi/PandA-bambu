...
static double __hide_sin_pi(double x)
{
   ...
   if(ix<0x3fd00000) return __hide_kernel_sin(pi*x,zero,0);
   ...
   switch (n) {
      case 0:   y =  __hide_kernel_sin(pi*y,zero,0); break;
      case 1:
      case 2:   y =  __hide_kernel_cos(pi*(0.5-y),zero); break;
      case 3:
      case 4:   y =  __hide_kernel_sin(pi*(one-y),zero,0); break;
      case 5:
      case 6:   y = -__hide_kernel_cos(pi*(y-1.5),zero); break;
      default:  y =  __hide_kernel_sin(pi*(y-2.0),zero,0); break;
   }
   return -y;
}
...
static double __hide_ieee754_lgamma_r(double x, int *signgamp)
{
   ...
   *signgamp = 1;
   ...
   if(ix<0x3b900000) {	/* |x|<2**-70, return -log(|x|) */
      ...
      } else return -__hide_ieee754_log(x);
   }
   if(hx<0) {
...
double tgamma(double x)
{
   ...
   if (__builtin_expect (hx < 0, 0)
       && (unsigned) hx < 0xfff00000 && rint (x) == x)
   {
