...
#define _FP_FRAC_COPY_4(D, S) (D##_f[0] = S##_f[0], D##_f[1] = S##_f[1], D##_f[2] = S##_f[2], D##_f[3] = S##_f[3])
...
#define _FP_FRAC_SLL_4(X, N)                                                                                        \
   ...
   {                                                                                                                \
      ...
      if(!_FP_FRAC_SLL_4_up)                                                                                        \
         for(_FP_FRAC_SLL_4_i = 3; _FP_FRAC_SLL_4_i >= _FP_FRAC_SLL_4_skip; --_FP_FRAC_SLL_4_i)                     \
            X##_f[_FP_FRAC_SLL_4_i] = X##_f[_FP_FRAC_SLL_4_i - _FP_FRAC_SLL_4_skip];                                \
      else                                                                                                          \
      {                                                                                                             \
         for(_FP_FRAC_SLL_4_i = 3; _FP_FRAC_SLL_4_i > _FP_FRAC_SLL_4_skip; --_FP_FRAC_SLL_4_i)                      \
            X##_f[_FP_FRAC_SLL_4_i] = ((X##_f[_FP_FRAC_SLL_4_i - _FP_FRAC_SLL_4_skip] << _FP_FRAC_SLL_4_up) |       \
                                       (X##_f[_FP_FRAC_SLL_4_i - _FP_FRAC_SLL_4_skip - 1] >> _FP_FRAC_SLL_4_down)); \
...
#define _FP_FRAC_SRL_4(X, N)                                                                                      \
   ...
   {                                                                                                              \
      ...
      if(!_FP_FRAC_SRL_4_down)                                                                                    \
         for(_FP_FRAC_SRL_4_i = 0; _FP_FRAC_SRL_4_i <= 3 - _FP_FRAC_SRL_4_skip; ++_FP_FRAC_SRL_4_i)               \
            X##_f[_FP_FRAC_SRL_4_i] = X##_f[_FP_FRAC_SRL_4_i + _FP_FRAC_SRL_4_skip];                              \
      else                                                                                                        \
      {                                                                                                           \
         for(_FP_FRAC_SRL_4_i = 0; _FP_FRAC_SRL_4_i < 3 - _FP_FRAC_SRL_4_skip; ++_FP_FRAC_SRL_4_i)                \
            X##_f[_FP_FRAC_SRL_4_i] = ((X##_f[_FP_FRAC_SRL_4_i + _FP_FRAC_SRL_4_skip] >> _FP_FRAC_SRL_4_down) |   \
                                       (X##_f[_FP_FRAC_SRL_4_i + _FP_FRAC_SRL_4_skip + 1] << _FP_FRAC_SRL_4_up)); \
   ...
   {                                                                                                                  \
      ...
      if(!_FP_FRAC_SRST_4_down)                                                                                       \
         for(_FP_FRAC_SRST_4_i = 0; _FP_FRAC_SRST_4_i <= 3 - _FP_FRAC_SRST_4_skip; ++_FP_FRAC_SRST_4_i)               \
            X##_f[_FP_FRAC_SRST_4_i] = X##_f[_FP_FRAC_SRST_4_i + _FP_FRAC_SRST_4_skip];                               \
      else                                                                                                            \
      {                                                                                                               \
         _FP_FRAC_SRST_4_s |= X##_f[_FP_FRAC_SRST_4_i] << _FP_FRAC_SRST_4_up;                                         \
         for(_FP_FRAC_SRST_4_i = 0; _FP_FRAC_SRST_4_i < 3 - _FP_FRAC_SRST_4_skip; ++_FP_FRAC_SRST_4_i)                \
            X##_f[_FP_FRAC_SRST_4_i] = ((X##_f[_FP_FRAC_SRST_4_i + _FP_FRAC_SRST_4_skip] >> _FP_FRAC_SRST_4_down) |   \
                                        (X##_f[_FP_FRAC_SRST_4_i + _FP_FRAC_SRST_4_skip + 1] << _FP_FRAC_SRST_4_up)); \
         X##_f[_FP_FRAC_SRST_4_i++] = X##_f[3] >> _FP_FRAC_SRST_4_down;                                               \
      }                                                                                                               \
...
#define _FP_FRAC_ADD_4(R, X, Y)                                                                                        \
   __FP_FRAC_ADD_4(R##_f[3], R##_f[2], R##_f[1], R##_f[0], X##_f[3], X##_f[2], X##_f[1], X##_f[0], Y##_f[3], Y##_f[2], \
                   Y##_f[1], Y##_f[0])

#define _FP_FRAC_SUB_4(R, X, Y)                                                                                        \
   __FP_FRAC_SUB_4(R##_f[3], R##_f[2], R##_f[1], R##_f[0], X##_f[3], X##_f[2], X##_f[1], X##_f[0], Y##_f[3], Y##_f[2], \
                   Y##_f[1], Y##_f[0])

#define _FP_FRAC_DEC_4(X, Y) \
   __FP_FRAC_DEC_4(X##_f[3], X##_f[2], X##_f[1], X##_f[0], Y##_f[3], Y##_f[2], Y##_f[1], Y##_f[0])
...
#define _FP_FRAC_HIGHBIT_DW_4(fs, X) (_FP_FRAC_HIGH_DW_##fs(X) & _FP_HIGHBIT_DW_##fs)
#define _FP_FRAC_CLEAR_OVERP_4(fs, X) (_FP_FRAC_HIGH_##fs(X) &= ~_FP_OVERFLOW_##fs)

#define _FP_FRAC_EQ_4(X, Y) \
   (X##_f[0] == Y##_f[0] && X##_f[1] == Y##_f[1] && X##_f[2] == Y##_f[2] && X##_f[3] == Y##_f[3])

#define _FP_FRAC_GT_4(X, Y)  \
   (X##_f[3] > Y##_f[3] ||   \
    (X##_f[3] == Y##_f[3] && \
     (X##_f[2] > Y##_f[2] || \
      (X##_f[2] == Y##_f[2] && (X##_f[1] > Y##_f[1] || (X##_f[1] == Y##_f[1] && X##_f[0] > Y##_f[0]))))))
...
#define _FP_UNPACK_RAW_4_P(fs, X, val)                                             \
   do                                                                              \
   {                                                                               \
      union _FP_UNION_##fs* _FP_UNPACK_RAW_4_P_flo = (union _FP_UNION_##fs*)(val); \
                                                                                   \
...
#define _FP_PACK_RAW_4_P(fs, val, X)                                             \
   do                                                                            \
   {                                                                             \
      union _FP_UNION_##fs* _FP_PACK_RAW_4_P_flo = (union _FP_UNION_##fs*)(val); \
                                                                                 \
...
#define _FP_MUL_MEAT_DW_4_wide(wfracbits, R, X, Y, doit)                                                      \
   ...
   {                                                                                                          \
      ...
      doit(_FP_MUL_MEAT_DW_4_wide_b_f1, _FP_MUL_MEAT_DW_4_wide_b_f0, X##_f[0], Y##_f[1]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_c_f1, _FP_MUL_MEAT_DW_4_wide_c_f0, X##_f[1], Y##_f[0]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_d_f1, _FP_MUL_MEAT_DW_4_wide_d_f0, X##_f[1], Y##_f[1]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_e_f1, _FP_MUL_MEAT_DW_4_wide_e_f0, X##_f[0], Y##_f[2]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_f_f1, _FP_MUL_MEAT_DW_4_wide_f_f0, X##_f[2], Y##_f[0]);                     \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 3), _FP_FRAC_WORD_8(R, 2), _FP_FRAC_WORD_8(R, 1), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_b_f1, _FP_MUL_MEAT_DW_4_wide_b_f0, 0, 0, _FP_FRAC_WORD_8(R, 1)); \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 3), _FP_FRAC_WORD_8(R, 2), _FP_FRAC_WORD_8(R, 1), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_c_f1, _FP_MUL_MEAT_DW_4_wide_c_f0, _FP_FRAC_WORD_8(R, 3),        \
                      _FP_FRAC_WORD_8(R, 2), _FP_FRAC_WORD_8(R, 1));                                          \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 4), _FP_FRAC_WORD_8(R, 3), _FP_FRAC_WORD_8(R, 2), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_d_f1, _FP_MUL_MEAT_DW_4_wide_d_f0, 0, _FP_FRAC_WORD_8(R, 3),     \
                      _FP_FRAC_WORD_8(R, 2));                                                                 \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 4), _FP_FRAC_WORD_8(R, 3), _FP_FRAC_WORD_8(R, 2), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_e_f1, _FP_MUL_MEAT_DW_4_wide_e_f0, _FP_FRAC_WORD_8(R, 4),        \
                      _FP_FRAC_WORD_8(R, 3), _FP_FRAC_WORD_8(R, 2));                                          \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 4), _FP_FRAC_WORD_8(R, 3), _FP_FRAC_WORD_8(R, 2), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_f_f1, _FP_MUL_MEAT_DW_4_wide_f_f0, _FP_FRAC_WORD_8(R, 4),        \
                      _FP_FRAC_WORD_8(R, 3), _FP_FRAC_WORD_8(R, 2));                                          \
      doit(_FP_MUL_MEAT_DW_4_wide_b_f1, _FP_MUL_MEAT_DW_4_wide_b_f0, X##_f[0], Y##_f[3]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_c_f1, _FP_MUL_MEAT_DW_4_wide_c_f0, X##_f[3], Y##_f[0]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_d_f1, _FP_MUL_MEAT_DW_4_wide_d_f0, X##_f[1], Y##_f[2]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_e_f1, _FP_MUL_MEAT_DW_4_wide_e_f0, X##_f[2], Y##_f[1]);                     \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 5), _FP_FRAC_WORD_8(R, 4), _FP_FRAC_WORD_8(R, 3), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_b_f1, _FP_MUL_MEAT_DW_4_wide_b_f0, 0, _FP_FRAC_WORD_8(R, 4),     \
                      _FP_FRAC_WORD_8(R, 3));                                                                 \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 5), _FP_FRAC_WORD_8(R, 4), _FP_FRAC_WORD_8(R, 3), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_c_f1, _FP_MUL_MEAT_DW_4_wide_c_f0, _FP_FRAC_WORD_8(R, 5),        \
                      _FP_FRAC_WORD_8(R, 4), _FP_FRAC_WORD_8(R, 3));                                          \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 5), _FP_FRAC_WORD_8(R, 4), _FP_FRAC_WORD_8(R, 3), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_d_f1, _FP_MUL_MEAT_DW_4_wide_d_f0, _FP_FRAC_WORD_8(R, 5),        \
                      _FP_FRAC_WORD_8(R, 4), _FP_FRAC_WORD_8(R, 3));                                          \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 5), _FP_FRAC_WORD_8(R, 4), _FP_FRAC_WORD_8(R, 3), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_e_f1, _FP_MUL_MEAT_DW_4_wide_e_f0, _FP_FRAC_WORD_8(R, 5),        \
                      _FP_FRAC_WORD_8(R, 4), _FP_FRAC_WORD_8(R, 3));                                          \
      doit(_FP_MUL_MEAT_DW_4_wide_b_f1, _FP_MUL_MEAT_DW_4_wide_b_f0, X##_f[2], Y##_f[2]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_c_f1, _FP_MUL_MEAT_DW_4_wide_c_f0, X##_f[1], Y##_f[3]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_d_f1, _FP_MUL_MEAT_DW_4_wide_d_f0, X##_f[3], Y##_f[1]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_e_f1, _FP_MUL_MEAT_DW_4_wide_e_f0, X##_f[2], Y##_f[3]);                     \
      doit(_FP_MUL_MEAT_DW_4_wide_f_f1, _FP_MUL_MEAT_DW_4_wide_f_f0, X##_f[3], Y##_f[2]);                     \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 6), _FP_FRAC_WORD_8(R, 5), _FP_FRAC_WORD_8(R, 4), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_b_f1, _FP_MUL_MEAT_DW_4_wide_b_f0, 0, _FP_FRAC_WORD_8(R, 5),     \
                      _FP_FRAC_WORD_8(R, 4));                                                                 \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 6), _FP_FRAC_WORD_8(R, 5), _FP_FRAC_WORD_8(R, 4), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_c_f1, _FP_MUL_MEAT_DW_4_wide_c_f0, _FP_FRAC_WORD_8(R, 6),        \
                      _FP_FRAC_WORD_8(R, 5), _FP_FRAC_WORD_8(R, 4));                                          \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 6), _FP_FRAC_WORD_8(R, 5), _FP_FRAC_WORD_8(R, 4), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_d_f1, _FP_MUL_MEAT_DW_4_wide_d_f0, _FP_FRAC_WORD_8(R, 6),        \
                      _FP_FRAC_WORD_8(R, 5), _FP_FRAC_WORD_8(R, 4));                                          \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 7), _FP_FRAC_WORD_8(R, 6), _FP_FRAC_WORD_8(R, 5), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_e_f1, _FP_MUL_MEAT_DW_4_wide_e_f0, 0, _FP_FRAC_WORD_8(R, 6),     \
                      _FP_FRAC_WORD_8(R, 5));                                                                 \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_8(R, 7), _FP_FRAC_WORD_8(R, 6), _FP_FRAC_WORD_8(R, 5), 0,                 \
                      _FP_MUL_MEAT_DW_4_wide_f_f1, _FP_MUL_MEAT_DW_4_wide_f_f0, _FP_FRAC_WORD_8(R, 7),        \
                      _FP_FRAC_WORD_8(R, 6), _FP_FRAC_WORD_8(R, 5));                                          \
      doit(_FP_MUL_MEAT_DW_4_wide_b_f1, _FP_MUL_MEAT_DW_4_wide_b_f0, X##_f[3], Y##_f[3]);                     \
      __FP_FRAC_ADD_2(_FP_FRAC_WORD_8(R, 7), _FP_FRAC_WORD_8(R, 6), _FP_MUL_MEAT_DW_4_wide_b_f1,              \
                      _FP_MUL_MEAT_DW_4_wide_b_f0, _FP_FRAC_WORD_8(R, 7), _FP_FRAC_WORD_8(R, 6));             \
   } while(0)
...
#define _FP_MUL_MEAT_4_wide(wfracbits, R, X, Y, doit)                                                          \
   ...
   {                                                                                                           \
      _FP_FRAC_DECL_8(_FP_MUL_MEAT_4_wide_z);                                                                  \
                                                                                                               \
      _FP_MUL_MEAT_DW_4_wide((wfracbits), _FP_MUL_MEAT_4_wide_z, X, Y, doit);                                  \
                                                                                                               \
      /* Normalize since we know where the msb of the multiplicands                                            \
    were (bit B), we know that the msb of the of the product is                                                \
    at either 2B or 2B-1.  */                                                                                  \
      _FP_FRAC_SRS_8(_FP_MUL_MEAT_4_wide_z, (wfracbits)-1, 2 * (wfracbits));                                   \
      __FP_FRAC_SET_4(R, _FP_FRAC_WORD_8(_FP_MUL_MEAT_4_wide_z, 3), _FP_FRAC_WORD_8(_FP_MUL_MEAT_4_wide_z, 2), \
                      _FP_FRAC_WORD_8(_FP_MUL_MEAT_4_wide_z, 1), _FP_FRAC_WORD_8(_FP_MUL_MEAT_4_wide_z, 0));   \
   } while(0)
...
#define _FP_MUL_MEAT_4_gmp(wfracbits, R, X, Y)                                                               \
   ...
   {                                                                                                         \
    ...
    at either 2B or 2B-1.  */                                                                                \
      ...
      __FP_FRAC_SET_4(R, _FP_FRAC_WORD_8(_FP_MUL_MEAT_4_gmp_z, 3), _FP_FRAC_WORD_8(_FP_MUL_MEAT_4_gmp_z, 2), \
                      _FP_FRAC_WORD_8(_FP_MUL_MEAT_4_gmp_z, 1), _FP_FRAC_WORD_8(_FP_MUL_MEAT_4_gmp_z, 0));   \
   } while(0)
...
#define _FP_DIV_MEAT_4_udiv(fs, R, X, Y)                                                                           \
   ...
   {                                                                                                               \
      ...
      {                                                                                                            \
         _FP_DIV_MEAT_4_udiv_n_f[3] = X##_f[0] << (_FP_W_TYPE_SIZE - 1);                                           \
         _FP_FRAC_SRL_4(X, 1);                                                                                     \
      }                                                                                                            \
      else                                                                                                         \
         R##_e--;                                                                                                  \
    ...
    denominator set.  */                                                                                           \
      ...
      {                                                                                                            \
         ...
         {                                                                                                         \
          ...
          (UWtype)-1 or (UWtype)-2.  */                                                                            \
            ...
            if(!_FP_DIV_MEAT_4_udiv_i)                                                                             \
               break;                                                                                              \
            __FP_FRAC_SUB_4(X##_f[3], X##_f[2], X##_f[1], X##_f[0], Y##_f[2], Y##_f[1], Y##_f[0], 0, X##_f[2],     \
                            X##_f[1], X##_f[0], _FP_DIV_MEAT_4_udiv_n_f[_FP_DIV_MEAT_4_udiv_i]);                   \
         ...
         {                                                                                                         \
            udiv_qrnnd(R##_f[_FP_DIV_MEAT_4_udiv_i], X##_f[3], X##_f[3], X##_f[2], Y##_f[3]);                      \
            umul_ppppmnnn(_FP_DIV_MEAT_4_udiv_m_f[3], _FP_DIV_MEAT_4_udiv_m_f[2], _FP_DIV_MEAT_4_udiv_m_f[1],      \
                          _FP_DIV_MEAT_4_udiv_m_f[0], R##_f[_FP_DIV_MEAT_4_udiv_i], Y##_f[2], Y##_f[1], Y##_f[0]); \
            X##_f[2] = X##_f[1];                                                                                   \
            X##_f[1] = X##_f[0];                                                                                   \
            X##_f[0] = _FP_DIV_MEAT_4_udiv_n_f[_FP_DIV_MEAT_4_udiv_i];                                             \
            if(_FP_FRAC_GT_4(_FP_DIV_MEAT_4_udiv_m, X))                                                            \
            {                                                                                                      \
               R##_f[_FP_DIV_MEAT_4_udiv_i]--;                                                                     \
               _FP_FRAC_ADD_4(X, Y, X);                                                                            \
               if(_FP_FRAC_GE_4(X, Y) && _FP_FRAC_GT_4(_FP_DIV_MEAT_4_udiv_m, X))                                  \
               {                                                                                                   \
                  R##_f[_FP_DIV_MEAT_4_udiv_i]--;                                                                  \
                  _FP_FRAC_ADD_4(X, Y, X);                                                                         \
               }                                                                                                   \
...
#define _FP_SQRT_MEAT_4(R, S, T, X, q)                                                                         \
   ...
   {                                                                                                           \
      ...
      {                                                                                                        \
         T##_f[2] = S##_f[2] + (q);                                                                            \
         T##_f[3] = S##_f[3];                                                                                  \
         if(T##_f[3] < X##_f[3] || (T##_f[3] == X##_f[3] && T##_f[2] <= X##_f[2]))                             \
         {                                                                                                     \
            S##_f[2] = T##_f[2] + (q);                                                                         \
            S##_f[3] += (T##_f[2] > S##_f[2]);                                                                 \
            __FP_FRAC_DEC_2(X##_f[3], X##_f[2], T##_f[3], T##_f[2]);                                           \
            R##_f[2] += (q);                                                                                   \
         }                                                                                                     \
         _FP_FRAC_SLL_4(X, 1);                                                                                 \
         (q) >>= 1;                                                                                            \
      ...
      {                                                                                                        \
         ...
         T##_f[3] = S##_f[3];                                                                                  \
         if(T##_f[3] < X##_f[3] ||                                                                             \
            (T##_f[3] == X##_f[3] && (T##_f[2] < X##_f[2] || (T##_f[2] == X##_f[2] && T##_f[1] <= X##_f[1])))) \
         {                                                                                                     \
            S##_f[1] = T##_f[1] + (q);                                                                         \
            S##_f[2] += (T##_f[1] > S##_f[1]);                                                                 \
            S##_f[3] += (T##_f[2] > S##_f[2]);                                                                 \
            __FP_FRAC_DEC_3(X##_f[3], X##_f[2], X##_f[1], T##_f[3], T##_f[2], T##_f[1]);                       \
            R##_f[1] += (q);                                                                                   \
         }                                                                                                     \
         _FP_FRAC_SLL_4(X, 1);                                                                                 \
         (q) >>= 1;                                                                                            \
...
#define __FP_FRAC_DEC_3(x2, x1, x0, y2, y1, y0)                                                            \
   ...
   {                                                                                                       \
      ...
      __FP_FRAC_SUB_3(x2, x1, x0, __FP_FRAC_DEC_3_t2, __FP_FRAC_DEC_3_t1, __FP_FRAC_DEC_3_t0, y2, y1, y0); \
   } while(0)
#endif
...
#define __FP_FRAC_DEC_4(x3, x2, x1, x0, y3, y2, y1, y0)                                                               \
   ...
   {                                                                                                                  \
      ...
      __FP_FRAC_SUB_4(x3, x2, x1, x0, __FP_FRAC_DEC_4_t3, __FP_FRAC_DEC_4_t2, __FP_FRAC_DEC_4_t1, __FP_FRAC_DEC_4_t0, \
                      y3, y2, y1, y0);                                                                                \
   } while(0)
#endif
