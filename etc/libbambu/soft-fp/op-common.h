               ...
               case FP_CLS_NORMAL:;                                                               \
                  ...
                  {                                                                               \
                     ...
                     {                                                                            \
                        ...
                        if(_FP_FMA_shift < 0)                                                     \
                           _FP_FRAC_SRS_##dwc(_FP_FMA_ZD, -_FP_FMA_shift, _FP_WFRACBITS_DW_##fs); \
                  ...
                  {                                                                               \
                     ...
                     if(_FP_FMA_shift >= _FP_WFRACBITS_DW_##fs)                                   \
                        ...
                        _FP_FRAC_SRS_##dwc(_FP_FMA_TD, _FP_FMA_shift, _FP_WFRACBITS_DW_##fs);     \
                  ...
                  {                                                                               \
                     ...
                     if(_FP_FMA_shift > 0)                                                        \
                        _FP_FRAC_SRS_##dwc(_FP_FMA_RD, _FP_FMA_shift, _FP_WFRACBITS_DW_##fs);     \
                     else if(_FP_FMA_shift < 0)                                                   \
   ...
   {                                                                                                         \
      ...
      {                                                                                                      \
         ...
         case _FP_CLS_COMBINE(FP_CLS_ZERO, FP_CLS_ZERO):                                                     \
            ...
            R##_c = FP_CLS_NAN;                                                                              \
            _FP_FRAC_SET_##wc(R, _FP_NANFRAC_##fs);                                                          \
            FP_SET_EXCEPTION(FP_EX_INVALID | (X##_c == FP_CLS_INF ? FP_EX_INVALID_IDI : FP_EX_INVALID_ZDZ)); \
            break;                                                                                           \
                                                                                                             \
         default:                                                                                            \
            _FP_UNREACHABLE;                                                                                 \
   ...
   {                                                                                                                \
      ...
      {                                                                                                             \
         _FP_CMP_CHECK_FLUSH_ZERO(fs, wc, X, Y);                                                                    \
                                                                                                                    \
         (ret) =                                                                                                    \
             !(X##_e == Y##_e && _FP_FRAC_EQ_##wc(X, Y) && (X##_s == Y##_s || (!X##_e && _FP_FRAC_ZEROP_##wc(X)))); \
      }                                                                                                             \
   } while(0)
   ...
   {                                                                                                              \
      ...
      {                                                                                                           \
         ...
         FP_SET_EXCEPTION(FP_EX_INVALID | FP_EX_INVALID_CVI |                                                     \
                          ((FP_EX_INVALID_SNAN && _FP_ISSIGNAN(fs, wc, X)) ? FP_EX_INVALID_SNAN : 0));            \
      }                                                                                                           \
         ...
         {                                                                                                        \
            ...
            if(!X##_s)                                                                                            \
               (r) = ~(r);                                                                                        \
                                                                                                                  ...
                                                                                                                  \
         if(_FP_EXPBIAS_##fs + (rsize)-1 < _FP_EXPMAX_##fs && (rsigned) && X##_s &&                               \
         ...
         {                                                                                                        \
          ...
          mantissa.  */                                                                                           \
            ...
            (void)((_FP_FRACBITS_##fs > (rsize)) ? ({                                                             \
               _FP_FRAC_SRST_##wc(X, _FP_TO_INT_inexact, _FP_FRACBITS_##fs - (rsize), _FP_FRACBITS_##fs);         \
               0;                                                                                                 \
            }) :                                                                                                  \
                                                   0);                                                            \
            if(!_FP_FRAC_ZEROP_##wc(X))                                                                           \
      ...
      {                                                                                                           \
         ...
         {                                                                                                        \
            _FP_FRAC_SRST_##wc(X, _FP_TO_INT_inexact, (_FP_FRACBITS_##fs + _FP_EXPBIAS_##fs - 1 - X##_e),         \
                               _FP_FRACBITS_##fs);                                                                \
            _FP_FRAC_ASSEMBLE_##wc((r), X, (rsize));                                                              \
         }                                                                                                        \
         if((rsigned) && X##_s)                                                                                   \
      ...
      {                                                                                                           \
         ...
         {                                                                                                        \
            if(X##_e > _FP_EXPBIAS_##fs + (rsize)-1 ||                                                            \
               (X##_e == _FP_EXPBIAS_##fs + (rsize)-1 &&                                                          \
                (X##_s ? (r) != (((typeof(r))1) << ((rsize)-1)) : ((rsigned) > 0 || (r) == 0))) ||                \
               ((rsigned) > 0 && !X##_s && X##_e == _FP_EXPBIAS_##fs + (rsize)-2 &&                               \
   ...
   {                                                                                                              \
      ...
      {                                                                                                           \
         ...
         (void)(((rsize) <= _FP_W_TYPE_SIZE) ?                                                                    \
                    ...
                    ({                                                                                            \
                       int _FP_FROM_INT_lz;                                                                       \
                       __FP_CLZ_2(_FP_FROM_INT_lz, (_FP_W_TYPE)(_FP_FROM_INT_ur >> _FP_W_TYPE_SIZE),              \
         ...
         {                                                                                                        \
          ...
          round.  */                                                                                              \
            if(_FP_EXPBIAS_##fs + _FP_WFRACBITS_##fs - 1 < X##_e)                                                 \
               _FP_FROM_INT_ur =                                                                                  \
                   ((_FP_FROM_INT_ur >> (X##_e - _FP_EXPBIAS_##fs - _FP_WFRACBITS_##fs + 1)) |                    \
                    ((_FP_FROM_INT_ur << ((rsize) - (X##_e - _FP_EXPBIAS_##fs - _FP_WFRACBITS_##fs + 1))) != 0)); \
            _FP_FRAC_DISASSEMBLE_##wc(X, _FP_FROM_INT_ur, (rsize));                                               \
...
#define _FP_EXTEND_CNAN(dfs, sfs, dwc, swc, D, S, check_nan)                                                    \
   do                                                                                                           \
   {                                                                                                            \
      _FP_STATIC_ASSERT(_FP_FRACBITS_##dfs >= _FP_FRACBITS_##sfs, "destination mantissa narrower than source"); \
      _FP_STATIC_ASSERT((_FP_EXPMAX_##dfs - _FP_EXPBIAS_##dfs >= _FP_EXPMAX_##sfs - _FP_EXPBIAS_##sfs),         \
                        "destination max exponent smaller"                                                      \
                        " than source");                                                                        \
      _FP_STATIC_ASSERT(((_FP_EXPBIAS_##dfs >= (_FP_EXPBIAS_##sfs + _FP_FRACBITS_##sfs - 1)) ||                 \
      ...
      {                                                                                                         \
         ...
         {                                                                                                      \
            ...
            {                                                                                                   \
               ...
               _FP_FRAC_SLL_##dwc(D, FP_EXTEND_lz + _FP_FRACBITS_##dfs - _FP_FRACTBITS_##sfs);                  \
...
#define FP_EXTEND(dfs, sfs, dwc, swc, D, S) _FP_EXTEND_CNAN(dfs, sfs, dwc, swc, D, S, 1)
...
#define FP_TRUNC(dfs, sfs, dwc, swc, D, S)                                                                             \
   do                                                                                                                  \
   {                                                                                                                   \
      _FP_STATIC_ASSERT(_FP_FRACBITS_##sfs >= _FP_FRACBITS_##dfs, "destination mantissa wider than source");           \
      _FP_STATIC_ASSERT(((_FP_EXPBIAS_##sfs >= (_FP_EXPBIAS_##dfs + _FP_FRACBITS_##dfs - 1)) ||                        \
...
#define _FP_DIV_MEAT_N_loop(fs, wc, R, X, Y)                                                        \
   ...
   {                                                                                                \
    ...
    count and exponent accordingly.  */                                                             \
      ...
      {                                                                                             \
         _FP_FRAC_SUB_##wc(_FP_DIV_MEAT_N_loop_u, _FP_DIV_MEAT_N_loop_u, _FP_DIV_MEAT_N_loop_v);    \
      ...
      {                                                                                             \
         ...
         if(_FP_DIV_MEAT_N_loop_msb || _FP_FRAC_GE_1(_FP_DIV_MEAT_N_loop_u, _FP_DIV_MEAT_N_loop_v)) \
         {                                                                                          \
            _FP_FRAC_SUB_##wc(_FP_DIV_MEAT_N_loop_u, _FP_DIV_MEAT_N_loop_u, _FP_DIV_MEAT_N_loop_v); \
            _FP_FRAC_LOW_##wc(R) |= 1;                                                              \
         }                                                                                          \
