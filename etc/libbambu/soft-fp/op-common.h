...
#define _FP_UNPACK_CANONICAL(fs, wc, X)                       \
   ...
   {                                                          \
      {                                                       \
         if(X##_e == 0)                                       \
         {                                                    \
            if(NO_DENORM || _FP_FRAC_ZEROP_##wc(X))           \
               X##_c = FP_CLS_ZERO;                           \
            else                                              \
            {                                                 \
      ...
      {                                                                            \
         ...
         {                                                                         \
            ...
            {                                                                      \
               ...
               if(NO_DENORM || _FP_FRAC_ZEROP_##wc(Y))                             \
               {                                                                   \
               ...
               case FP_CLS_NORMAL:;                                               \
                  ...
                  {                                                               \
                     ...
                     {                                                            \
                        ...
                        if(shift < 0)                                             \
                           _FP_FRAC_SRS_##dwc(ZD, -shift, _FP_WFRACBITS_DW_##fs); \
                        else if(shift > 0)                                        \
                  ...
                  {                                                               \
                     ...
                     if(shift >= _FP_WFRACBITS_DW_##fs)                           \
                        ...
                        _FP_FRAC_SRS_##dwc(TD, shift, _FP_WFRACBITS_DW_##fs);     \
                     if(Z##_s == T##_s)                                           \
                  ...
                  {                                                               \
                     ...
                     if(shift > 0)                                                \
                        _FP_FRAC_SRS_##dwc(RD, shift, _FP_WFRACBITS_DW_##fs);     \
                     else if(shift < 0)                                           \
