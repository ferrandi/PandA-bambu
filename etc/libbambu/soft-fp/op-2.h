...
#define _FP_FRAC_DECL_2(X) _FP_W_TYPE X##_f0 _FP_ZERO_INIT, X##_f1 _FP_ZERO_INIT
...
#define _FP_FRAC_HIGHBIT_DW_2(fs, X) (_FP_FRAC_HIGH_DW_##fs(X) & _FP_HIGHBIT_DW_##fs)
...
#define __FP_FRAC_ADDI_2(xh, xl, i) (xh += ((xl += i) < i))
#endif
#ifndef __FP_FRAC_ADD_2
#define __FP_FRAC_ADD_2(rh, rl, xh, xl, yh, yl) (rh = xh + yh + ((rl = xl + yl) < xl))
#endif
#ifndef __FP_FRAC_SUB_2
#define __FP_FRAC_SUB_2(rh, rl, xh, xl, yh, yl) (rh = xh - yh - ((rl = xl - yl) > xl))
#endif
...
#define _FP_UNPACK_RAW_2_P(fs, X, val)                                             \
   do                                                                              \
   {                                                                               \
      union _FP_UNION_##fs* _FP_UNPACK_RAW_2_P_flo = (union _FP_UNION_##fs*)(val); \
                                                                                   \
...
#define _FP_PACK_RAW_2_P(fs, val, X)                                             \
   do                                                                            \
   {                                                                             \
      union _FP_UNION_##fs* _FP_PACK_RAW_2_P_flo = (union _FP_UNION_##fs*)(val); \
                                                                                 \
...
#define _FP_MUL_MEAT_DW_2_wide(wfracbits, R, X, Y, doit)                                               \
   ...
   {                                                                                                   \
      ...
      doit(_FP_MUL_MEAT_DW_2_wide_b_f1, _FP_MUL_MEAT_DW_2_wide_b_f0, X##_f0, Y##_f1);                  \
      doit(_FP_MUL_MEAT_DW_2_wide_c_f1, _FP_MUL_MEAT_DW_2_wide_c_f0, X##_f1, Y##_f0);                  \
      doit(_FP_FRAC_WORD_4(R, 3), _FP_FRAC_WORD_4(R, 2), X##_f1, Y##_f1);                              \
                                                                                                       \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_4(R, 3), _FP_FRAC_WORD_4(R, 2), _FP_FRAC_WORD_4(R, 1), 0,          \
                      _FP_MUL_MEAT_DW_2_wide_b_f1, _FP_MUL_MEAT_DW_2_wide_b_f0, _FP_FRAC_WORD_4(R, 3), \
                      _FP_FRAC_WORD_4(R, 2), _FP_FRAC_WORD_4(R, 1));                                   \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_4(R, 3), _FP_FRAC_WORD_4(R, 2), _FP_FRAC_WORD_4(R, 1), 0,          \
                      _FP_MUL_MEAT_DW_2_wide_c_f1, _FP_MUL_MEAT_DW_2_wide_c_f0, _FP_FRAC_WORD_4(R, 3), \
                      _FP_FRAC_WORD_4(R, 2), _FP_FRAC_WORD_4(R, 1));                                   \
   } while(0)
...
#define _FP_MUL_MEAT_2_wide(wfracbits, R, X, Y, doit)                         \
   ...
   {                                                                          \
      _FP_FRAC_DECL_4(_FP_MUL_MEAT_2_wide_z);                                 \
                                                                              \
      _FP_MUL_MEAT_DW_2_wide((wfracbits), _FP_MUL_MEAT_2_wide_z, X, Y, doit); \
                                                                              \
...
#define _FP_MUL_MEAT_DW_2_wide_3mul(wfracbits, R, X, Y, doit)                                           \
   ...
   {                                                                                                    \
      ...
      _FP_MUL_MEAT_DW_2_wide_3mul_c1 = _FP_MUL_MEAT_DW_2_wide_3mul_b_f0 < X##_f0;                       \
      _FP_MUL_MEAT_DW_2_wide_3mul_b_f1 = Y##_f0 + Y##_f1;                                               \
      _FP_MUL_MEAT_DW_2_wide_3mul_c2 = _FP_MUL_MEAT_DW_2_wide_3mul_b_f1 < Y##_f0;                       \
      doit(_FP_MUL_MEAT_DW_2_wide_3mul_d, _FP_FRAC_WORD_4(R, 0), X##_f0, Y##_f0);                       \
      doit(_FP_FRAC_WORD_4(R, 2), _FP_FRAC_WORD_4(R, 1), _FP_MUL_MEAT_DW_2_wide_3mul_b_f0,              \
           _FP_MUL_MEAT_DW_2_wide_3mul_b_f1);                                                           \
      doit(_FP_MUL_MEAT_DW_2_wide_3mul_c_f1, _FP_MUL_MEAT_DW_2_wide_3mul_c_f0, X##_f1, Y##_f1);         \
                                                                                                        \
      _FP_MUL_MEAT_DW_2_wide_3mul_b_f0 &= -_FP_MUL_MEAT_DW_2_wide_3mul_c2;                              \
      _FP_MUL_MEAT_DW_2_wide_3mul_b_f1 &= -_FP_MUL_MEAT_DW_2_wide_3mul_c1;                              \
      __FP_FRAC_ADD_3(_FP_FRAC_WORD_4(R, 3), _FP_FRAC_WORD_4(R, 2), _FP_FRAC_WORD_4(R, 1),              \
                      (_FP_MUL_MEAT_DW_2_wide_3mul_c1 & _FP_MUL_MEAT_DW_2_wide_3mul_c2), 0,             \
                      _FP_MUL_MEAT_DW_2_wide_3mul_d, 0, _FP_FRAC_WORD_4(R, 2), _FP_FRAC_WORD_4(R, 1));  \
      __FP_FRAC_ADDI_2(_FP_FRAC_WORD_4(R, 3), _FP_FRAC_WORD_4(R, 2), _FP_MUL_MEAT_DW_2_wide_3mul_b_f0); \
      __FP_FRAC_ADDI_2(_FP_FRAC_WORD_4(R, 3), _FP_FRAC_WORD_4(R, 2), _FP_MUL_MEAT_DW_2_wide_3mul_b_f1); \
      __FP_FRAC_DEC_3(_FP_FRAC_WORD_4(R, 3), _FP_FRAC_WORD_4(R, 2), _FP_FRAC_WORD_4(R, 1), 0,           \
                      _FP_MUL_MEAT_DW_2_wide_3mul_d, _FP_FRAC_WORD_4(R, 0));                            \
      __FP_FRAC_DEC_3(_FP_FRAC_WORD_4(R, 3), _FP_FRAC_WORD_4(R, 2), _FP_FRAC_WORD_4(R, 1), 0,           \
                      _FP_MUL_MEAT_DW_2_wide_3mul_c_f1, _FP_MUL_MEAT_DW_2_wide_3mul_c_f0);              \
      __FP_FRAC_ADD_2(_FP_FRAC_WORD_4(R, 3), _FP_FRAC_WORD_4(R, 2), _FP_MUL_MEAT_DW_2_wide_3mul_c_f1,   \
                      _FP_MUL_MEAT_DW_2_wide_3mul_c_f0, _FP_FRAC_WORD_4(R, 3), _FP_FRAC_WORD_4(R, 2));  \
   } while(0)
...
#define _FP_MUL_MEAT_2_wide_3mul(wfracbits, R, X, Y, doit)                              \
   ...
   {                                                                                    \
      _FP_FRAC_DECL_4(_FP_MUL_MEAT_2_wide_3mul_z);                                      \
                                                                                        \
      _FP_MUL_MEAT_DW_2_wide_3mul((wfracbits), _FP_MUL_MEAT_2_wide_3mul_z, X, Y, doit); \
                                                                                        \
      /* Normalize since we know where the msb of the multiplicands                     \
    were (bit B), we know that the msb of the of the product is                         \
    at either 2B or 2B-1.  */                                                           \
      _FP_FRAC_SRS_4(_FP_MUL_MEAT_2_wide_3mul_z, (wfracbits)-1, 2 * (wfracbits));       \
...
#define _FP_MUL_MEAT_DW_2_gmp(wfracbits, R, X, Y)                            \
   ...
   {                                                                         \
      ...
      _FP_MUL_MEAT_DW_2_gmp_y[1] = Y##_f1;                                   \
                                                                             \
      mpn_mul_n(R##_f, _FP_MUL_MEAT_DW_2_gmp_x, _FP_MUL_MEAT_DW_2_gmp_y, 2); \
   } while(0)
...
#define _FP_MUL_MEAT_2_120_240_double(wfracbits, R, X, Y, setfetz, resetfe)                                           \
   ...
   {                                                                                                                  \
      ...
      UDItype _t240, _u240, _v240, _w240, _x240, _y240 = 0;                                                           \
                                                                                                                      \
      _FP_STATIC_ASSERT((wfracbits) >= 106 && (wfracbits) <= 120, "wfracbits out of range");                          \
                                                                                                                      \
      setfetz;                                                                                                        \
                                                                                                                      \
...
#define _FP_DIV_MEAT_2_udiv(fs, R, X, Y)                                                                               \
   ...
   {                                                                                                                   \
      ...
      {                                                                                                                \
         ...
         _FP_DIV_MEAT_2_udiv_n_f1 = X##_f1 << (_FP_W_TYPE_SIZE - 1) | X##_f0 >> 1;                                     \
         _FP_DIV_MEAT_2_udiv_n_f0 = X##_f0 << (_FP_W_TYPE_SIZE - 1);                                                   \
      }                                                                                                                \
      else                                                                                                             \
      {                                                                                                                \
         R##_e--;                                                                                                      \
    ...
    denominator set.  */                                                                                               \
      _FP_FRAC_SLL_2(Y, _FP_WFRACXBITS_##fs);                                                                          \
                                                                                                                       \
      udiv_qrnnd(R##_f1, _FP_DIV_MEAT_2_udiv_r_f1, _FP_DIV_MEAT_2_udiv_n_f2, _FP_DIV_MEAT_2_udiv_n_f1, Y##_f1);        \
      umul_ppmm(_FP_DIV_MEAT_2_udiv_m_f1, _FP_DIV_MEAT_2_udiv_m_f0, R##_f1, Y##_f0);                                   \
      _FP_DIV_MEAT_2_udiv_r_f0 = _FP_DIV_MEAT_2_udiv_n_f0;                                                             \
      if(_FP_FRAC_GT_2(_FP_DIV_MEAT_2_udiv_m, _FP_DIV_MEAT_2_udiv_r))                                                  \
      {                                                                                                                \
         R##_f1--;                                                                                                     \
         _FP_FRAC_ADD_2(_FP_DIV_MEAT_2_udiv_r, Y, _FP_DIV_MEAT_2_udiv_r);                                              \
         if(_FP_FRAC_GE_2(_FP_DIV_MEAT_2_udiv_r, Y) && _FP_FRAC_GT_2(_FP_DIV_MEAT_2_udiv_m, _FP_DIV_MEAT_2_udiv_r))    \
         {                                                                                                             \
            R##_f1--;                                                                                                  \
            _FP_FRAC_ADD_2(_FP_DIV_MEAT_2_udiv_r, Y, _FP_DIV_MEAT_2_udiv_r);                                           \
         }                                                                                                             \
      ...
      {                                                                                                                \
         udiv_qrnnd(R##_f0, _FP_DIV_MEAT_2_udiv_r_f1, _FP_DIV_MEAT_2_udiv_r_f1, _FP_DIV_MEAT_2_udiv_r_f0, Y##_f1);     \
         umul_ppmm(_FP_DIV_MEAT_2_udiv_m_f1, _FP_DIV_MEAT_2_udiv_m_f0, R##_f0, Y##_f0);                                \
         ...
         if(!_FP_FRAC_EQ_2(_FP_DIV_MEAT_2_udiv_r, _FP_DIV_MEAT_2_udiv_m))                                              \
...
#define _FP_SQRT_MEAT_2(R, S, T, X, q)                                 \
   ...
   {                                                                   \
      ...
      {                                                                \
         T##_f0 = S##_f0 + (q);                                        \
         T##_f1 = S##_f1;                                              \
         if(T##_f1 < X##_f1 || (T##_f1 == X##_f1 && T##_f0 <= X##_f0)) \
         {                                                             \
            S##_f0 = T##_f0 + (q);                                     \
            S##_f1 += (T##_f0 > S##_f0);                               \
            _FP_FRAC_DEC_2(X, T);                                      \
      ...
      if(X##_f0 | X##_f1)                                              \
      {                                                                \
         if(S##_f1 < X##_f1 || (S##_f1 == X##_f1 && S##_f0 < X##_f0))  \
...
#define _FP_FRAC_ASSEMBLE_2(r, X, rsize)                          \
   (void)(((rsize) <= _FP_W_TYPE_SIZE) ? ({ (r) = X##_f0; }) : ({ \
      (r) = X##_f1;                                               \
      (r) <<= _FP_W_TYPE_SIZE;                                    \
      (r) += X##_f0;                                              \
   }))
