...
__float32 __uint64_to_float32(__uint64 a, __bits8 __exp_bits, __bits8 __frac_bits, __sbits32 __exp_bias,
                              __flag __rounding, __flag __nan, __flag __one, __flag __subnorm, __sbits8 __sign)
{
   union _FP_UNION_S ur;
   ur.flt = __floatundisf(a);
   return ur.coded;
}
                    ...
                    __flag __rounding, __flag __nan, __flag __one, __flag __subnorm, __sbits8 __sign)
{
   ...
   if(__bw == 16)
   {
      union _FP_UNION_H ua, ub, ur;
      ua.coded = a;
      ub.coded = b;
      ur.flt = __addhf3(ua.flt, ub.flt);
      return ur.coded;
   }
   else if(__bw == 32)
   {
