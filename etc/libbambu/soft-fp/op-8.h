...
#define _FP_FRAC_SLL_8(X, N)                                                                                        \
   ...
   {                                                                                                                \
      ...
      if(!_FP_FRAC_SLL_8_up)                                                                                        \
         for(_FP_FRAC_SLL_8_i = 7; _FP_FRAC_SLL_8_i >= _FP_FRAC_SLL_8_skip; --_FP_FRAC_SLL_8_i)                     \
            X##_f[_FP_FRAC_SLL_8_i] = X##_f[_FP_FRAC_SLL_8_i - _FP_FRAC_SLL_8_skip];                                \
      else                                                                                                          \
      {                                                                                                             \
         for(_FP_FRAC_SLL_8_i = 7; _FP_FRAC_SLL_8_i > _FP_FRAC_SLL_8_skip; --_FP_FRAC_SLL_8_i)                      \
            X##_f[_FP_FRAC_SLL_8_i] = ((X##_f[_FP_FRAC_SLL_8_i - _FP_FRAC_SLL_8_skip] << _FP_FRAC_SLL_8_up) |       \
                                       (X##_f[_FP_FRAC_SLL_8_i - _FP_FRAC_SLL_8_skip - 1] >> _FP_FRAC_SLL_8_down)); \
...
#define _FP_FRAC_SRL_8(X, N)                                                                                      \
   ...
   {                                                                                                              \
      ...
      if(!_FP_FRAC_SRL_8_down)                                                                                    \
         for(_FP_FRAC_SRL_8_i = 0; _FP_FRAC_SRL_8_i <= 7 - _FP_FRAC_SRL_8_skip; ++_FP_FRAC_SRL_8_i)               \
            X##_f[_FP_FRAC_SRL_8_i] = X##_f[_FP_FRAC_SRL_8_i + _FP_FRAC_SRL_8_skip];                              \
      else                                                                                                        \
      {                                                                                                           \
         for(_FP_FRAC_SRL_8_i = 0; _FP_FRAC_SRL_8_i < 7 - _FP_FRAC_SRL_8_skip; ++_FP_FRAC_SRL_8_i)                \
            X##_f[_FP_FRAC_SRL_8_i] = ((X##_f[_FP_FRAC_SRL_8_i + _FP_FRAC_SRL_8_skip] >> _FP_FRAC_SRL_8_down) |   \
                                       (X##_f[_FP_FRAC_SRL_8_i + _FP_FRAC_SRL_8_skip + 1] << _FP_FRAC_SRL_8_up)); \
...
#define _FP_FRAC_SRS_8(X, N, size)                                                                                \
   ...
   {                                                                                                              \
      ...
      for(_FP_FRAC_SRS_8_s = _FP_FRAC_SRS_8_i = 0; _FP_FRAC_SRS_8_i < _FP_FRAC_SRS_8_skip; ++_FP_FRAC_SRS_8_i)    \
         _FP_FRAC_SRS_8_s |= X##_f[_FP_FRAC_SRS_8_i];                                                             \
      if(!_FP_FRAC_SRS_8_down)                                                                                    \
         for(_FP_FRAC_SRS_8_i = 0; _FP_FRAC_SRS_8_i <= 7 - _FP_FRAC_SRS_8_skip; ++_FP_FRAC_SRS_8_i)               \
            X##_f[_FP_FRAC_SRS_8_i] = X##_f[_FP_FRAC_SRS_8_i + _FP_FRAC_SRS_8_skip];                              \
      else                                                                                                        \
      {                                                                                                           \
         _FP_FRAC_SRS_8_s |= X##_f[_FP_FRAC_SRS_8_i] << _FP_FRAC_SRS_8_up;                                        \
         for(_FP_FRAC_SRS_8_i = 0; _FP_FRAC_SRS_8_i < 7 - _FP_FRAC_SRS_8_skip; ++_FP_FRAC_SRS_8_i)                \
            X##_f[_FP_FRAC_SRS_8_i] = ((X##_f[_FP_FRAC_SRS_8_i + _FP_FRAC_SRS_8_skip] >> _FP_FRAC_SRS_8_down) |   \
                                       (X##_f[_FP_FRAC_SRS_8_i + _FP_FRAC_SRS_8_skip + 1] << _FP_FRAC_SRS_8_up)); \
...
#define _FP_FRAC_ADD_8(R, X, Y)                                                                            \
   ...
   {                                                                                                       \
      ...
      {                                                                                                    \
         R##_f[_FP_FRAC_ADD_8_i] = (X##_f[_FP_FRAC_ADD_8_i] + Y##_f[_FP_FRAC_ADD_8_i] + _FP_FRAC_ADD_8_c); \
         _FP_FRAC_ADD_8_c = (_FP_FRAC_ADD_8_c ? R##_f[_FP_FRAC_ADD_8_i] <= X##_f[_FP_FRAC_ADD_8_i] :       \
...
#define _FP_FRAC_SUB_8(R, X, Y)                                                                                     \
   ...
   {                                                                                                                \
      ...
      {                                                                                                             \
         ...
         _FP_FRAC_SUB_8_c = (_FP_FRAC_SUB_8_c ? (_FP_FRAC_SUB_8_tmp[_FP_FRAC_SUB_8_i] >= X##_f[_FP_FRAC_SUB_8_i]) : \
                                                (_FP_FRAC_SUB_8_tmp[_FP_FRAC_SUB_8_i] > X##_f[_FP_FRAC_SUB_8_i]));  \
      }                                                                                                             \
      for(_FP_FRAC_SUB_8_i = 0; _FP_FRAC_SUB_8_i < 8; ++_FP_FRAC_SUB_8_i)                                           \
...
#define _FP_FRAC_ZEROP_8(X) \
   ((X##_f[0] | X##_f[1] | X##_f[2] | X##_f[3] | X##_f[4] | X##_f[5] | X##_f[6] | X##_f[7]) == 0)
#define _FP_FRAC_HIGHBIT_DW_8(fs, X) (_FP_FRAC_HIGH_DW_##fs(X) & _FP_HIGHBIT_DW_##fs)
...
#define __FP_FRAC_SET_8(X, I7, I6, I5, I4, I3, I2, I1, I0)                                                   \
   (X##_f[7] = I7, X##_f[6] = I6, X##_f[5] = I5, X##_f[4] = I4, X##_f[3] = I3, X##_f[2] = I2, X##_f[1] = I1, \
    X##_f[0] = I0)
