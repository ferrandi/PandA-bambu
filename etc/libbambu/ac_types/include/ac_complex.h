...
public:
  ...
  ac_complex() {}
  template <typename T2> ac_complex(const ac_complex<T2> &c) {
    _r = c.r();
    _i = c.i();
  }
  template <typename T2> ac_complex(const T2 &r) {
    _r = r;
    _i = 0;
  }
  template <typename T2, typename T3> ac_complex(const T2 &r, const T3 &i) {
    _r = r;
    _i = i;
  }
  ...
  template <typename T2> ac_complex &operator+=(const ac_complex<T2> &op2) {
    _r += op2.r();
    _i += op2.i();
    return *this;
  }

  template <typename T2> ac_complex &operator+=(const T2 &op2) {
    _r += op2;
    return *this;
  }
  ...
  ac_complex<ac_int<2, true>> sign_conj() const {
    return ac_complex<ac_int<2, true>>(_r ? (_r < 0 ? -1 : 1) : 0,
                                       _i ? (_i < 0 ? 1 : -1) : 0);
  }
...
// with T2 == ac_float
template <AC_FL_T0(2)> struct rt_ac_complex_T<AC_FL0(2)> {
  typedef AC_FL0(2) T2;
  template <typename T> struct op1 {
...
inline typename ac_complex<T>::template rt_T<ac_complex<T2>>::plus
...
template <typename T, typename T2>
inline typename ac_complex<T2>::template rt_T<T>::plus
...
template <typename T, typename T2>
inline typename ac_complex<T>::template rt_T<T2>::plus
...
template <typename T, typename T2>
inline typename ac_complex<T>::template rt_T<ac_complex<T2>>::minus
operator-(const ac_complex<T> &op, const ac_complex<T2> &op2) {
...
template <typename T, typename T2>
inline typename ac_complex<T2>::template rt_T<T>::minus2
operator-(const T &op, const ac_complex<T2> &op2) {
...
template <typename T, typename T2>
inline typename ac_complex<T>::template rt_T<T2>::minus
operator-(const ac_complex<T> &op, const T2 &op2) {
...
template <typename T, typename T2>
inline typename ac_complex<T>::template rt_T<ac_complex<T2>>::mult
operator*(const ac_complex<T> &op, const ac_complex<T2> &op2) {
...
template <typename T, typename T2>
inline typename ac_complex<T2>::template rt_T<T>::mult
operator*(const T &op, const ac_complex<T2> &op2) {
...
template <typename T, typename T2>
inline typename ac_complex<T>::template rt_T<T2>::mult
operator*(const ac_complex<T> &op, const T2 &op2) {
...
template <typename T, typename T2>
inline typename ac_complex<T>::template rt_T<ac_complex<T2>>::div
operator/(const ac_complex<T> &op, const ac_complex<T2> &op2) {
  typename ac_complex<T2>::rt_unary::mag_sqr d = op2.mag_sqr();
...
template <typename T, typename T2>
inline typename ac_complex<T>::template rt_T<T2>::div
operator/(const ac_complex<T> &op, const T2 &op2) {
...
template <typename T, typename T2>
inline typename ac_complex<T2>::template rt_T<T>::div2
operator/(const T &op, const ac_complex<T2> &op2) {
  typename ac_complex<T2>::rt_unary::mag_sqr d = op2.mag_sqr();
