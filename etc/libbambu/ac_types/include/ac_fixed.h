...
#pragma GCC diagnostic pop
      ...
      {
          std::string msg = std::string("Out of bounds set_slc; umsb: ") + std::to_string(umsb) +
                        std::string(" , ulsb: ") + std::to_string(ulsb) + std::string(" , W: ") + std::to_string(W);
          AC_ASSERT((ulsb + umsb + 1) <= W, msg.c_str());
