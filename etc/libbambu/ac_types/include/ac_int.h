...
#pragma builtin
  ...
  template<> inline bool iv_equal_ones<0,0>(const iv_base<0>& /*op*/) { return true; }
  ...
  inline bool iv_equal(const iv_base<N1>&op1, const iv_base<N2>&op2){
    ...
    const iv_base<M1>&OP1 = N1 >= N2 ? op1 : op2;
    const iv_base<M2>&OP2 = N1 >= N2 ? op2 : op1;
    for(int i=0; i < M2; i++)
      if(OP1[i] != OP2[i])
        return false;
  ...
  template<> inline bool iv_add_int_carry<1,1,1>(const iv_base<1>& op1, int op2, bool carry, iv_base<1>&r) { return carry; }
  ...
  template<> inline bool iv_sub_int_borrow<1,1,1>(const iv_base<1>&op1, int op2, bool borrow, iv_base<1>&r) { return borrow; }
  ...
  template<> inline bool iv_sub_int_borrow<1,1,1>(int op1, const iv_base<1>&op2, bool borrow, iv_base<1>&r) { return borrow; }
  ...
  template<> inline bool iv_all_bits_same<0>(const iv_base<0>& /*op*/, bool /*bit*/) { return true; }
  ...
  inline void iv_bitwise_and(const iv_base<N1>&op1, const iv_base<N2>&op2, iv_base<Nr>&r) {
    ...
    const iv_base<AC_MAX(N1,N2)>&OP1 = N1 > N2 ? op1 : op2;
    const iv_base<AC_MIN(N1,N2)>&OP2 = N1 > N2 ? op2 : op1;
  ...
  template<int N>
  inline void iv_conv_from_fraction(double d, iv_base<N>&r, bool *qb, bool *rbits, bool *o) {
    bool b = d < 0;
    double d2 = b ? -d : d;
