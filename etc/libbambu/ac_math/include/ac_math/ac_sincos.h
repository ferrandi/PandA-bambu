...
//
// Description:
//    Provides lookup based implementation of the sincos finction for the
...
//============================================================================
// Function: ac_sincos (for ac_fixed)
//
// Description:
//    Looking up the sin and cos lookup tables for finding the sin and cos
//    values of real inputs, passed as ac_fixed variables.
//
// Usage:
//    See above example code for usage.
//
// Notes:
//    The lookup table based implementation utilizes lookup tables for
//    sin and cos values. For smaller bitwidths, a stride has been implemented
//    to prune the tables.
//    The input is the range of 0-1 radians/2PI. The maximum allowed number of
//    fractional bits in the input is 12.
//-------------------------------------------------------------------------

namespace ac_math
{
   template <class T_in, class T_out>
   void ac_sincos(const T_in& input, ac_complex<T_out>& output)
   {
      ...
      static const luttype sincos[512] = {{1.0000000000000000000000, 0.0000000000000000000000},  // index = 0, scaled angle = 0
   ...
   T_out ac_sincos(const T_in& input)
   {
      T_out output;
      ac_sincos(input, output);
      return output;
   }
} // namespace ac_math
