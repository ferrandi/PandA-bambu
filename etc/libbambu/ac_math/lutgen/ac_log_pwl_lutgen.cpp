 ...
 *************************************************************************/
// Usage:
//   g++ -I$MGC_HOME/shared/include ac_log_pwl_lutgen.cpp -o ac_log_pwl_lutgen
//   ./ac_log_pwl_lutgen
// results in a text file ac_log_pwl_lut_values.txt which can be pasted into
// a locally modified version of ac_log_pwl.h.
...
int main()
{
   ...
   // as this .cpp file
   const char filename[] = "ac_log_pwl_lut_values.txt";
   ...
   for(int i = 0; i < nsegments; i++)
   {
      ...
      double max_diff = (pwl_new(x_mid) - log2(x_mid));
