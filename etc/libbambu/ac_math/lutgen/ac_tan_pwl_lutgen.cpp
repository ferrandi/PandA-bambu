 ...
 *************************************************************************/
// Usage:
//   g++ -I$MGC_HOME/shared/include ac_tan_pwl_lutgen.cpp -o ac_tan_pwl_lutgen
//   ./ac_tan_pwl_lutgen
...
int main()
{
   ...
   // as this .cpp file
   const char filename[] = "ac_tan_pwl_lut_values.txt";
   ...
   for(int i = 0; i < nsegments; i++)
   {
      ...
      double max_diff = (pwl_new(x_mid) - tan(x_mid));
...
int p_c_int_bits = ceil(log2(make_non_zero(prop_constant))) + 1;
