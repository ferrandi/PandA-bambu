...
void test_ac_determinant(
  ...
  ac_fixed<(M*Wfi + ac::log2_floor<Factorial<M>::value >::val), (M*Ifi + ac::log2_floor<Factorial<M>::value >::val), true, AC_TRN, AC_WRAP> &det1,
  const ac_complex<ac_fixed<Wfi, Ifi, Sfi, AC_TRN, AC_WRAP> > A2[M][M],
  ac_complex<ac_fixed<(M*Wfi + ac::log2_floor<Factorial<M>::value >::val), (M*Ifi + ac::log2_floor<Factorial<M>::value >::val), true, AC_TRN, AC_WRAP> > &det2,
  const ac_matrix<ac_fixed<Wfi, Ifi, Sfi, AC_TRN, AC_WRAP>, M, M> &A3,
  ac_fixed<(M*Wfi + ac::log2_floor<Factorial<M>::value >::val), (M*Ifi + ac::log2_floor<Factorial<M>::value >::val), true, AC_TRN, AC_WRAP> &det3,
