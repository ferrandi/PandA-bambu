...
void test_ac_shift_left_us(
  const ac_fixed<W, I, false, AC_TRN, AC_WRAP> &us_fixed_input,
...
template <int W, int I, int outW, int outI, ac_q_mode outQ, ac_o_mode outO>
void test_ac_shift_left_s(
  const ac_fixed<W, I, true, AC_TRN, AC_WRAP> &s_fixed_input,
...
void print_origin_error(
  const ac_fixed<W, I, true, AC_TRN, AC_WRAP> input,
  const int n
)
{
...
template <int W, int I>
void print_origin_error(
  const ac_fixed<W, I, false, AC_TRN, AC_WRAP> input,
  const int n
)
{
...
template <int W, int I>
void print_origin_error(
  const ac_complex<ac_fixed<W, I, false, AC_TRN, AC_WRAP> > input,
  const unsigned int n
)
{
...
template <int W, int I>
void print_origin_error(
  const ac_complex<ac_fixed<W, I, true, AC_TRN, AC_WRAP> > input,
  const unsigned int n
)
{
