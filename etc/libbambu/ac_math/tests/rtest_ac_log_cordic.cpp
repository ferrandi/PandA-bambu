...
void test_ac_log_cordic(const ac_fixed<Wfi, Ifi, false, AC_TRN, AC_WRAP>& in,
...
template <int Wfi, int Ifi, int outWfi, int outIfi, bool outSfi>
int test_driver(double& cumulative_max_error_log, const double allowed_error, const double threshold,
                bool details = false)
{
